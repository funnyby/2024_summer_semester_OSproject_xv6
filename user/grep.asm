...
00000000000001ee <main>:
{
 ...
 262:	80a58593          	addi	a1,a1,-2038 # a68 <malloc+0xe8>
 266:	4509                	li	a0,2
 268:	00000097          	auipc	ra,0x0
 26c:	62c080e7          	jalr	1580(ra) # 894 <fprintf>
    exit(1);
 270:	4505                	li	a0,1
 ...
 298:	7f450513          	addi	a0,a0,2036 # a88 <malloc+0x108>
 29c:	00000097          	auipc	ra,0x0
 2a0:	626080e7          	jalr	1574(ra) # 8c2 <printf>
      exit(1);
 2a4:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 632:	47a50513          	addi	a0,a0,1146 # aa8 <digits>
 636:	883a                	mv	a6,a4
 ...
 644:	0007c783          	lbu	a5,0(a5) # 4000000 <__global_pointer$+0x3ffed47>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6fe:	3aeb8b93          	addi	s7,s7,942 # aa8 <digits>
 ...
 83e:	26690913          	addi	s2,s2,614 # aa0 <malloc+0x120>
        while(*s != 0){
...
free(void *ap)
{
 ...
 906:	1be7b783          	ld	a5,446(a5) # ac0 <freep>
 ...
 934:	00e6ea63          	bltu	a3,a4,948 <free+0x50>
{
 ...
 976:	14f73723          	sd	a5,334(a4) # ac0 <freep>
}
 97a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9a8:	11c53503          	ld	a0,284(a0) # ac0 <freep>
 ...
 9d0:	0f490913          	addi	s2,s2,244 # ac0 <freep>
  if(p == (char*)-1)
 9d4:	5afd                	li	s5,-1
 9d6:	a88d                	j	a48 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9d8:	00000797          	auipc	a5,0x0
 9dc:	4f078793          	addi	a5,a5,1264 # ec8 <base>
 9e0:	00000717          	auipc	a4,0x0
 9e4:	0ef73023          	sd	a5,224(a4) # ac0 <freep>
 9e8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a0a:	0aa73d23          	sd	a0,186(a4) # ac0 <freep>
      return (void*)(p + 1);
 ...
 a58:	b6e080e7          	jalr	-1170(ra) # 5c2 <sbrk>
  if(p == (char*)-1)

...
main(int argc, char **argv)
{
  ...
  4c:	7d858593          	addi	a1,a1,2008 # 820 <malloc+0xea>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e8:	45c50513          	addi	a0,a0,1116 # 840 <digits>
 3ec:	883a                	mv	a6,a4
 ...
 3fa:	0007c783          	lbu	a5,0(a5) # 4000000 <__global_pointer$+0x3ffefaf>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b4:	390b8b93          	addi	s7,s7,912 # 840 <digits>
 ...
 5f4:	24890913          	addi	s2,s2,584 # 838 <malloc+0x102>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6bc:	1a07b783          	ld	a5,416(a5) # 858 <freep>
 ...
 6ea:	00e6ea63          	bltu	a3,a4,6fe <free+0x50>
{
 ...
 72c:	12f73823          	sd	a5,304(a4) # 858 <freep>
}
 730:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 75e:	0fe53503          	ld	a0,254(a0) # 858 <freep>
 ...
 786:	0d690913          	addi	s2,s2,214 # 858 <freep>
  if(p == (char*)-1)
 78a:	5afd                	li	s5,-1
 78c:	a88d                	j	7fe <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 78e:	00000797          	auipc	a5,0x0
 792:	0d278793          	addi	a5,a5,210 # 860 <base>
 796:	00000717          	auipc	a4,0x0
 79a:	0cf73123          	sd	a5,194(a4) # 858 <freep>
 79e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7c0:	08a73e23          	sd	a0,156(a4) # 858 <freep>
      return (void*)(p + 1);

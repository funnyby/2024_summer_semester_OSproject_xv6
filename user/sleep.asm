...
int main(int argc,char *argv[])
{
  ...
  16:	1be080e7          	jalr	446(ra) # 1d0 <atoi>
  1a:	84aa                	mv	s1,a0
    printf("(start sleep)\n");
  1c:	00000517          	auipc	a0,0x0
  20:	7f450513          	addi	a0,a0,2036 # 810 <malloc+0x10a>
  24:	00000097          	auipc	ra,0x0
  28:	624080e7          	jalr	1572(ra) # 648 <printf>
    sleep(ticks);
  2c:	8526                	mv	a0,s1
  2e:	00000097          	auipc	ra,0x0
  32:	332080e7          	jalr	818(ra) # 360 <sleep>
    exit(0);
  36:	4501                	li	a0,0
  ...
  44:	7b050513          	addi	a0,a0,1968 # 7f0 <malloc+0xea>
  48:	00000097          	auipc	ra,0x0
  4c:	600080e7          	jalr	1536(ra) # 648 <printf>
        exit(1);
  50:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b8:	47450513          	addi	a0,a0,1140 # 828 <digits>
 3bc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 484:	3a8b8b93          	addi	s7,s7,936 # 828 <digits>
 ...
 5c4:	26090913          	addi	s2,s2,608 # 820 <malloc+0x11a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 68c:	1b87b783          	ld	a5,440(a5) # 840 <freep>
 ...
 6ba:	00e6ea63          	bltu	a3,a4,6ce <free+0x50>
{
 ...
 6fc:	14f73423          	sd	a5,328(a4) # 840 <freep>
}
 700:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 72e:	11653503          	ld	a0,278(a0) # 840 <freep>
 ...
 756:	0ee90913          	addi	s2,s2,238 # 840 <freep>
  if(p == (char*)-1)
 75a:	5afd                	li	s5,-1
 75c:	a88d                	j	7ce <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 75e:	00000797          	auipc	a5,0x0
 762:	0ea78793          	addi	a5,a5,234 # 848 <base>
 766:	00000717          	auipc	a4,0x0
 76a:	0cf73d23          	sd	a5,218(a4) # 840 <freep>
 76e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;

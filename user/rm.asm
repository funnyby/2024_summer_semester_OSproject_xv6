...
main(int argc, char *argv[])
{
  ...
  42:	7f258593          	addi	a1,a1,2034 # 830 <malloc+0xe6>
  46:	4509                	li	a0,2
  48:	00000097          	auipc	ra,0x0
  4c:	616080e7          	jalr	1558(ra) # 65e <fprintf>
    exit(1);
  50:	4505                	li	a0,1
  ...
  60:	7ec58593          	addi	a1,a1,2028 # 848 <malloc+0xfe>
  64:	4509                	li	a0,2
  66:	00000097          	auipc	ra,0x0
  6a:	5f8080e7          	jalr	1528(ra) # 65e <fprintf>
      break;
    }
  }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fc:	47850513          	addi	a0,a0,1144 # 870 <digits>
 400:	883a                	mv	a6,a4
 ...
 40e:	0007c783          	lbu	a5,0(a5) # 4000000 <__global_pointer$+0x3ffef7f>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 608:	26490913          	addi	s2,s2,612 # 868 <malloc+0x11e>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d0:	1bc7b783          	ld	a5,444(a5) # 888 <freep>
 ...
 6fe:	00e6ea63          	bltu	a3,a4,712 <free+0x50>
{
 ...
 740:	14f73623          	sd	a5,332(a4) # 888 <freep>
}
 744:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 772:	11a53503          	ld	a0,282(a0) # 888 <freep>
 ...
 79a:	0f290913          	addi	s2,s2,242 # 888 <freep>
  if(p == (char*)-1)
 79e:	5afd                	li	s5,-1
 7a0:	a88d                	j	812 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7a2:	00000797          	auipc	a5,0x0
 7a6:	0ee78793          	addi	a5,a5,238 # 890 <base>
 7aa:	00000717          	auipc	a4,0x0
 7ae:	0cf73f23          	sd	a5,222(a4) # 888 <freep>
 7b2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7d4:	0aa73c23          	sd	a0,184(a4) # 888 <freep>
      return (void*)(p + 1);

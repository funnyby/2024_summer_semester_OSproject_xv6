...
forkret(void)
{
  ...
  if (first) {
    ...
    80000ee6:	9fe7a783          	lw	a5,-1538(a5) # 800088e0 <first.1673>
  ...
  usertrapret();
    ...
    80000f00:	9e07a223          	sw	zero,-1564(a5) # 800088e0 <first.1673>
    fsinit(ROOTDEV);
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001b2a:	74a58593          	addi	a1,a1,1866 # 80008270 <states.1710+0x30>
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001c94:	5e850513          	addi	a0,a0,1512 # 80008278 <states.1710+0x38>
...
0000000080001ce4 <usertrap>:
{
  ...
  usertrapret();
    ...
    80001d5e:	53e50513          	addi	a0,a0,1342 # 80008298 <states.1710+0x58>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001d92:	52a50513          	addi	a0,a0,1322 # 800082b8 <states.1710+0x78>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001daa:	54250513          	addi	a0,a0,1346 # 800082e8 <states.1710+0xa8>
...
0000000080001dd8 <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001e2a:	4e250513          	addi	a0,a0,1250 # 80008308 <states.1710+0xc8>
    80001e2e:	00004097          	auipc	ra,0x4
    80001e32:	e6a080e7          	jalr	-406(ra) # 80005c98 <panic>
    panic("kerneltrap: interrupts enabled");
    80001e36:	00006517          	auipc	a0,0x6
    80001e3a:	4fa50513          	addi	a0,a0,1274 # 80008330 <states.1710+0xf0>
    ...
    80001e4c:	50850513          	addi	a0,a0,1288 # 80008350 <states.1710+0x110>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001e64:	50050513          	addi	a0,a0,1280 # 80008360 <states.1710+0x120>
    80001e68:	00004097          	auipc	ra,0x4
    80001e6c:	e7a080e7          	jalr	-390(ra) # 80005ce2 <printf>
    panic("kerneltrap");
    80001e70:	00006517          	auipc	a0,0x6
    80001e74:	50850513          	addi	a0,a0,1288 # 80008378 <states.1710+0x138>
...
argraw(int n)
{
  ...
  switch (n) {
    ...
    80001ec4:	5b870713          	addi	a4,a4,1464 # 80008478 <states.1710+0x238>
  ...
  panic("argraw");
    ...
    80001f00:	48c50513          	addi	a0,a0,1164 # 80008388 <states.1710+0x148>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    8000204e:	44678793          	addi	a5,a5,1094 # 80008490 <syscalls>
    ...
    80002072:	8ba78793          	addi	a5,a5,-1862 # 80008928 <syscallnames>
    ...
    80002084:	31050513          	addi	a0,a0,784 # 80008390 <states.1710+0x150>
    ...
    8000209e:	30e50513          	addi	a0,a0,782 # 800083a8 <states.1710+0x168>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002368:	1ec58593          	addi	a1,a1,492 # 80008550 <syscalls+0xc0>
  ...
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    ...
    800023a4:	1b8a0a13          	addi	s4,s4,440 # 80008558 <syscalls+0xc8>
    b->next = bcache.head.next;
...
bread(uint dev, uint blockno)
{
  ...
  panic("bget: no buffers");
    ...
    80002476:	0ee50513          	addi	a0,a0,238 # 80008560 <syscalls+0xd0>
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002506:	07650513          	addi	a0,a0,118 # 80008578 <syscalls+0xe8>
...
brelse(struct buf *b)
{
  ...
  release(&bcache.lock);
    ...
    800025a4:	fe050513          	addi	a0,a0,-32 # 80008580 <syscalls+0xf0>
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    80002698:	ef450513          	addi	a0,a0,-268 # 80008588 <syscalls+0xf8>
...
00000000800026a4 <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    8000275e:	e4650513          	addi	a0,a0,-442 # 800085a0 <syscalls+0x110>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800028a4:	d1850513          	addi	a0,a0,-744 # 800085b8 <syscalls+0x128>
...
00000000800028b0 <iget>:
{
  ...
  release(&itable.lock);
    ...
    80002960:	c7450513          	addi	a0,a0,-908 # 800085d0 <syscalls+0x140>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    800029e0:	c0450513          	addi	a0,a0,-1020 # 800085e0 <syscalls+0x150>
...
00000000800029ec <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    800029fe:	bfe58593          	addi	a1,a1,-1026 # 800085f8 <syscalls+0x168>
  ...
  for(i = 0; i < NINODE; i++) {
    ...
    80002a26:	bde90913          	addi	s2,s2,-1058 # 80008600 <syscalls+0x170>
...
0000000080002a4c <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    80002ac4:	b4850513          	addi	a0,a0,-1208 # 80008608 <syscalls+0x178>
...
0000000080002be4 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002c18:	a0c50513          	addi	a0,a0,-1524 # 80008620 <syscalls+0x190>
    ...
    80002c9a:	99250513          	addi	a0,a0,-1646 # 80008628 <syscalls+0x198>
...
0000000080002ca6 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002ce6:	95650513          	addi	a0,a0,-1706 # 80008638 <syscalls+0x1a8>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    800030f6:	54e50513          	addi	a0,a0,1358 # 80008640 <syscalls+0x1b0>
    800030fa:	00003097          	auipc	ra,0x3
    800030fe:	b9e080e7          	jalr	-1122(ra) # 80005c98 <panic>
      panic("dirlookup read");
    80003102:	00005517          	auipc	a0,0x5
    80003106:	55650513          	addi	a0,a0,1366 # 80008658 <syscalls+0x1c8>
...
00000000800032d8 <dirlink>:
{
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    8000337e:	2ee50513          	addi	a0,a0,750 # 80008668 <syscalls+0x1d8>
    80003382:	00003097          	auipc	ra,0x3
    80003386:	916080e7          	jalr	-1770(ra) # 80005c98 <panic>
    panic("dirlink");
    8000338a:	00005517          	auipc	a0,0x5
    8000338e:	3e650513          	addi	a0,a0,998 # 80008770 <syscalls+0x2e0>
...
0000000080003512 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003530:	14c58593          	addi	a1,a1,332 # 80008678 <syscalls+0x1e8>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800036c8:	fbc50513          	addi	a0,a0,-68 # 80008680 <syscalls+0x1f0>
...
log_write(struct buf *b)
{
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80003822:	e7250513          	addi	a0,a0,-398 # 80008690 <syscalls+0x200>
    80003826:	00002097          	auipc	ra,0x2
    8000382a:	472080e7          	jalr	1138(ra) # 80005c98 <panic>
    panic("log_write outside of trans");
    8000382e:	00005517          	auipc	a0,0x5
    80003832:	e7a50513          	addi	a0,a0,-390 # 800086a8 <syscalls+0x218>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80003888:	e4458593          	addi	a1,a1,-444 # 800086c8 <syscalls+0x238>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800039aa:	d3258593          	addi	a1,a1,-718 # 800086d8 <syscalls+0x248>
...
filedup(struct file *f)
{
  ...
  return f;
    ...
    80003a76:	c6e50513          	addi	a0,a0,-914 # 800086e0 <syscalls+0x250>
...
fileclose(struct file *f)
{
  ...
  if(ff.type == FD_PIPE){
    ...
    80003b0e:	bde50513          	addi	a0,a0,-1058 # 800086e8 <syscalls+0x258>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80003c66:	a9650513          	addi	a0,a0,-1386 # 800086f8 <syscalls+0x268>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  return ret;
    ...
    80003d9a:	97250513          	addi	a0,a0,-1678 # 80008708 <syscalls+0x278>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003e0a:	5da58593          	addi	a1,a1,1498 # 800083e0 <states.1710+0x1a0>
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    800041d6:	54650513          	addi	a0,a0,1350 # 80008718 <syscalls+0x288>
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    80004608:	13450513          	addi	a0,a0,308 # 80008738 <syscalls+0x2a8>
    ...
    8000462e:	11e58593          	addi	a1,a1,286 # 80008748 <syscalls+0x2b8>
    ...
    80004648:	10c58593          	addi	a1,a1,268 # 80008750 <syscalls+0x2c0>
    ...
    8000465e:	0fe50513          	addi	a0,a0,254 # 80008758 <syscalls+0x2c8>
    80004662:	00001097          	auipc	ra,0x1
    80004666:	636080e7          	jalr	1590(ra) # 80005c98 <panic>
    panic("create: dirlink");
    8000466a:	00004517          	auipc	a0,0x4
    8000466e:	0fe50513          	addi	a0,a0,254 # 80008768 <syscalls+0x2d8>
...
000000008000497e <sys_unlink>:
{
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    800049ca:	d8258593          	addi	a1,a1,-638 # 80008748 <syscalls+0x2b8>
    ...
    800049e2:	d7258593          	addi	a1,a1,-654 # 80008750 <syscalls+0x2c0>
  ...
  return 0;
    ...
    80004aa2:	cda50513          	addi	a0,a0,-806 # 80008778 <syscalls+0x2e8>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80004aee:	ca650513          	addi	a0,a0,-858 # 80008790 <syscalls+0x300>
    80004af2:	00001097          	auipc	ra,0x1
    80004af6:	1a6080e7          	jalr	422(ra) # 80005c98 <panic>
    panic("unlink: writei");
    80004afa:	00004517          	auipc	a0,0x4
    80004afe:	cae50513          	addi	a0,a0,-850 # 800087a8 <syscalls+0x318>

...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800027f4:	5d8080e7          	jalr	1496(ra) # 80005dc8 <panic>
...
00000000800027f8 <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80002818:	afe080e7          	jalr	-1282(ra) # 80006312 <acquire>
  empty = 0;
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    8000285e:	b6c080e7          	jalr	-1172(ra) # 800063c6 <release>
      return ip;
  ...
  release(&itable.lock);
    ...
    8000288e:	b3c080e7          	jalr	-1220(ra) # 800063c6 <release>
}
    ...
    800028b0:	51c080e7          	jalr	1308(ra) # 80005dc8 <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    80002930:	49c080e7          	jalr	1180(ra) # 80005dc8 <panic>
...
0000000080002934 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80002956:	930080e7          	jalr	-1744(ra) # 80006282 <initlock>
  for(i = 0; i < NINODE; i++) {
...
0000000080002994 <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    80002a14:	3b8080e7          	jalr	952(ra) # 80005dc8 <panic>
...
0000000080002aee <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002b06:	810080e7          	jalr	-2032(ra) # 80006312 <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    80002b1c:	8ae080e7          	jalr	-1874(ra) # 800063c6 <release>
}
...
0000000080002b2c <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002b68:	264080e7          	jalr	612(ra) # 80005dc8 <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002bea:	1e2080e7          	jalr	482(ra) # 80005dc8 <panic>
...
0000000080002bee <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002c36:	196080e7          	jalr	406(ra) # 80005dc8 <panic>
...
0000000080002d90 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002daa:	56c080e7          	jalr	1388(ra) # 80006312 <acquire>
  ...
  release(&itable.lock);
    ...
    80002dc8:	602080e7          	jalr	1538(ra) # 800063c6 <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002dfc:	5ce080e7          	jalr	1486(ra) # 800063c6 <release>
    itrunc(ip);
    ...
    80002e32:	4e4080e7          	jalr	1252(ra) # 80006312 <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    800030f2:	cda080e7          	jalr	-806(ra) # 80005dc8 <panic>
    ...
    80003102:	cca080e7          	jalr	-822(ra) # 80005dc8 <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
0000000080003506 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    8000352e:	d58080e7          	jalr	-680(ra) # 80006282 <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800035c2:	d54080e7          	jalr	-684(ra) # 80006312 <acquire>
  while(1){
    if(log.committing){
    ...
    8000361a:	db0080e7          	jalr	-592(ra) # 800063c6 <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000364a:	ccc080e7          	jalr	-820(ra) # 80006312 <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    80003672:	d58080e7          	jalr	-680(ra) # 800063c6 <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    8000368a:	c8c080e7          	jalr	-884(ra) # 80006312 <acquire>
    log.committing = 0;
    ...
    800036a2:	d28080e7          	jalr	-728(ra) # 800063c6 <release>
}
    ...
    800036c4:	708080e7          	jalr	1800(ra) # 80005dc8 <panic>
    wakeup(&log);
  ...
  release(&log.lock);
    ...
    800036e0:	cea080e7          	jalr	-790(ra) # 800063c6 <release>
  if(do_commit){
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    8000379e:	b78080e7          	jalr	-1160(ra) # 80006312 <acquire>
  ...
  release(&log.lock);
    ...
    80003858:	b72080e7          	jalr	-1166(ra) # 800063c6 <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80003886:	a00080e7          	jalr	-1536(ra) # 80006282 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800038ba:	a5c080e7          	jalr	-1444(ra) # 80006312 <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    800038e8:	ae2080e7          	jalr	-1310(ra) # 800063c6 <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003910:	a06080e7          	jalr	-1530(ra) # 80006312 <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    8000392c:	a9e080e7          	jalr	-1378(ra) # 800063c6 <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003956:	9c0080e7          	jalr	-1600(ra) # 80006312 <acquire>
  ...
  release(&lk->lk);
    ...
    80003966:	a64080e7          	jalr	-1436(ra) # 800063c6 <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800039ae:	8d8080e7          	jalr	-1832(ra) # 80006282 <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800039d0:	946080e7          	jalr	-1722(ra) # 80006312 <acquire>
  ...
  release(&ftable.lock);
    ...
    800039fc:	9ce080e7          	jalr	-1586(ra) # 800063c6 <release>
  return 0;
    ...
    80003a14:	9b6080e7          	jalr	-1610(ra) # 800063c6 <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003a3c:	8da080e7          	jalr	-1830(ra) # 80006312 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    80003a56:	974080e7          	jalr	-1676(ra) # 800063c6 <release>
  return f;
}
    ...
    80003a72:	35a080e7          	jalr	858(ra) # 80005dc8 <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003a96:	880080e7          	jalr	-1920(ra) # 80006312 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    80003ad0:	8fa080e7          	jalr	-1798(ra) # 800063c6 <release>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80003c62:	16a080e7          	jalr	362(ra) # 80005dc8 <panic>
    return -1;
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  return ret;
    ...
    80003d96:	036080e7          	jalr	54(ra) # 80005dc8 <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003e06:	480080e7          	jalr	1152(ra) # 80006282 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003e94:	482080e7          	jalr	1154(ra) # 80006312 <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003eb8:	512080e7          	jalr	1298(ra) # 800063c6 <release>
    kfree((char*)pi);
    ...
    80003eea:	4e0080e7          	jalr	1248(ra) # 800063c6 <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003f20:	3f6080e7          	jalr	1014(ra) # 80006312 <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003f3e:	48c080e7          	jalr	1164(ra) # 800063c6 <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003fe0:	3ea080e7          	jalr	1002(ra) # 800063c6 <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80004016:	300080e7          	jalr	768(ra) # 80006312 <acquire>
  ...
  release(&pi->lock);
    ...
    800040aa:	320080e7          	jalr	800(ra) # 800063c6 <release>
  return i;
}
    ...
    800040ca:	300080e7          	jalr	768(ra) # 800063c6 <release>
      return -1;
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    800041d2:	bfa080e7          	jalr	-1030(ra) # 80005dc8 <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    80004604:	7c8080e7          	jalr	1992(ra) # 80005dc8 <panic>
    dp->nlink++;  // for ".."
...
0000000080004972 <sys_unlink>:
{
  ...
  return 0;
    ...
    80004a9e:	32e080e7          	jalr	814(ra) # 80005dc8 <panic>
...
sys_open(void)
{
    80004b44:	7129                	addi	sp,sp,-320
    80004b46:	fe06                	sd	ra,312(sp)
    80004b48:	fa22                	sd	s0,304(sp)
    80004b4a:	f626                	sd	s1,296(sp)
    80004b4c:	f24a                	sd	s2,288(sp)
    80004b4e:	ee4e                	sd	s3,280(sp)
    80004b50:	0280                	addi	s0,sp,320
  int fd, omode;
  struct file *f;
  struct inode *ip;
  int n;
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    80004b66:	18054b63          	bltz	a0,80004cfc <sys_open+0x1b8>
    ...
    80004b78:	18054263          	bltz	a0,80004cfc <sys_open+0x1b8>

  begin_op();
    80004b7c:	fffff097          	auipc	ra,0xfffff
    80004b80:	a2e080e7          	jalr	-1490(ra) # 800035aa <begin_op>

  if(omode & O_CREATE){
    80004b84:	f4c42783          	lw	a5,-180(s0)
    80004b88:	2007f793          	andi	a5,a5,512
    80004b8c:	c7dd                	beqz	a5,80004c3a <sys_open+0xf6>
    ...
    80004b9c:	972080e7          	jalr	-1678(ra) # 8000450a <create>
    80004ba0:	84aa                	mv	s1,a0
    if(ip == 0){
    80004ba2:	c559                	beqz	a0,80004c30 <sys_open+0xec>
      end_op();
      return -1;
    }
  }
  ...
  if(ip->type == T_DEVICE && (ip->major < 0 || ip->major >= NDEV)){
    ...
    80004bae:	0ce68b63          	beq	a3,a4,80004c84 <sys_open+0x140>
    iunlockput(ip);
    end_op();
    return -1;
  }
  if (ip->type == T_SYMLINK)
    ...
    80004bb6:	0ce79c63          	bne	a5,a4,80004c8e <sys_open+0x14a>
  {
      if ((omode & O_NOFOLLOW) == 0)
    80004bba:	f4c42783          	lw	a5,-180(s0)
    80004bbe:	8bc1                	andi	a5,a5,16
    80004bc0:	e7f9                	bnez	a5,80004c8e <sys_open+0x14a>
    80004bc2:	4929                	li	s2,10
              {
                  end_op();
                  return -1;
              }
              ilock(ip);
              if (ip->type != T_SYMLINK)
    80004bc4:	4991                	li	s3,4
              if (readi(ip, 0, (uint64)target, ip->size-MAXPATH, MAXPATH) != MAXPATH)
    80004bc6:	44f4                	lw	a3,76(s1)
    80004bc8:	08000713          	li	a4,128
    80004bcc:	f806869b          	addiw	a3,a3,-128
    80004bd0:	ec840613          	addi	a2,s0,-312
    80004bd4:	4581                	li	a1,0
    80004bd6:	8526                	mv	a0,s1
    80004bd8:	ffffe097          	auipc	ra,0xffffe
    80004bdc:	2b2080e7          	jalr	690(ra) # 80002e8a <readi>
    80004be0:	08000793          	li	a5,128
    80004be4:	04f51463          	bne	a0,a5,80004c2c <sys_open+0xe8>
              iunlockput(ip);
    80004be8:	8526                	mv	a0,s1
    80004bea:	ffffe097          	auipc	ra,0xffffe
    80004bee:	24e080e7          	jalr	590(ra) # 80002e38 <iunlockput>
              if ((ip = namei(target)) == 0)
    80004bf2:	ec840513          	addi	a0,s0,-312
    80004bf6:	ffffe097          	auipc	ra,0xffffe
    80004bfa:	798080e7          	jalr	1944(ra) # 8000338e <namei>
    80004bfe:	84aa                	mv	s1,a0
    80004c00:	12050163          	beqz	a0,80004d22 <sys_open+0x1de>
              ilock(ip);
    80004c04:	ffffe097          	auipc	ra,0xffffe
    80004c08:	f28080e7          	jalr	-216(ra) # 80002b2c <ilock>
              if (ip->type != T_SYMLINK)
    80004c0c:	04449783          	lh	a5,68(s1)
    80004c10:	07379f63          	bne	a5,s3,80004c8e <sys_open+0x14a>
              if (recursive_depth >= 10)
    80004c14:	397d                	addiw	s2,s2,-1
    80004c16:	fa0918e3          	bnez	s2,80004bc6 <sys_open+0x82>
                  iunlockput(ip);
    80004c1a:	8526                	mv	a0,s1
    80004c1c:	ffffe097          	auipc	ra,0xffffe
    80004c20:	21c080e7          	jalr	540(ra) # 80002e38 <iunlockput>
                  end_op();
    80004c24:	fffff097          	auipc	ra,0xfffff
    80004c28:	a06080e7          	jalr	-1530(ra) # 8000362a <end_op>
                  return -1;
    80004c2c:	597d                	li	s2,-1
    80004c2e:	a0f9                	j	80004cfc <sys_open+0x1b8>
      end_op();
    80004c30:	fffff097          	auipc	ra,0xfffff
    80004c34:	9fa080e7          	jalr	-1542(ra) # 8000362a <end_op>
      return -1;
    80004c38:	a0d1                	j	80004cfc <sys_open+0x1b8>
    if((ip = namei(path)) == 0){
    80004c3a:	f5040513          	addi	a0,s0,-176
    80004c3e:	ffffe097          	auipc	ra,0xffffe
    80004c42:	750080e7          	jalr	1872(ra) # 8000338e <namei>
    80004c46:	84aa                	mv	s1,a0
    80004c48:	c905                	beqz	a0,80004c78 <sys_open+0x134>
    ilock(ip);
    80004c4a:	ffffe097          	auipc	ra,0xffffe
    80004c4e:	ee2080e7          	jalr	-286(ra) # 80002b2c <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
    80004c52:	04449703          	lh	a4,68(s1)
    80004c56:	4785                	li	a5,1
    80004c58:	f4f716e3          	bne	a4,a5,80004ba4 <sys_open+0x60>
    80004c5c:	f4c42783          	lw	a5,-180(s0)
    80004c60:	c79d                	beqz	a5,80004c8e <sys_open+0x14a>
      iunlockput(ip);
    80004c62:	8526                	mv	a0,s1
    80004c64:	ffffe097          	auipc	ra,0xffffe
    80004c68:	1d4080e7          	jalr	468(ra) # 80002e38 <iunlockput>
      end_op();
    80004c6c:	fffff097          	auipc	ra,0xfffff
    80004c70:	9be080e7          	jalr	-1602(ra) # 8000362a <end_op>
      return -1;
    80004c74:	597d                	li	s2,-1
    80004c76:	a059                	j	80004cfc <sys_open+0x1b8>
      end_op();
    80004c78:	fffff097          	auipc	ra,0xfffff
    80004c7c:	9b2080e7          	jalr	-1614(ra) # 8000362a <end_op>
      return -1;
    80004c80:	597d                	li	s2,-1
    80004c82:	a8ad                	j	80004cfc <sys_open+0x1b8>
  if(ip->type == T_DEVICE && (ip->major < 0 || ip->major >= NDEV)){
    80004c84:	0464d703          	lhu	a4,70(s1)
    80004c88:	47a5                	li	a5,9
    80004c8a:	08e7e163          	bltu	a5,a4,80004d0c <sys_open+0x1c8>
              recursive_depth++;
          }
      }
  }
  ...
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    ...
    80004c92:	d2c080e7          	jalr	-724(ra) # 800039ba <filealloc>
    80004c96:	89aa                	mv	s3,a0
    80004c98:	cd45                	beqz	a0,80004d50 <sys_open+0x20c>
    80004c9a:	00000097          	auipc	ra,0x0
    80004c9e:	82e080e7          	jalr	-2002(ra) # 800044c8 <fdalloc>
    80004ca2:	892a                	mv	s2,a0
    80004ca4:	0a054163          	bltz	a0,80004d46 <sys_open+0x202>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if(ip->type == T_DEVICE){
    ...
    80004cae:	06f70f63          	beq	a4,a5,80004d2c <sys_open+0x1e8>
    f->type = FD_DEVICE;
    f->major = ip->major;
  } else {
    f->type = FD_INODE;
  ...
  if((omode & O_TRUNC) && ip->type == T_FILE){
    ...
    80004cde:	c791                	beqz	a5,80004cea <sys_open+0x1a6>
    80004ce0:	04449703          	lh	a4,68(s1)
    80004ce4:	4789                	li	a5,2
    80004ce6:	04f70a63          	beq	a4,a5,80004d3a <sys_open+0x1f6>
    itrunc(ip);
  }
  ...
  iunlock(ip);
    ...
    80004cf0:	f02080e7          	jalr	-254(ra) # 80002bee <iunlock>
  end_op();
    80004cf4:	fffff097          	auipc	ra,0xfffff
    80004cf8:	936080e7          	jalr	-1738(ra) # 8000362a <end_op>

  return fd;
}
    80004cfc:	854a                	mv	a0,s2
    80004cfe:	70f2                	ld	ra,312(sp)
    80004d00:	7452                	ld	s0,304(sp)
    80004d02:	74b2                	ld	s1,296(sp)
    80004d04:	7912                	ld	s2,288(sp)
    80004d06:	69f2                	ld	s3,280(sp)
    80004d08:	6131                	addi	sp,sp,320
    80004d0a:	8082                	ret
    iunlockput(ip);
    80004d0c:	8526                	mv	a0,s1
    80004d0e:	ffffe097          	auipc	ra,0xffffe
    80004d12:	12a080e7          	jalr	298(ra) # 80002e38 <iunlockput>
    end_op();
    80004d16:	fffff097          	auipc	ra,0xfffff
    80004d1a:	914080e7          	jalr	-1772(ra) # 8000362a <end_op>
    return -1;
    80004d1e:	597d                	li	s2,-1
    80004d20:	bff1                	j	80004cfc <sys_open+0x1b8>
                  end_op();
    80004d22:	fffff097          	auipc	ra,0xfffff
    80004d26:	908080e7          	jalr	-1784(ra) # 8000362a <end_op>
                  return -1;
    80004d2a:	b709                	j	80004c2c <sys_open+0xe8>
    f->type = FD_DEVICE;
    80004d2c:	00f9a023          	sw	a5,0(s3)
    f->major = ip->major;
    80004d30:	04649783          	lh	a5,70(s1)
    80004d34:	02f99223          	sh	a5,36(s3)
    80004d38:	b751                	j	80004cbc <sys_open+0x178>
    itrunc(ip);
    80004d3a:	8526                	mv	a0,s1
    80004d3c:	ffffe097          	auipc	ra,0xffffe
    80004d40:	efe080e7          	jalr	-258(ra) # 80002c3a <itrunc>
    80004d44:	b75d                	j	80004cea <sys_open+0x1a6>
      fileclose(f);
    80004d46:	854e                	mv	a0,s3
    80004d48:	fffff097          	auipc	ra,0xfffff
    80004d4c:	d2e080e7          	jalr	-722(ra) # 80003a76 <fileclose>
    iunlockput(ip);
    80004d50:	8526                	mv	a0,s1
    80004d52:	ffffe097          	auipc	ra,0xffffe
    80004d56:	0e6080e7          	jalr	230(ra) # 80002e38 <iunlockput>
    end_op();
    80004d5a:	fffff097          	auipc	ra,0xfffff
    80004d5e:	8d0080e7          	jalr	-1840(ra) # 8000362a <end_op>
    return -1;
    80004d62:	597d                	li	s2,-1
    80004d64:	bf61                	j	80004cfc <sys_open+0x1b8>

0000000080004d66 <sys_mkdir>:

uint64
sys_mkdir(void)
{
    80004d66:	7175                	addi	sp,sp,-144
    80004d68:	e506                	sd	ra,136(sp)
    80004d6a:	e122                	sd	s0,128(sp)
  ...
  begin_op();
    ...
    80004d72:	83c080e7          	jalr	-1988(ra) # 800035aa <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    80004d76:	08000613          	li	a2,128
    80004d7a:	f7040593          	addi	a1,s0,-144
    80004d7e:	4501                	li	a0,0
    80004d80:	ffffd097          	auipc	ra,0xffffd
    80004d84:	1b8080e7          	jalr	440(ra) # 80001f38 <argstr>
    80004d88:	02054963          	bltz	a0,80004dba <sys_mkdir+0x54>
    80004d8c:	4681                	li	a3,0
    80004d8e:	4601                	li	a2,0
    80004d90:	4585                	li	a1,1
    80004d92:	f7040513          	addi	a0,s0,-144
    80004d96:	fffff097          	auipc	ra,0xfffff
    80004d9a:	774080e7          	jalr	1908(ra) # 8000450a <create>
    80004d9e:	cd11                	beqz	a0,80004dba <sys_mkdir+0x54>
    end_op();
    return -1;
  }
  iunlockput(ip);
    80004da0:	ffffe097          	auipc	ra,0xffffe
    80004da4:	098080e7          	jalr	152(ra) # 80002e38 <iunlockput>
  end_op();
    80004da8:	fffff097          	auipc	ra,0xfffff
    80004dac:	882080e7          	jalr	-1918(ra) # 8000362a <end_op>
  return 0;
    80004db0:	4501                	li	a0,0
}
    80004db2:	60aa                	ld	ra,136(sp)
    80004db4:	640a                	ld	s0,128(sp)
    80004db6:	6149                	addi	sp,sp,144
    80004db8:	8082                	ret
    end_op();
    80004dba:	fffff097          	auipc	ra,0xfffff
    80004dbe:	870080e7          	jalr	-1936(ra) # 8000362a <end_op>
    return -1;
    80004dc2:	557d                	li	a0,-1
    80004dc4:	b7fd                	j	80004db2 <sys_mkdir+0x4c>

0000000080004dc6 <sys_mknod>:
...
sys_mknod(void)
{
  ...
  begin_op();
    ...
    80004dd2:	7dc080e7          	jalr	2012(ra) # 800035aa <begin_op>
  if((argstr(0, path, MAXPATH)) < 0 ||
    80004dd6:	08000613          	li	a2,128
    80004dda:	f7040593          	addi	a1,s0,-144
    80004dde:	4501                	li	a0,0
    80004de0:	ffffd097          	auipc	ra,0xffffd
    80004de4:	158080e7          	jalr	344(ra) # 80001f38 <argstr>
    80004de8:	04054a63          	bltz	a0,80004e3c <sys_mknod+0x76>
     argint(1, &major) < 0 ||
    80004dec:	f6c40593          	addi	a1,s0,-148
    80004df0:	4505                	li	a0,1
    80004df2:	ffffd097          	auipc	ra,0xffffd
    80004df6:	102080e7          	jalr	258(ra) # 80001ef4 <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    80004dfa:	04054163          	bltz	a0,80004e3c <sys_mknod+0x76>
     argint(2, &minor) < 0 ||
    80004dfe:	f6840593          	addi	a1,s0,-152
    80004e02:	4509                	li	a0,2
    80004e04:	ffffd097          	auipc	ra,0xffffd
    80004e08:	0f0080e7          	jalr	240(ra) # 80001ef4 <argint>
     argint(1, &major) < 0 ||
    80004e0c:	02054863          	bltz	a0,80004e3c <sys_mknod+0x76>
     (ip = create(path, T_DEVICE, major, minor)) == 0){
    80004e10:	f6841683          	lh	a3,-152(s0)
    80004e14:	f6c41603          	lh	a2,-148(s0)
    80004e18:	458d                	li	a1,3
    80004e1a:	f7040513          	addi	a0,s0,-144
    80004e1e:	fffff097          	auipc	ra,0xfffff
    80004e22:	6ec080e7          	jalr	1772(ra) # 8000450a <create>
     argint(2, &minor) < 0 ||
    80004e26:	c919                	beqz	a0,80004e3c <sys_mknod+0x76>
    end_op();
    return -1;
  }
  iunlockput(ip);
    80004e28:	ffffe097          	auipc	ra,0xffffe
    80004e2c:	010080e7          	jalr	16(ra) # 80002e38 <iunlockput>
  end_op();
    80004e30:	ffffe097          	auipc	ra,0xffffe
    80004e34:	7fa080e7          	jalr	2042(ra) # 8000362a <end_op>
  return 0;
    80004e38:	4501                	li	a0,0
    80004e3a:	a031                	j	80004e46 <sys_mknod+0x80>
    end_op();
    80004e3c:	ffffe097          	auipc	ra,0xffffe
    80004e40:	7ee080e7          	jalr	2030(ra) # 8000362a <end_op>
    return -1;
    80004e44:	557d                	li	a0,-1
}
    80004e46:	60ea                	ld	ra,152(sp)
    80004e48:	644a                	ld	s0,144(sp)
    80004e4a:	610d                	addi	sp,sp,160
    80004e4c:	8082                	ret

0000000080004e4e <sys_chdir>:
...
sys_chdir(void)
{
    ...
    80004e54:	e526                	sd	s1,136(sp)
    80004e56:	e14a                	sd	s2,128(sp)
    80004e58:	1100                	addi	s0,sp,160
  char path[MAXPATH];
  struct inode *ip;
  struct proc *p = myproc();
    80004e5a:	ffffc097          	auipc	ra,0xffffc
    80004e5e:	fee080e7          	jalr	-18(ra) # 80000e48 <myproc>
    80004e62:	892a                	mv	s2,a0

  begin_op();
    80004e64:	ffffe097          	auipc	ra,0xffffe
    80004e68:	746080e7          	jalr	1862(ra) # 800035aa <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    80004e6c:	08000613          	li	a2,128
    80004e70:	f6040593          	addi	a1,s0,-160
    80004e74:	4501                	li	a0,0
    80004e76:	ffffd097          	auipc	ra,0xffffd
    80004e7a:	0c2080e7          	jalr	194(ra) # 80001f38 <argstr>
    80004e7e:	04054b63          	bltz	a0,80004ed4 <sys_chdir+0x86>
    80004e82:	f6040513          	addi	a0,s0,-160
    80004e86:	ffffe097          	auipc	ra,0xffffe
    80004e8a:	508080e7          	jalr	1288(ra) # 8000338e <namei>
    80004e8e:	84aa                	mv	s1,a0
    80004e90:	c131                	beqz	a0,80004ed4 <sys_chdir+0x86>
    end_op();
    return -1;
  }
  ilock(ip);
    80004e92:	ffffe097          	auipc	ra,0xffffe
    80004e96:	c9a080e7          	jalr	-870(ra) # 80002b2c <ilock>
  if(ip->type != T_DIR){
    80004e9a:	04449703          	lh	a4,68(s1)
    80004e9e:	4785                	li	a5,1
    80004ea0:	04f71063          	bne	a4,a5,80004ee0 <sys_chdir+0x92>
    iunlockput(ip);
    end_op();
    return -1;
  }
  iunlock(ip);
    ...
    80004eaa:	d48080e7          	jalr	-696(ra) # 80002bee <iunlock>
  iput(p->cwd);
    80004eae:	15093503          	ld	a0,336(s2)
    80004eb2:	ffffe097          	auipc	ra,0xffffe
    80004eb6:	ede080e7          	jalr	-290(ra) # 80002d90 <iput>
  end_op();
    80004eba:	ffffe097          	auipc	ra,0xffffe
    80004ebe:	770080e7          	jalr	1904(ra) # 8000362a <end_op>
  p->cwd = ip;
    80004ec2:	14993823          	sd	s1,336(s2)
  return 0;
    80004ec6:	4501                	li	a0,0
}
    80004ec8:	60ea                	ld	ra,152(sp)
    80004eca:	644a                	ld	s0,144(sp)
    80004ecc:	64aa                	ld	s1,136(sp)
    80004ece:	690a                	ld	s2,128(sp)
    80004ed0:	610d                	addi	sp,sp,160
    80004ed2:	8082                	ret
    end_op();
    80004ed4:	ffffe097          	auipc	ra,0xffffe
    80004ed8:	756080e7          	jalr	1878(ra) # 8000362a <end_op>
    return -1;
    80004edc:	557d                	li	a0,-1
    80004ede:	b7ed                	j	80004ec8 <sys_chdir+0x7a>
    iunlockput(ip);
    80004ee0:	8526                	mv	a0,s1
    80004ee2:	ffffe097          	auipc	ra,0xffffe
    80004ee6:	f56080e7          	jalr	-170(ra) # 80002e38 <iunlockput>
    end_op();
    80004eea:	ffffe097          	auipc	ra,0xffffe
    80004eee:	740080e7          	jalr	1856(ra) # 8000362a <end_op>
    return -1;
    80004ef2:	557d                	li	a0,-1
    80004ef4:	bfd1                	j	80004ec8 <sys_chdir+0x7a>

0000000080004ef6 <sys_exec>:

uint64
sys_exec(void)
{
    80004ef6:	7145                	addi	sp,sp,-464
    80004ef8:	e786                	sd	ra,456(sp)
    80004efa:	e3a2                	sd	s0,448(sp)
    80004efc:	ff26                	sd	s1,440(sp)
    80004efe:	fb4a                	sd	s2,432(sp)
    80004f00:	f74e                	sd	s3,424(sp)
    80004f02:	f352                	sd	s4,416(sp)
    80004f04:	ef56                	sd	s5,408(sp)
    80004f06:	0b80                	addi	s0,sp,464
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80004f0c:	f4040593          	addi	a1,s0,-192
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    80004f1c:	0c054a63          	bltz	a0,80004ff0 <sys_exec+0xfa>
    80004f20:	e3840593          	addi	a1,s0,-456
    80004f24:	4505                	li	a0,1
    80004f26:	ffffd097          	auipc	ra,0xffffd
    80004f2a:	ff0080e7          	jalr	-16(ra) # 80001f16 <argaddr>
    80004f2e:	0c054163          	bltz	a0,80004ff0 <sys_exec+0xfa>
  }
  memset(argv, 0, sizeof(argv));
    80004f32:	10000613          	li	a2,256
    80004f36:	4581                	li	a1,0
    80004f38:	e4040513          	addi	a0,s0,-448
    80004f3c:	ffffb097          	auipc	ra,0xffffb
    80004f40:	23c080e7          	jalr	572(ra) # 80000178 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
    80004f44:	e4040493          	addi	s1,s0,-448
  memset(argv, 0, sizeof(argv));
    80004f48:	89a6                	mv	s3,s1
    80004f4a:	4901                	li	s2,0
    if(i >= NELEM(argv)){
    80004f4c:	02000a13          	li	s4,32
    80004f50:	00090a9b          	sext.w	s5,s2
      goto bad;
    }
    if(fetchaddr(uargv+sizeof(uint64)*i, (uint64*)&uarg) < 0){
    80004f54:	00391513          	slli	a0,s2,0x3
    80004f58:	e3040593          	addi	a1,s0,-464
    80004f5c:	e3843783          	ld	a5,-456(s0)
    80004f60:	953e                	add	a0,a0,a5
    80004f62:	ffffd097          	auipc	ra,0xffffd
    80004f66:	ef8080e7          	jalr	-264(ra) # 80001e5a <fetchaddr>
    80004f6a:	02054a63          	bltz	a0,80004f9e <sys_exec+0xa8>
      goto bad;
    }
    if(uarg == 0){
    80004f6e:	e3043783          	ld	a5,-464(s0)
    80004f72:	c3b9                	beqz	a5,80004fb8 <sys_exec+0xc2>
      argv[i] = 0;
      break;
    }
    argv[i] = kalloc();
    80004f74:	ffffb097          	auipc	ra,0xffffb
    80004f78:	1a4080e7          	jalr	420(ra) # 80000118 <kalloc>
    80004f7c:	85aa                	mv	a1,a0
    80004f7e:	00a9b023          	sd	a0,0(s3)
    if(argv[i] == 0)
    80004f82:	cd11                	beqz	a0,80004f9e <sys_exec+0xa8>
      goto bad;
    if(fetchstr(uarg, argv[i], PGSIZE) < 0)
    80004f84:	6605                	lui	a2,0x1
    80004f86:	e3043503          	ld	a0,-464(s0)
    80004f8a:	ffffd097          	auipc	ra,0xffffd
    80004f8e:	f22080e7          	jalr	-222(ra) # 80001eac <fetchstr>
    80004f92:	00054663          	bltz	a0,80004f9e <sys_exec+0xa8>
    if(i >= NELEM(argv)){
    80004f96:	0905                	addi	s2,s2,1
    80004f98:	09a1                	addi	s3,s3,8
    80004f9a:	fb491be3          	bne	s2,s4,80004f50 <sys_exec+0x5a>
    kfree(argv[i]);
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80004f9e:	10048913          	addi	s2,s1,256
    80004fa2:	6088                	ld	a0,0(s1)
    80004fa4:	c529                	beqz	a0,80004fee <sys_exec+0xf8>
    kfree(argv[i]);
    80004fa6:	ffffb097          	auipc	ra,0xffffb
    80004faa:	076080e7          	jalr	118(ra) # 8000001c <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80004fae:	04a1                	addi	s1,s1,8
    80004fb0:	ff2499e3          	bne	s1,s2,80004fa2 <sys_exec+0xac>
  return -1;
    80004fb4:	597d                	li	s2,-1
    80004fb6:	a82d                	j	80004ff0 <sys_exec+0xfa>
      argv[i] = 0;
    80004fb8:	0a8e                	slli	s5,s5,0x3
    80004fba:	fc040793          	addi	a5,s0,-64
    80004fbe:	9abe                	add	s5,s5,a5
    80004fc0:	e80ab023          	sd	zero,-384(s5)
  int ret = exec(path, argv);
    80004fc4:	e4040593          	addi	a1,s0,-448
    80004fc8:	f4040513          	addi	a0,s0,-192
    80004fcc:	fffff097          	auipc	ra,0xfffff
    80004fd0:	10a080e7          	jalr	266(ra) # 800040d6 <exec>
    80004fd4:	892a                	mv	s2,a0
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80004fd6:	10048993          	addi	s3,s1,256
    80004fda:	6088                	ld	a0,0(s1)
    80004fdc:	c911                	beqz	a0,80004ff0 <sys_exec+0xfa>
    kfree(argv[i]);
    80004fde:	ffffb097          	auipc	ra,0xffffb
    80004fe2:	03e080e7          	jalr	62(ra) # 8000001c <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80004fe6:	04a1                	addi	s1,s1,8
    80004fe8:	ff3499e3          	bne	s1,s3,80004fda <sys_exec+0xe4>
    80004fec:	a011                	j	80004ff0 <sys_exec+0xfa>
  return -1;
    80004fee:	597d                	li	s2,-1
}
    80004ff0:	854a                	mv	a0,s2
    80004ff2:	60be                	ld	ra,456(sp)
    80004ff4:	641e                	ld	s0,448(sp)
    80004ff6:	74fa                	ld	s1,440(sp)
    80004ff8:	795a                	ld	s2,432(sp)
    80004ffa:	79ba                	ld	s3,424(sp)
    80004ffc:	7a1a                	ld	s4,416(sp)
    80004ffe:	6afa                	ld	s5,408(sp)
    80005000:	6179                	addi	sp,sp,464
    80005002:	8082                	ret
...
sys_pipe(void)
{
  ...
  struct proc *p = myproc();
    ...
    80005012:	e3a080e7          	jalr	-454(ra) # 80000e48 <myproc>
  ...
  if(argaddr(0, &fdarray) < 0)
    ...
    80005022:	ef8080e7          	jalr	-264(ra) # 80001f16 <argaddr>
    return -1;
  ...
  if(pipealloc(&rf, &wf) < 0)
    ...
    80005038:	d72080e7          	jalr	-654(ra) # 80003da6 <pipealloc>
    return -1;
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    ...
    8000504e:	47e080e7          	jalr	1150(ra) # 800044c8 <fdalloc>
    ...
    80005062:	46a080e7          	jalr	1130(ra) # 800044c8 <fdalloc>
    80005066:	fca42023          	sw	a0,-64(s0)
    8000506a:	06054863          	bltz	a0,800050da <sys_pipe+0xd6>
      p->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    8000507e:	a90080e7          	jalr	-1392(ra) # 80000b0a <copyout>
    ...
    80005098:	a76080e7          	jalr	-1418(ra) # 80000b0a <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    p->ofile[fd1] = 0;
    800050b0:	fc042503          	lw	a0,-64(s0)
    800050b4:	0569                	addi	a0,a0,26
    800050b6:	050e                	slli	a0,a0,0x3
    800050b8:	9526                	add	a0,a0,s1
    800050ba:	00053023          	sd	zero,0(a0)
    fileclose(rf);
    800050be:	fd043503          	ld	a0,-48(s0)
    800050c2:	fffff097          	auipc	ra,0xfffff
    800050c6:	9b4080e7          	jalr	-1612(ra) # 80003a76 <fileclose>
    fileclose(wf);
    800050ca:	fc843503          	ld	a0,-56(s0)
    800050ce:	fffff097          	auipc	ra,0xfffff
    800050d2:	9a8080e7          	jalr	-1624(ra) # 80003a76 <fileclose>
    return -1;
    800050d6:	57fd                	li	a5,-1
    800050d8:	a805                	j	80005108 <sys_pipe+0x104>
    if(fd0 >= 0)
    800050da:	fc442783          	lw	a5,-60(s0)
    800050de:	0007c863          	bltz	a5,800050ee <sys_pipe+0xea>
      p->ofile[fd0] = 0;
    800050e2:	01a78513          	addi	a0,a5,26
    800050e6:	050e                	slli	a0,a0,0x3
    800050e8:	9526                	add	a0,a0,s1
    800050ea:	00053023          	sd	zero,0(a0)
    fileclose(rf);
    800050ee:	fd043503          	ld	a0,-48(s0)
    800050f2:	fffff097          	auipc	ra,0xfffff
    800050f6:	984080e7          	jalr	-1660(ra) # 80003a76 <fileclose>
    fileclose(wf);
    800050fa:	fc843503          	ld	a0,-56(s0)
    800050fe:	fffff097          	auipc	ra,0xfffff
    80005102:	978080e7          	jalr	-1672(ra) # 80003a76 <fileclose>
    return -1;
...
0000000080005114 <sys_symlink>:

uint64 sys_symlink(void)
{
    80005114:	712d                	addi	sp,sp,-288
    80005116:	ee06                	sd	ra,280(sp)
    80005118:	ea22                	sd	s0,272(sp)
    8000511a:	e626                	sd	s1,264(sp)
    8000511c:	1200                	addi	s0,sp,288
    ...
    8000512c:	e10080e7          	jalr	-496(ra) # 80001f38 <argstr>
    {
        return -1;
    80005130:	57fd                	li	a5,-1
    if (argstr(0, target, MAXPATH) < 0 || argstr(1, path, MAXPATH) < 0)
    80005132:	04054f63          	bltz	a0,80005190 <sys_symlink+0x7c>
    80005136:	08000613          	li	a2,128
    8000513a:	ee040593          	addi	a1,s0,-288
    8000513e:	4505                	li	a0,1
    80005140:	ffffd097          	auipc	ra,0xffffd
    80005144:	df8080e7          	jalr	-520(ra) # 80001f38 <argstr>
        return -1;
    80005148:	57fd                	li	a5,-1
    if (argstr(0, target, MAXPATH) < 0 || argstr(1, path, MAXPATH) < 0)
    8000514a:	04054363          	bltz	a0,80005190 <sys_symlink+0x7c>
    }

    begin_op();
    8000514e:	ffffe097          	auipc	ra,0xffffe
    80005152:	45c080e7          	jalr	1116(ra) # 800035aa <begin_op>

    if ((ip = namei(path)) == 0)
    80005156:	ee040513          	addi	a0,s0,-288
    8000515a:	ffffe097          	auipc	ra,0xffffe
    8000515e:	234080e7          	jalr	564(ra) # 8000338e <namei>
    80005162:	84aa                	mv	s1,a0
    80005164:	cd05                	beqz	a0,8000519c <sys_symlink+0x88>
    {
    ...
    8000516c:	9c4080e7          	jalr	-1596(ra) # 80002b2c <ilock>

    if (writei(ip, 0, (uint64)target, ip->size, MAXPATH) != MAXPATH)
    80005170:	08000713          	li	a4,128
    80005174:	44f4                	lw	a3,76(s1)
    80005176:	f6040613          	addi	a2,s0,-160
    8000517a:	4581                	li	a1,0
    8000517c:	8526                	mv	a0,s1
    8000517e:	ffffe097          	auipc	ra,0xffffe
    80005182:	e04080e7          	jalr	-508(ra) # 80002f82 <writei>
    80005186:	08000713          	li	a4,128
    {
        return -1;
    8000518a:	57fd                	li	a5,-1
    if (writei(ip, 0, (uint64)target, ip->size, MAXPATH) != MAXPATH)
    8000518c:	02e50763          	beq	a0,a4,800051ba <sys_symlink+0xa6>
    ...
    80005192:	60f2                	ld	ra,280(sp)
    80005194:	6452                	ld	s0,272(sp)
    80005196:	64b2                	ld	s1,264(sp)
    80005198:	6115                	addi	sp,sp,288
    8000519a:	8082                	ret
        ip = create(path, T_SYMLINK, 0, 0);
    8000519c:	4681                	li	a3,0
    8000519e:	4601                	li	a2,0
    800051a0:	4591                	li	a1,4
    800051a2:	ee040513          	addi	a0,s0,-288
    800051a6:	fffff097          	auipc	ra,0xfffff
    800051aa:	364080e7          	jalr	868(ra) # 8000450a <create>
    800051ae:	84aa                	mv	s1,a0
        iunlock(ip);
    800051b0:	ffffe097          	auipc	ra,0xffffe
    800051b4:	a3e080e7          	jalr	-1474(ra) # 80002bee <iunlock>
    800051b8:	b77d                	j	80005166 <sys_symlink+0x52>
    iunlockput(ip);
    800051ba:	8526                	mv	a0,s1
    800051bc:	ffffe097          	auipc	ra,0xffffe
    800051c0:	c7c080e7          	jalr	-900(ra) # 80002e38 <iunlockput>
    end_op();
    800051c4:	ffffe097          	auipc	ra,0xffffe
    800051c8:	466080e7          	jalr	1126(ra) # 8000362a <end_op>
    return 0;
    800051cc:	4781                	li	a5,0
    800051ce:	b7c9                	j	80005190 <sys_symlink+0x7c>

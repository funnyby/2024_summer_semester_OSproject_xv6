...
0000000080000000 <_entry>:
    ...
    80000016:	752060ef          	jal	ra,80006768 <start>
...
kfree(void *pa)
{
  ...
  acquire(&kmem.lock);
    ...
    8000005e:	108080e7          	jalr	264(ra) # 80007162 <acquire>
  ...
  release(&kmem.lock);
    ...
    80000072:	1a8080e7          	jalr	424(ra) # 80007216 <release>
}
    ...
    8000008e:	b8e080e7          	jalr	-1138(ra) # 80006c18 <panic>
...
00000000800000dc <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000f8:	fde080e7          	jalr	-34(ra) # 800070d2 <initlock>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000130:	036080e7          	jalr	54(ra) # 80007162 <acquire>
  r = kmem.freelist;
  ...
  release(&kmem.lock);
    ...
    80000148:	0d2080e7          	jalr	210(ra) # 80007216 <release>
  ...
  release(&kmem.lock);
    ...
    80000172:	0a8080e7          	jalr	168(ra) # 80007216 <release>
  if(r)
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000348:	f30080e7          	jalr	-208(ra) # 80007274 <lockfree_read4>
    ...
    80000368:	8fe080e7          	jalr	-1794(ra) # 80006c62 <printf>
  ...
  scheduler();        
    ...
    80000430:	23c080e7          	jalr	572(ra) # 80006668 <pci_init>
    sockinit();
    80000434:	00006097          	auipc	ra,0x6
    80000438:	e2a080e7          	jalr	-470(ra) # 8000625e <sockinit>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    800004aa:	772080e7          	jalr	1906(ra) # 80006c18 <panic>
...
0000000080000600 <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    8000062c:	5f0080e7          	jalr	1520(ra) # 80006c18 <panic>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  memmove(mem, src, sz);
    ...
    800008ca:	352080e7          	jalr	850(ra) # 80006c18 <panic>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    80000a0c:	210080e7          	jalr	528(ra) # 80006c18 <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000b62:	0ba080e7          	jalr	186(ra) # 80006c18 <panic>
...
proc_mapstacks(pagetable_t kpgtbl) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000dc2:	e5a080e7          	jalr	-422(ra) # 80006c18 <panic>
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000dee:	2e8080e7          	jalr	744(ra) # 800070d2 <initlock>
  initlock(&wait_lock, "wait_lock");
    ...
    80000e06:	2d0080e7          	jalr	720(ra) # 800070d2 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000e3c:	29a080e7          	jalr	666(ra) # 800070d2 <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000eae:	26c080e7          	jalr	620(ra) # 80007116 <push_off>
  ...
  pop_off();
    ...
    80000ec8:	2f2080e7          	jalr	754(ra) # 800071b6 <pop_off>
  return p;
}
...
forkret(void)
{
  ...
  release(&myproc()->lock);
    ...
    80000eec:	32e080e7          	jalr	814(ra) # 80007216 <release>
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000f38:	22e080e7          	jalr	558(ra) # 80007162 <acquire>
  pid = nextpid;
  ...
  release(&pid_lock);
    ...
    80000f52:	2c8080e7          	jalr	712(ra) # 80007216 <release>
}
...
00000000800010aa <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800010cc:	09a080e7          	jalr	154(ra) # 80007162 <acquire>
    if(p->state == UNUSED) {
    ...
    800010da:	140080e7          	jalr	320(ra) # 80007216 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  p->context.sp = p->kstack + PGSIZE;
    ...
    80001158:	0c2080e7          	jalr	194(ra) # 80007216 <release>
    return 0;
    ...
    80001170:	0aa080e7          	jalr	170(ra) # 80007216 <release>
    return 0;
...
0000000080001178 <userinit>:
{
  ...
  release(&p->lock);
    ...
    800011ec:	02e080e7          	jalr	46(ra) # 80007216 <release>
}
...
000000008000126e <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    80001304:	f16080e7          	jalr	-234(ra) # 80007216 <release>
    return -1;
  ...
  release(&np->lock);
    ...
    80001356:	ec4080e7          	jalr	-316(ra) # 80007216 <release>
  acquire(&wait_lock);
    ...
    80001368:	dfe080e7          	jalr	-514(ra) # 80007162 <acquire>
  np->parent = p;
    8000136c:	0329bc23          	sd	s2,56(s3)
  release(&wait_lock);
    80001370:	8526                	mv	a0,s1
    80001372:	00006097          	auipc	ra,0x6
    80001376:	ea4080e7          	jalr	-348(ra) # 80007216 <release>
  acquire(&np->lock);
    8000137a:	854e                	mv	a0,s3
    8000137c:	00006097          	auipc	ra,0x6
    80001380:	de6080e7          	jalr	-538(ra) # 80007162 <acquire>
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    80001390:	e8a080e7          	jalr	-374(ra) # 80007216 <release>
}
...
00000000800013aa <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    8000142c:	dee080e7          	jalr	-530(ra) # 80007216 <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000143e:	d28080e7          	jalr	-728(ra) # 80007162 <acquire>
      if(p->state == RUNNABLE) {
...
000000008000144a <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    80001466:	c86080e7          	jalr	-890(ra) # 800070e8 <holding>
...
0000000080001520 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    80001538:	c2e080e7          	jalr	-978(ra) # 80007162 <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    8000154e:	ccc080e7          	jalr	-820(ra) # 80007216 <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    8000157c:	bea080e7          	jalr	-1046(ra) # 80007162 <acquire>
  release(lk);
    80001580:	854a                	mv	a0,s2
    80001582:	00006097          	auipc	ra,0x6
    80001586:	c94080e7          	jalr	-876(ra) # 80007216 <release>
  ...
  release(&p->lock);
    ...
    800015a4:	c76080e7          	jalr	-906(ra) # 80007216 <release>
  acquire(lk);
    800015a8:	854a                	mv	a0,s2
    800015aa:	00006097          	auipc	ra,0x6
    800015ae:	bb8080e7          	jalr	-1096(ra) # 80007162 <acquire>
}
...
00000000800015c0 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    800015f0:	b76080e7          	jalr	-1162(ra) # 80007162 <acquire>
    havekids = 0;
    ...
    8000168e:	ad8080e7          	jalr	-1320(ra) # 80007162 <acquire>
        if(np->state == ZOMBIE){
    ...
    8000169e:	b7c080e7          	jalr	-1156(ra) # 80007216 <release>
        havekids = 1;
    ...
    800016ba:	b60080e7          	jalr	-1184(ra) # 80007216 <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000171c:	afe080e7          	jalr	-1282(ra) # 80007216 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000173a:	a2c080e7          	jalr	-1492(ra) # 80007162 <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
00000000800017b8 <exit>:
{
  ...
  if(p == initproc)
    ...
    800017f4:	428080e7          	jalr	1064(ra) # 80006c18 <panic>
      fileclose(f);
  ...
  acquire(&wait_lock);
    ...
    8000183e:	928080e7          	jalr	-1752(ra) # 80007162 <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    8000185e:	908080e7          	jalr	-1784(ra) # 80007162 <acquire>
  p->xstate = status;
  ...
  release(&wait_lock);
    ...
    80001872:	9a8080e7          	jalr	-1624(ra) # 80007216 <release>
  sched();
  ...
  panic("zombie exit");
    ...
    8000188a:	392080e7          	jalr	914(ra) # 80006c18 <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800018b4:	8b2080e7          	jalr	-1870(ra) # 80007162 <acquire>
    if(p->pid == pid){
    ...
    800018c4:	956080e7          	jalr	-1706(ra) # 80007216 <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    800018e6:	934080e7          	jalr	-1740(ra) # 80007216 <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    800019ce:	298080e7          	jalr	664(ra) # 80006c62 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001a10:	256080e7          	jalr	598(ra) # 80006c62 <printf>
    printf("\n");
    80001a14:	8552                	mv	a0,s4
    80001a16:	00005097          	auipc	ra,0x5
    80001a1a:	24c080e7          	jalr	588(ra) # 80006c62 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001ae0:	5f6080e7          	jalr	1526(ra) # 800070d2 <initlock>
}
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001bba:	5ac080e7          	jalr	1452(ra) # 80007162 <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001bda:	640080e7          	jalr	1600(ra) # 80007216 <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001c4a:	01c080e7          	jalr	28(ra) # 80006c62 <printf>
    80001c4e:	a029                	j	80001c58 <devintr+0x70>
      uartintr();
    80001c50:	00005097          	auipc	ra,0x5
    80001c54:	432080e7          	jalr	1074(ra) # 80007082 <uartintr>
      plic_complete(irq);
    ...
    80001c74:	d82080e7          	jalr	-638(ra) # 800059f2 <e1000_intr>
...
0000000080001c9c <usertrap>:
{
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001cee:	58a080e7          	jalr	1418(ra) # 80007274 <lockfree_read4>
    ...
    80001d02:	f1a080e7          	jalr	-230(ra) # 80006c18 <panic>
    if(lockfree_read4(&p->killed))
    80001d06:	02850513          	addi	a0,a0,40
    80001d0a:	00005097          	auipc	ra,0x5
    80001d0e:	56a080e7          	jalr	1386(ra) # 80007274 <lockfree_read4>
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001d38:	540080e7          	jalr	1344(ra) # 80007274 <lockfree_read4>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001d82:	ee4080e7          	jalr	-284(ra) # 80006c62 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001d9a:	ecc080e7          	jalr	-308(ra) # 80006c62 <printf>
    p->killed = 1;
...
0000000080001dae <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001e08:	e14080e7          	jalr	-492(ra) # 80006c18 <panic>
    ...
    80001e18:	e04080e7          	jalr	-508(ra) # 80006c18 <panic>
    printf("scause %p\n", scause);
    ...
    80001e2a:	e3c080e7          	jalr	-452(ra) # 80006c62 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001ede:	d3e080e7          	jalr	-706(ra) # 80006c18 <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002046:	c20080e7          	jalr	-992(ra) # 80006c62 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    8000216c:	ffa080e7          	jalr	-6(ra) # 80007162 <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    800021c0:	05a080e7          	jalr	90(ra) # 80007216 <release>
  return 0;
    ...
    800021e2:	038080e7          	jalr	56(ra) # 80007216 <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002232:	f34080e7          	jalr	-204(ra) # 80007162 <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    8000224a:	fd0080e7          	jalr	-48(ra) # 80007216 <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002282:	e54080e7          	jalr	-428(ra) # 800070d2 <initlock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    8000230a:	e5c080e7          	jalr	-420(ra) # 80007162 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    8000234a:	ed0080e7          	jalr	-304(ra) # 80007216 <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    80002388:	894080e7          	jalr	-1900(ra) # 80006c18 <panic>
      b->dev = dev;
    ...
    800023a8:	e72080e7          	jalr	-398(ra) # 80007216 <release>
      acquiresleep(&b->lock);
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002418:	804080e7          	jalr	-2044(ra) # 80006c18 <panic>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002450:	d16080e7          	jalr	-746(ra) # 80007162 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    8000249a:	d80080e7          	jalr	-640(ra) # 80007216 <release>
}
    ...
    800024b6:	766080e7          	jalr	1894(ra) # 80006c18 <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800024d2:	c94080e7          	jalr	-876(ra) # 80007162 <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    800024e8:	d32080e7          	jalr	-718(ra) # 80007216 <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000250e:	c58080e7          	jalr	-936(ra) # 80007162 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002524:	cf6080e7          	jalr	-778(ra) # 80007216 <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    800025aa:	672080e7          	jalr	1650(ra) # 80006c18 <panic>
...
00000000800025ae <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    80002670:	5ac080e7          	jalr	1452(ra) # 80006c18 <panic>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800027b6:	466080e7          	jalr	1126(ra) # 80006c18 <panic>
...
00000000800027ba <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    800027da:	98c080e7          	jalr	-1652(ra) # 80007162 <acquire>
  empty = 0;
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002820:	9fa080e7          	jalr	-1542(ra) # 80007216 <release>
      return ip;
  ...
  release(&itable.lock);
    ...
    80002850:	9ca080e7          	jalr	-1590(ra) # 80007216 <release>
}
    ...
    80002872:	3aa080e7          	jalr	938(ra) # 80006c18 <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    800028f2:	32a080e7          	jalr	810(ra) # 80006c18 <panic>
...
00000000800028f6 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80002918:	7be080e7          	jalr	1982(ra) # 800070d2 <initlock>
  for(i = 0; i < NINODE; i++) {
...
0000000080002956 <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    800029d6:	246080e7          	jalr	582(ra) # 80006c18 <panic>
...
0000000080002ab0 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002ac8:	69e080e7          	jalr	1694(ra) # 80007162 <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    80002ade:	73c080e7          	jalr	1852(ra) # 80007216 <release>
}
...
0000000080002aee <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002b2a:	0f2080e7          	jalr	242(ra) # 80006c18 <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002bac:	070080e7          	jalr	112(ra) # 80006c18 <panic>
...
0000000080002bb0 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002bf8:	024080e7          	jalr	36(ra) # 80006c18 <panic>
...
0000000080002ca8 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002cc2:	4a4080e7          	jalr	1188(ra) # 80007162 <acquire>
  ...
  release(&itable.lock);
    ...
    80002ce0:	53a080e7          	jalr	1338(ra) # 80007216 <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002d14:	506080e7          	jalr	1286(ra) # 80007216 <release>
    itrunc(ip);
    ...
    80002d4a:	41c080e7          	jalr	1052(ra) # 80007162 <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003008:	c14080e7          	jalr	-1004(ra) # 80006c18 <panic>
    ...
    80003018:	c04080e7          	jalr	-1020(ra) # 80006c18 <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
000000008000341c <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003444:	c92080e7          	jalr	-878(ra) # 800070d2 <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800034d8:	c8e080e7          	jalr	-882(ra) # 80007162 <acquire>
  while(1){
    if(log.committing){
    ...
    80003530:	cea080e7          	jalr	-790(ra) # 80007216 <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003560:	c06080e7          	jalr	-1018(ra) # 80007162 <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    80003588:	c92080e7          	jalr	-878(ra) # 80007216 <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800035a0:	bc6080e7          	jalr	-1082(ra) # 80007162 <acquire>
    log.committing = 0;
    ...
    800035b8:	c62080e7          	jalr	-926(ra) # 80007216 <release>
}
    ...
    800035da:	642080e7          	jalr	1602(ra) # 80006c18 <panic>
    wakeup(&log);
  ...
  release(&log.lock);
    ...
    800035f6:	c24080e7          	jalr	-988(ra) # 80007216 <release>
  if(do_commit){
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800036b4:	ab2080e7          	jalr	-1358(ra) # 80007162 <acquire>
  ...
  release(&log.lock);
    ...
    8000376e:	aac080e7          	jalr	-1364(ra) # 80007216 <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    8000379c:	93a080e7          	jalr	-1734(ra) # 800070d2 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800037d0:	996080e7          	jalr	-1642(ra) # 80007162 <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    800037fe:	a1c080e7          	jalr	-1508(ra) # 80007216 <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003826:	940080e7          	jalr	-1728(ra) # 80007162 <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    80003842:	9d8080e7          	jalr	-1576(ra) # 80007216 <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000386c:	8fa080e7          	jalr	-1798(ra) # 80007162 <acquire>
  ...
  release(&lk->lk);
    ...
    8000387c:	99e080e7          	jalr	-1634(ra) # 80007216 <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800038c4:	812080e7          	jalr	-2030(ra) # 800070d2 <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800038e6:	880080e7          	jalr	-1920(ra) # 80007162 <acquire>
  ...
  release(&ftable.lock);
    ...
    80003912:	908080e7          	jalr	-1784(ra) # 80007216 <release>
  return 0;
    ...
    8000392a:	8f0080e7          	jalr	-1808(ra) # 80007216 <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003952:	814080e7          	jalr	-2028(ra) # 80007162 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    8000396c:	8ae080e7          	jalr	-1874(ra) # 80007216 <release>
  return f;
}
    ...
    80003988:	294080e7          	jalr	660(ra) # 80006c18 <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800039ae:	7b8080e7          	jalr	1976(ra) # 80007162 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800039ec:	82e080e7          	jalr	-2002(ra) # 80007216 <release>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003a0c:	9a4080e7          	jalr	-1628(ra) # 800063ac <sockclose>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003b1c:	924080e7          	jalr	-1756(ra) # 8000643c <sockread>
  ...
  return r;
    ...
    80003ba8:	074080e7          	jalr	116(ra) # 80006c18 <panic>
    return -1;
    ...
    80003bbc:	12078263          	beqz	a5,80003ce0 <filewrite+0x128>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003bfe:	912080e7          	jalr	-1774(ra) # 8000650c <sockwrite>
  else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80003cdc:	f40080e7          	jalr	-192(ra) # 80006c18 <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003d4c:	38a080e7          	jalr	906(ra) # 800070d2 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003dda:	38c080e7          	jalr	908(ra) # 80007162 <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003dfe:	41c080e7          	jalr	1052(ra) # 80007216 <release>
    kfree((char*)pi);
    ...
    80003e30:	3ea080e7          	jalr	1002(ra) # 80007216 <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003e66:	300080e7          	jalr	768(ra) # 80007162 <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003e84:	396080e7          	jalr	918(ra) # 80007216 <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003f26:	2f4080e7          	jalr	756(ra) # 80007216 <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003f5c:	20a080e7          	jalr	522(ra) # 80007162 <acquire>
  ...
  release(&pi->lock);
    ...
    80003ff0:	22a080e7          	jalr	554(ra) # 80007216 <release>
  return i;
}
    ...
    80004010:	20a080e7          	jalr	522(ra) # 80007216 <release>
      return -1;
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004118:	b04080e7          	jalr	-1276(ra) # 80006c18 <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    8000454a:	6d2080e7          	jalr	1746(ra) # 80006c18 <panic>
    dp->nlink++;  // for ".."
...
00000000800048b8 <sys_unlink>:
{
  ...
  return 0;
    ...
    800049e4:	238080e7          	jalr	568(ra) # 80006c18 <panic>
...
sys_connect(void)
{
  ...
  if(sockalloc(&f, raddr, lport, rport) < 0)
    ...
    80005022:	268080e7          	jalr	616(ra) # 80006286 <sockalloc>
...
000000008000527c <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    8000529a:	e3c080e7          	jalr	-452(ra) # 800070d2 <initlock>
  ...
  *R(VIRTIO_MMIO_QUEUE_PFN) = ((uint64)disk.pages) >> PGSHIFT;
  ...
  disk.used = (struct virtq_used *) (disk.pages + PGSIZE);
    ...
    8000539c:	880080e7          	jalr	-1920(ra) # 80006c18 <panic>
    ...
    800053ac:	870080e7          	jalr	-1936(ra) # 80006c18 <panic>
    ...
    800053bc:	860080e7          	jalr	-1952(ra) # 80006c18 <panic>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800053fa:	d6c080e7          	jalr	-660(ra) # 80007162 <acquire>
  for(int i = 0; i < 3; i++){
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  release(&disk.vdisk_lock);
    ...
    80005634:	be6080e7          	jalr	-1050(ra) # 80007216 <release>
}
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800056ae:	ab8080e7          	jalr	-1352(ra) # 80007162 <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005740:	ada080e7          	jalr	-1318(ra) # 80007216 <release>
}
    ...
    8000575c:	4c0080e7          	jalr	1216(ra) # 80006c18 <panic>
...
e1000_init(uint32 *xregs)
{
  ...
  initlock(&e1000_lock, "e1000");
    ...
    80005784:	952080e7          	jalr	-1710(ra) # 800070d2 <initlock>
  ...
  for (i = 0; i < RX_RING_SIZE; i++) {
    ...
    8000583e:	466080e7          	jalr	1126(ra) # 80005ca0 <mbufalloc>
  ...
  regs[E1000_IMS] = (1 << 7); // RXDW -- Receiver Descriptor Write Back
    ...
    80005900:	31c080e7          	jalr	796(ra) # 80006c18 <panic>
...
e1000_transmit(struct mbuf *m)
{
  ...
  acquire(&e1000_lock);
    ...
    80005922:	844080e7          	jalr	-1980(ra) # 80007162 <acquire>
  ...
  if (tx_ring[idx].status != E1000_TXD_STAT_DD)
    ...
    80005948:	08f71663          	bne	a4,a5,800059d4 <e1000_transmit+0xd0>
    ...
    8000596a:	392080e7          	jalr	914(ra) # 80005cf8 <mbuffree>
    }
  ...
  release(&e1000_lock);
    ...
    800059c0:	85a080e7          	jalr	-1958(ra) # 80007216 <release>
  return 0;
  ...
  // return 0;
    ...
    800059ca:	64e2                	ld	s1,24(sp)
    800059cc:	6942                	ld	s2,16(sp)
    800059ce:	69a2                	ld	s3,8(sp)
    800059d0:	6145                	addi	sp,sp,48
    800059d2:	8082                	ret
    printf("e1000_transmit: tx queue full\n");
    800059d4:	00004517          	auipc	a0,0x4
    800059d8:	e1450513          	addi	a0,a0,-492 # 800097e8 <syscalls+0x410>
    800059dc:	00001097          	auipc	ra,0x1
    800059e0:	286080e7          	jalr	646(ra) # 80006c62 <printf>
    release(&e1000_lock);
    800059e4:	854e                	mv	a0,s3
    800059e6:	00002097          	auipc	ra,0x2
    800059ea:	830080e7          	jalr	-2000(ra) # 80007216 <release>
    return -1;
    800059ee:	557d                	li	a0,-1
    800059f0:	bfd9                	j	800059c6 <e1000_transmit+0xc2>

00000000800059f2 <e1000_intr>:
}
...
e1000_intr(void)
{
    800059f2:	715d                	addi	sp,sp,-80
    800059f4:	e486                	sd	ra,72(sp)
    800059f6:	e0a2                	sd	s0,64(sp)
    800059f8:	fc26                	sd	s1,56(sp)
    800059fa:	f84a                	sd	s2,48(sp)
    800059fc:	f44e                	sd	s3,40(sp)
    800059fe:	f052                	sd	s4,32(sp)
    80005a00:	ec56                	sd	s5,24(sp)
    80005a02:	e85a                	sd	s6,16(sp)
    80005a04:	e45e                	sd	s7,8(sp)
    80005a06:	e062                	sd	s8,0(sp)
    80005a08:	0880                	addi	s0,sp,80
  // tell the e1000 we've seen this interrupt;
  // without this the e1000 won't raise any
  // further interrupts.
  regs[E1000_ICR] = 0xffffffff;
    80005a0a:	00004797          	auipc	a5,0x4
    80005a0e:	6167b783          	ld	a5,1558(a5) # 8000a020 <regs>
    80005a12:	577d                	li	a4,-1
    80005a14:	0ce7a023          	sw	a4,192(a5)
  uint32 idx = (regs[E1000_RDT] + 1) % RX_RING_SIZE;
    80005a18:	670d                	lui	a4,0x3
    80005a1a:	97ba                	add	a5,a5,a4
    80005a1c:	8187a783          	lw	a5,-2024(a5)
    80005a20:	2785                	addiw	a5,a5,1
    80005a22:	00f7f993          	andi	s3,a5,15
  struct rx_desc* dest = &rx_ring[idx];
    80005a26:	00499793          	slli	a5,s3,0x4
    80005a2a:	00019497          	auipc	s1,0x19
    80005a2e:	77648493          	addi	s1,s1,1910 # 8001f1a0 <rx_ring>
    80005a32:	94be                	add	s1,s1,a5
  while (rx_ring[idx].status & E1000_RXD_STAT_DD)
    ...
    80005a44:	cbc1                	beqz	a5,80005ad4 <e1000_intr+0xe2>
    acquire(&e1000_lock);
    80005a46:	893a                	mv	s2,a4
    regs[E1000_RDT] = idx;
    80005a48:	00004a97          	auipc	s5,0x4
    80005a4c:	5d8a8a93          	addi	s5,s5,1496 # 8000a020 <regs>
    80005a50:	6a0d                	lui	s4,0x3
    dest = &rx_ring[idx];
    80005a52:	00019b17          	auipc	s6,0x19
    80005a56:	74eb0b13          	addi	s6,s6,1870 # 8001f1a0 <rx_ring>
    acquire(&e1000_lock);
    80005a5a:	854a                	mv	a0,s2
    80005a5c:	00001097          	auipc	ra,0x1
    80005a60:	706080e7          	jalr	1798(ra) # 80007162 <acquire>
    struct mbuf *buf = rx_mbufs[idx];
    80005a64:	00399b93          	slli	s7,s3,0x3
    80005a68:	9bca                	add	s7,s7,s2
    80005a6a:	2a0bbc03          	ld	s8,672(s7)
    mbufput(buf, dest->length);
    80005a6e:	0084d583          	lhu	a1,8(s1)
    80005a72:	8562                	mv	a0,s8
    80005a74:	00000097          	auipc	ra,0x0
    80005a78:	1d0080e7          	jalr	464(ra) # 80005c44 <mbufput>
    if (!(rx_mbufs[idx] = mbufalloc(0)))
    80005a7c:	4501                	li	a0,0
    80005a7e:	00000097          	auipc	ra,0x0
    80005a82:	222080e7          	jalr	546(ra) # 80005ca0 <mbufalloc>
    80005a86:	2aabb023          	sd	a0,672(s7)
    80005a8a:	c12d                	beqz	a0,80005aec <e1000_intr+0xfa>
    dest->addr = (uint64)rx_mbufs[idx]->head;
    80005a8c:	651c                	ld	a5,8(a0)
    80005a8e:	e09c                	sd	a5,0(s1)
    dest->status = 0;
    80005a90:	00048623          	sb	zero,12(s1)
    regs[E1000_RDT] = idx;
    80005a94:	000ab783          	ld	a5,0(s5)
    80005a98:	97d2                	add	a5,a5,s4
    80005a9a:	8137ac23          	sw	s3,-2024(a5)
    release(&e1000_lock);
    80005a9e:	854a                	mv	a0,s2
    80005aa0:	00001097          	auipc	ra,0x1
    80005aa4:	776080e7          	jalr	1910(ra) # 80007216 <release>
    net_rx(buf);
    80005aa8:	8562                	mv	a0,s8
    80005aaa:	00000097          	auipc	ra,0x0
    80005aae:	3c2080e7          	jalr	962(ra) # 80005e6c <net_rx>
    idx = (regs[E1000_RDT] + 1) % RX_RING_SIZE;
    80005ab2:	000ab783          	ld	a5,0(s5)
    80005ab6:	97d2                	add	a5,a5,s4
    80005ab8:	8187a783          	lw	a5,-2024(a5)
    80005abc:	2785                	addiw	a5,a5,1
    80005abe:	00f7f993          	andi	s3,a5,15
    dest = &rx_ring[idx];
    80005ac2:	00499793          	slli	a5,s3,0x4
    80005ac6:	00fb04b3          	add	s1,s6,a5
  while (rx_ring[idx].status & E1000_RXD_STAT_DD)
    80005aca:	97ca                	add	a5,a5,s2
    80005acc:	1ac7c783          	lbu	a5,428(a5)
    80005ad0:	8b85                	andi	a5,a5,1
    80005ad2:	f7c1                	bnez	a5,80005a5a <e1000_intr+0x68>

  e1000_recv();
    80005ad4:	60a6                	ld	ra,72(sp)
    80005ad6:	6406                	ld	s0,64(sp)
    80005ad8:	74e2                	ld	s1,56(sp)
    80005ada:	7942                	ld	s2,48(sp)
    80005adc:	79a2                	ld	s3,40(sp)
    80005ade:	7a02                	ld	s4,32(sp)
    80005ae0:	6ae2                	ld	s5,24(sp)
    80005ae2:	6b42                	ld	s6,16(sp)
    80005ae4:	6ba2                	ld	s7,8(sp)
    80005ae6:	6c02                	ld	s8,0(sp)
    80005ae8:	6161                	addi	sp,sp,80
    80005aea:	8082                	ret
      panic("mbuf alloc failed");
    80005aec:	00004517          	auipc	a0,0x4
    80005af0:	d1c50513          	addi	a0,a0,-740 # 80009808 <syscalls+0x430>
    80005af4:	00001097          	auipc	ra,0x1
    80005af8:	124080e7          	jalr	292(ra) # 80006c18 <panic>

0000000080005afc <in_cksum>:
...
in_cksum(const unsigned char *addr, int len)
{
    ...
    80005afe:	ec22                	sd	s0,24(sp)
    80005b00:	1000                	addi	s0,sp,32
  int nleft = len;
  const unsigned short *w = (const unsigned short *)addr;
  unsigned int sum = 0;
  unsigned short answer = 0;
    80005b02:	fe041723          	sh	zero,-18(s0)
  /*
  ...
  while (nleft > 1)  {
    ...
    80005b08:	04b7d963          	bge	a5,a1,80005b5a <in_cksum+0x5e>
    80005b0c:	ffe5879b          	addiw	a5,a1,-2
    80005b10:	0017d61b          	srliw	a2,a5,0x1
    80005b14:	0017d71b          	srliw	a4,a5,0x1
    80005b18:	0705                	addi	a4,a4,1
    80005b1a:	0706                	slli	a4,a4,0x1
    80005b1c:	972a                	add	a4,a4,a0
  unsigned int sum = 0;
    80005b1e:	4781                	li	a5,0
    sum += *w++;
    80005b20:	0509                	addi	a0,a0,2
    80005b22:	ffe55683          	lhu	a3,-2(a0)
    80005b26:	9fb5                	addw	a5,a5,a3
  while (nleft > 1)  {
    80005b28:	fee51ce3          	bne	a0,a4,80005b20 <in_cksum+0x24>
    80005b2c:	35f9                	addiw	a1,a1,-2
    80005b2e:	0016169b          	slliw	a3,a2,0x1
    80005b32:	9d95                	subw	a1,a1,a3
    nleft -= 2;
  }
  ...
  if (nleft == 1) {
    ...
    80005b36:	02d58563          	beq	a1,a3,80005b60 <in_cksum+0x64>
  ...
  sum = (sum & 0xffff) + (sum >> 16);
    80005b3a:	03079513          	slli	a0,a5,0x30
    80005b3e:	9141                	srli	a0,a0,0x30
    80005b40:	0107d79b          	srliw	a5,a5,0x10
    80005b44:	9fa9                	addw	a5,a5,a0
  sum += (sum >> 16);
    80005b46:	0107d51b          	srliw	a0,a5,0x10
  /* guaranteed now that the lower 16 bits of sum are correct */

  answer = ~sum; /* truncate to 16 bits */
    80005b4a:	9d3d                	addw	a0,a0,a5
    80005b4c:	fff54513          	not	a0,a0
  return answer;
}
    80005b50:	1542                	slli	a0,a0,0x30
    80005b52:	9141                	srli	a0,a0,0x30
    80005b54:	6462                	ld	s0,24(sp)
    80005b56:	6105                	addi	sp,sp,32
    80005b58:	8082                	ret
  const unsigned short *w = (const unsigned short *)addr;
    80005b5a:	872a                	mv	a4,a0
  unsigned int sum = 0;
    80005b5c:	4781                	li	a5,0
    80005b5e:	bfd9                	j	80005b34 <in_cksum+0x38>
    *(unsigned char *)(&answer) = *(const unsigned char *)w;
    80005b60:	00074703          	lbu	a4,0(a4)
    80005b64:	fee40723          	sb	a4,-18(s0)
    sum += answer;
    80005b68:	fee45703          	lhu	a4,-18(s0)
    80005b6c:	9fb9                	addw	a5,a5,a4
    80005b6e:	b7f1                	j	80005b3a <in_cksum+0x3e>

0000000080005b70 <mbufpull>:
{
  ...
  if (m->len < len)
    80005b7a:	4b98                	lw	a4,16(a5)
    80005b7c:	00b76b63          	bltu	a4,a1,80005b92 <mbufpull+0x22>
  m->len -= len;
    80005b80:	9f0d                	subw	a4,a4,a1
    80005b82:	cb98                	sw	a4,16(a5)
  m->head += len;
    80005b84:	1582                	slli	a1,a1,0x20
    80005b86:	9181                	srli	a1,a1,0x20
    80005b88:	95aa                	add	a1,a1,a0
    80005b8a:	e78c                	sd	a1,8(a5)
}
    ...
    80005b94:	bfe5                	j	80005b8c <mbufpull+0x1c>

0000000080005b96 <mbufpush>:
{
    80005b96:	87aa                	mv	a5,a0
  m->head -= len;
    80005b98:	02059713          	slli	a4,a1,0x20
    80005b9c:	9301                	srli	a4,a4,0x20
    80005b9e:	6508                	ld	a0,8(a0)
    80005ba0:	8d19                	sub	a0,a0,a4
    80005ba2:	e788                	sd	a0,8(a5)
  if (m->head < m->buf)
    80005ba4:	01478713          	addi	a4,a5,20
    80005ba8:	00e56663          	bltu	a0,a4,80005bb4 <mbufpush+0x1e>
  m->len += len;
    80005bac:	4b98                	lw	a4,16(a5)
    80005bae:	9db9                	addw	a1,a1,a4
    80005bb0:	cb8c                	sw	a1,16(a5)
}
    80005bb2:	8082                	ret
{
    ...
    80005bc0:	c6450513          	addi	a0,a0,-924 # 80009820 <syscalls+0x448>
    80005bc4:	00001097          	auipc	ra,0x1
    80005bc8:	054080e7          	jalr	84(ra) # 80006c18 <panic>

0000000080005bcc <net_tx_eth>:
...
net_tx_eth(struct mbuf *m, uint16 ethtype)
{
    ...
    80005bd6:	e44e                	sd	s3,8(sp)
    80005bd8:	1800                	addi	s0,sp,48
    80005bda:	89aa                	mv	s3,a0
    80005bdc:	892e                	mv	s2,a1
  struct eth *ethhdr;

  ethhdr = mbufpushhdr(m, *ethhdr);
    80005bde:	45b9                	li	a1,14
    80005be0:	00000097          	auipc	ra,0x0
    80005be4:	fb6080e7          	jalr	-74(ra) # 80005b96 <mbufpush>
    80005be8:	84aa                	mv	s1,a0
  memmove(ethhdr->shost, local_mac, ETHADDR_LEN);
    80005bea:	4619                	li	a2,6
    80005bec:	00004597          	auipc	a1,0x4
    80005bf0:	cf458593          	addi	a1,a1,-780 # 800098e0 <local_mac>
    80005bf4:	0519                	addi	a0,a0,6
    80005bf6:	ffffa097          	auipc	ra,0xffffa
    80005bfa:	5e2080e7          	jalr	1506(ra) # 800001d8 <memmove>
  // In a real networking stack, dhost would be set to the address discovered
  // through ARP. Because we don't support enough of the ARP protocol, set it
  // to broadcast instead.
  memmove(ethhdr->dhost, broadcast_mac, ETHADDR_LEN);
    80005bfe:	4619                	li	a2,6
    80005c00:	00004597          	auipc	a1,0x4
    80005c04:	cd858593          	addi	a1,a1,-808 # 800098d8 <broadcast_mac>
    80005c08:	8526                	mv	a0,s1
    80005c0a:	ffffa097          	auipc	ra,0xffffa
    80005c0e:	5ce080e7          	jalr	1486(ra) # 800001d8 <memmove>
// endianness support
//
...
static inline uint16 bswaps(uint16 val)
{
  return (((val & 0x00ffU) << 8) |
    80005c12:	0089579b          	srliw	a5,s2,0x8
  ethhdr->type = htons(ethtype);
    80005c16:	00f48623          	sb	a5,12(s1)
    80005c1a:	012486a3          	sb	s2,13(s1)
  if (e1000_transmit(m)) {
    80005c1e:	854e                	mv	a0,s3
    80005c20:	00000097          	auipc	ra,0x0
    80005c24:	ce4080e7          	jalr	-796(ra) # 80005904 <e1000_transmit>
    80005c28:	e901                	bnez	a0,80005c38 <net_tx_eth+0x6c>
    mbuffree(m);
  }
}
    80005c2a:	70a2                	ld	ra,40(sp)
    80005c2c:	7402                	ld	s0,32(sp)
    80005c2e:	64e2                	ld	s1,24(sp)
    80005c30:	6942                	ld	s2,16(sp)
  ...
  kfree(m);
    ...
    80005c42:	b7e5                	j	80005c2a <net_tx_eth+0x5e>

0000000080005c44 <mbufput>:
{
    80005c44:	87aa                	mv	a5,a0
  char *tmp = m->head + m->len;
    80005c46:	4918                	lw	a4,16(a0)
    80005c48:	02071693          	slli	a3,a4,0x20
    80005c4c:	9281                	srli	a3,a3,0x20
    80005c4e:	6508                	ld	a0,8(a0)
    80005c50:	9536                	add	a0,a0,a3
  m->len += len;
    80005c52:	9f2d                	addw	a4,a4,a1
    80005c54:	0007069b          	sext.w	a3,a4
    80005c58:	cb98                	sw	a4,16(a5)
  if (m->len > MBUF_SIZE)
    80005c5a:	6785                	lui	a5,0x1
    80005c5c:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    80005c60:	00d7e363          	bltu	a5,a3,80005c66 <mbufput+0x22>
}
    80005c64:	8082                	ret
{
    ...
    panic("mbufput");
    80005c6e:	00004517          	auipc	a0,0x4
    80005c72:	bc250513          	addi	a0,a0,-1086 # 80009830 <syscalls+0x458>
    80005c76:	00001097          	auipc	ra,0x1
    80005c7a:	fa2080e7          	jalr	-94(ra) # 80006c18 <panic>

0000000080005c7e <mbuftrim>:
{
    80005c7e:	1141                	addi	sp,sp,-16
    80005c80:	e422                	sd	s0,8(sp)
    80005c82:	0800                	addi	s0,sp,16
  if (len > m->len)
    80005c84:	491c                	lw	a5,16(a0)
    80005c86:	00b7eb63          	bltu	a5,a1,80005c9c <mbuftrim+0x1e>
  m->len -= len;
    80005c8a:	9f8d                	subw	a5,a5,a1
    80005c8c:	c91c                	sw	a5,16(a0)
  return m->head + m->len;
    80005c8e:	1782                	slli	a5,a5,0x20
    80005c90:	9381                	srli	a5,a5,0x20
    80005c92:	6508                	ld	a0,8(a0)
    ...
    80005c9e:	bfe5                	j	80005c96 <mbuftrim+0x18>

0000000080005ca0 <mbufalloc>:
{
    80005ca0:	1101                	addi	sp,sp,-32
    80005ca2:	ec06                	sd	ra,24(sp)
    80005ca4:	e822                	sd	s0,16(sp)
    80005ca6:	e426                	sd	s1,8(sp)
    80005ca8:	e04a                	sd	s2,0(sp)
    80005caa:	1000                	addi	s0,sp,32
  if (headroom > MBUF_SIZE)
    80005cac:	6785                	lui	a5,0x1
    80005cae:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    return 0;
    80005cb2:	4901                	li	s2,0
  if (headroom > MBUF_SIZE)
    80005cb4:	02a7eb63          	bltu	a5,a0,80005cea <mbufalloc+0x4a>
    80005cb8:	84aa                	mv	s1,a0
  m = kalloc();
    80005cba:	ffffa097          	auipc	ra,0xffffa
    80005cbe:	45e080e7          	jalr	1118(ra) # 80000118 <kalloc>
    80005cc2:	892a                	mv	s2,a0
  if (m == 0)
    80005cc4:	c11d                	beqz	a0,80005cea <mbufalloc+0x4a>
  m->next = 0;
    80005cc6:	00053023          	sd	zero,0(a0)
  m->head = (char *)m->buf + headroom;
    80005cca:	0551                	addi	a0,a0,20
    80005ccc:	1482                	slli	s1,s1,0x20
    80005cce:	9081                	srli	s1,s1,0x20
    80005cd0:	94aa                	add	s1,s1,a0
    80005cd2:	00993423          	sd	s1,8(s2)
  m->len = 0;
    80005cd6:	00092823          	sw	zero,16(s2)
  memset(m->buf, 0, sizeof(m->buf));
    80005cda:	6605                	lui	a2,0x1
    80005cdc:	80060613          	addi	a2,a2,-2048 # 800 <_entry-0x7ffff800>
    80005ce0:	4581                	li	a1,0
    80005ce2:	ffffa097          	auipc	ra,0xffffa
    80005ce6:	496080e7          	jalr	1174(ra) # 80000178 <memset>
}
...
0000000080005cf8 <mbuffree>:
{
  ...
  kfree(m);
    80005d00:	ffffa097          	auipc	ra,0xffffa
    80005d04:	31c080e7          	jalr	796(ra) # 8000001c <kfree>
}
...
0000000080005d10 <mbufq_pushtail>:
{
    80005d10:	1141                	addi	sp,sp,-16
    80005d12:	e422                	sd	s0,8(sp)
    80005d14:	0800                	addi	s0,sp,16
  m->next = 0;
    80005d16:	0005b023          	sd	zero,0(a1)
  if (!q->head){
    80005d1a:	611c                	ld	a5,0(a0)
    80005d1c:	c799                	beqz	a5,80005d2a <mbufq_pushtail+0x1a>
  q->tail->next = m;
    80005d1e:	651c                	ld	a5,8(a0)
    80005d20:	e38c                	sd	a1,0(a5)
  q->tail = m;
    80005d22:	e50c                	sd	a1,8(a0)
}
    80005d24:	6422                	ld	s0,8(sp)
    80005d26:	0141                	addi	sp,sp,16
    80005d28:	8082                	ret
    q->head = q->tail = m;
    80005d2a:	e50c                	sd	a1,8(a0)
    80005d2c:	e10c                	sd	a1,0(a0)
    return;
    80005d2e:	bfdd                	j	80005d24 <mbufq_pushtail+0x14>

0000000080005d30 <mbufq_pophead>:
{
    80005d30:	1141                	addi	sp,sp,-16
    80005d32:	e422                	sd	s0,8(sp)
    80005d34:	0800                	addi	s0,sp,16
    80005d36:	87aa                	mv	a5,a0
  struct mbuf *head = q->head;
    80005d38:	6108                	ld	a0,0(a0)
  if (!head)
    80005d3a:	c119                	beqz	a0,80005d40 <mbufq_pophead+0x10>
  q->head = head->next;
    80005d3c:	6118                	ld	a4,0(a0)
    80005d3e:	e398                	sd	a4,0(a5)
}
    80005d40:	6422                	ld	s0,8(sp)
    80005d42:	0141                	addi	sp,sp,16
    80005d44:	8082                	ret

0000000080005d46 <mbufq_empty>:
{
    80005d46:	1141                	addi	sp,sp,-16
    80005d48:	e422                	sd	s0,8(sp)
    80005d4a:	0800                	addi	s0,sp,16
  return q->head == 0;
    80005d4c:	6108                	ld	a0,0(a0)
}
    80005d4e:	00153513          	seqz	a0,a0
    80005d52:	6422                	ld	s0,8(sp)
    80005d54:	0141                	addi	sp,sp,16
    80005d56:	8082                	ret

0000000080005d58 <mbufq_init>:
{
    80005d58:	1141                	addi	sp,sp,-16
    80005d5a:	e422                	sd	s0,8(sp)
           ...
           uint16 sport, uint16 dport)
{
    ...
    80005d70:	e84a                	sd	s2,16(sp)
    80005d72:	e44e                	sd	s3,8(sp)
    80005d74:	e052                	sd	s4,0(sp)
    80005d76:	1800                	addi	s0,sp,48
    80005d78:	8a2a                	mv	s4,a0
    80005d7a:	892e                	mv	s2,a1
    80005d7c:	89b2                	mv	s3,a2
    80005d7e:	84b6                	mv	s1,a3
  struct udp *udphdr;

  // put the UDP header
  udphdr = mbufpushhdr(m, *udphdr);
    80005d80:	45a1                	li	a1,8
    80005d82:	00000097          	auipc	ra,0x0
    80005d86:	e14080e7          	jalr	-492(ra) # 80005b96 <mbufpush>
    80005d8a:	0089d61b          	srliw	a2,s3,0x8
    80005d8e:	0089999b          	slliw	s3,s3,0x8
    80005d92:	00c9e9b3          	or	s3,s3,a2
  udphdr->sport = htons(sport);
    80005d96:	01351023          	sh	s3,0(a0)
    80005d9a:	0084d69b          	srliw	a3,s1,0x8
    80005d9e:	0084949b          	slliw	s1,s1,0x8
    80005da2:	8cd5                	or	s1,s1,a3
  udphdr->dport = htons(dport);
    80005da4:	00951123          	sh	s1,2(a0)
  udphdr->ulen = htons(m->len);
    80005da8:	010a2783          	lw	a5,16(s4) # 3010 <_entry-0x7fffcff0>
    80005dac:	0087d713          	srli	a4,a5,0x8
    80005db0:	0087979b          	slliw	a5,a5,0x8
    80005db4:	0ff77713          	andi	a4,a4,255
    80005db8:	8fd9                	or	a5,a5,a4
    80005dba:	00f51223          	sh	a5,4(a0)
  udphdr->sum = 0; // zero means no checksum is provided
    80005dbe:	00051323          	sh	zero,6(a0)
  iphdr = mbufpushhdr(m, *iphdr);
    80005dc2:	45d1                	li	a1,20
    80005dc4:	8552                	mv	a0,s4
    80005dc6:	00000097          	auipc	ra,0x0
    80005dca:	dd0080e7          	jalr	-560(ra) # 80005b96 <mbufpush>
    80005dce:	84aa                	mv	s1,a0
  memset(iphdr, 0, sizeof(*iphdr));
    80005dd0:	4651                	li	a2,20
    80005dd2:	4581                	li	a1,0
    80005dd4:	ffffa097          	auipc	ra,0xffffa
    80005dd8:	3a4080e7          	jalr	932(ra) # 80000178 <memset>
  iphdr->ip_vhl = (4 << 4) | (20 >> 2);
    80005ddc:	04500793          	li	a5,69
    80005de0:	00f48023          	sb	a5,0(s1)
  iphdr->ip_p = proto;
    80005de4:	47c5                	li	a5,17
    80005de6:	00f484a3          	sb	a5,9(s1)
  iphdr->ip_src = htonl(local_ip);
    80005dea:	0f0207b7          	lui	a5,0xf020
    80005dee:	27a9                	addiw	a5,a5,10
    80005df0:	c4dc                	sw	a5,12(s1)
          ((val & 0xff00U) >> 8));
}
...
static inline uint32 bswapl(uint32 val)
{
  return (((val & 0x000000ffUL) << 24) |
    80005df2:	0189179b          	slliw	a5,s2,0x18
          ((val & 0x0000ff00UL) << 8) |
          ((val & 0x00ff0000UL) >> 8) |
          ((val & 0xff000000UL) >> 24));
    80005df6:	0189571b          	srliw	a4,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005dfa:	8fd9                	or	a5,a5,a4
          ((val & 0x0000ff00UL) << 8) |
    80005dfc:	0089171b          	slliw	a4,s2,0x8
    80005e00:	00ff06b7          	lui	a3,0xff0
    80005e04:	8f75                	and	a4,a4,a3
          ((val & 0x00ff0000UL) >> 8) |
    80005e06:	8fd9                	or	a5,a5,a4
    80005e08:	0089591b          	srliw	s2,s2,0x8
    80005e0c:	65c1                	lui	a1,0x10
    80005e0e:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80005e12:	00b97933          	and	s2,s2,a1
    80005e16:	0127e933          	or	s2,a5,s2
  iphdr->ip_dst = htonl(dip);
    80005e1a:	0124a823          	sw	s2,16(s1)
  iphdr->ip_len = htons(m->len);
    80005e1e:	010a2783          	lw	a5,16(s4)
  return (((val & 0x00ffU) << 8) |
    80005e22:	0087d713          	srli	a4,a5,0x8
    80005e26:	0087979b          	slliw	a5,a5,0x8
    80005e2a:	0ff77713          	andi	a4,a4,255
    80005e2e:	8fd9                	or	a5,a5,a4
    80005e30:	00f49123          	sh	a5,2(s1)
  iphdr->ip_ttl = 100;
    80005e34:	06400793          	li	a5,100
    80005e38:	00f48423          	sb	a5,8(s1)
  iphdr->ip_sum = in_cksum((unsigned char *)iphdr, sizeof(*iphdr));
    80005e3c:	45d1                	li	a1,20
    80005e3e:	8526                	mv	a0,s1
    80005e40:	00000097          	auipc	ra,0x0
    80005e44:	cbc080e7          	jalr	-836(ra) # 80005afc <in_cksum>
    80005e48:	00a49523          	sh	a0,10(s1)
  net_tx_eth(m, ETHTYPE_IP);
    80005e4c:	6585                	lui	a1,0x1
    80005e4e:	80058593          	addi	a1,a1,-2048 # 800 <_entry-0x7ffff800>
    80005e52:	8552                	mv	a0,s4
    80005e54:	00000097          	auipc	ra,0x0
    80005e58:	d78080e7          	jalr	-648(ra) # 80005bcc <net_tx_eth>
  ...
  net_tx_ip(m, IPPROTO_UDP, dip);
    ...
    80005e62:	6942                	ld	s2,16(sp)
    80005e64:	69a2                	ld	s3,8(sp)
    80005e66:	6a02                	ld	s4,0(sp)
    80005e68:	6145                	addi	sp,sp,48
    80005e6a:	8082                	ret

0000000080005e6c <net_rx>:
}
...
{
    80005e6c:	715d                	addi	sp,sp,-80
    80005e6e:	e486                	sd	ra,72(sp)
    80005e70:	e0a2                	sd	s0,64(sp)
    80005e72:	fc26                	sd	s1,56(sp)
    80005e74:	f84a                	sd	s2,48(sp)
    80005e76:	f44e                	sd	s3,40(sp)
    80005e78:	f052                	sd	s4,32(sp)
    80005e7a:	ec56                	sd	s5,24(sp)
  ...
  ethhdr = mbufpullhdr(m, *ethhdr);
    80005e80:	45b9                	li	a1,14
    80005e82:	00000097          	auipc	ra,0x0
    80005e86:	cee080e7          	jalr	-786(ra) # 80005b70 <mbufpull>
  if (!ethhdr) {
    80005e8a:	c521                	beqz	a0,80005ed2 <net_rx+0x66>
    mbuffree(m);
    return;
  }

  type = ntohs(ethhdr->type);
    80005e8c:	00c54783          	lbu	a5,12(a0)
    80005e90:	00d54703          	lbu	a4,13(a0)
    80005e94:	0722                	slli	a4,a4,0x8
    80005e96:	8fd9                	or	a5,a5,a4
    80005e98:	0087979b          	slliw	a5,a5,0x8
    80005e9c:	8321                	srli	a4,a4,0x8
    80005e9e:	8fd9                	or	a5,a5,a4
    80005ea0:	17c2                	slli	a5,a5,0x30
    80005ea2:	93c1                	srli	a5,a5,0x30
  if (type == ETHTYPE_IP)
    80005ea4:	8007871b          	addiw	a4,a5,-2048
    80005ea8:	cb1d                	beqz	a4,80005ede <net_rx+0x72>
    net_rx_ip(m);
  else if (type == ETHTYPE_ARP)
    80005eaa:	2781                	sext.w	a5,a5
    80005eac:	6705                	lui	a4,0x1
    80005eae:	80670713          	addi	a4,a4,-2042 # 806 <_entry-0x7ffff7fa>
    80005eb2:	18e78e63          	beq	a5,a4,8000604e <net_rx+0x1e2>
  kfree(m);
    ...
    80005ec0:	60a6                	ld	ra,72(sp)
    80005ec2:	6406                	ld	s0,64(sp)
    80005ec4:	74e2                	ld	s1,56(sp)
    80005ec6:	7942                	ld	s2,48(sp)
    80005ec8:	79a2                	ld	s3,40(sp)
    80005eca:	7a02                	ld	s4,32(sp)
    80005ecc:	6ae2                	ld	s5,24(sp)
    80005ece:	6161                	addi	sp,sp,80
    80005ed0:	8082                	ret
  kfree(m);
    80005ed2:	8526                	mv	a0,s1
    80005ed4:	ffffa097          	auipc	ra,0xffffa
    80005ed8:	148080e7          	jalr	328(ra) # 8000001c <kfree>
}
    80005edc:	b7d5                	j	80005ec0 <net_rx+0x54>
  iphdr = mbufpullhdr(m, *iphdr);
    80005ede:	45d1                	li	a1,20
    80005ee0:	8526                	mv	a0,s1
    80005ee2:	00000097          	auipc	ra,0x0
    80005ee6:	c8e080e7          	jalr	-882(ra) # 80005b70 <mbufpull>
    80005eea:	892a                	mv	s2,a0
  if (!iphdr)
    80005eec:	c519                	beqz	a0,80005efa <net_rx+0x8e>
  if (iphdr->ip_vhl != ((4 << 4) | (20 >> 2)))
    80005eee:	00054703          	lbu	a4,0(a0)
    80005ef2:	04500793          	li	a5,69
    80005ef6:	00f70863          	beq	a4,a5,80005f06 <net_rx+0x9a>
  kfree(m);
    80005efa:	8526                	mv	a0,s1
    80005efc:	ffffa097          	auipc	ra,0xffffa
    80005f00:	120080e7          	jalr	288(ra) # 8000001c <kfree>
}
    80005f04:	bf75                	j	80005ec0 <net_rx+0x54>
  if (in_cksum((unsigned char *)iphdr, sizeof(*iphdr)))
    80005f06:	45d1                	li	a1,20
    80005f08:	00000097          	auipc	ra,0x0
    80005f0c:	bf4080e7          	jalr	-1036(ra) # 80005afc <in_cksum>
    80005f10:	f56d                	bnez	a0,80005efa <net_rx+0x8e>
    80005f12:	00695783          	lhu	a5,6(s2)
    80005f16:	0087d713          	srli	a4,a5,0x8
    80005f1a:	0087979b          	slliw	a5,a5,0x8
    80005f1e:	0ff77713          	andi	a4,a4,255
    80005f22:	8fd9                	or	a5,a5,a4
  if (htons(iphdr->ip_off) != 0)
    80005f24:	17c2                	slli	a5,a5,0x30
    80005f26:	93c1                	srli	a5,a5,0x30
    80005f28:	fbe9                	bnez	a5,80005efa <net_rx+0x8e>
  if (htonl(iphdr->ip_dst) != local_ip)
    80005f2a:	01092703          	lw	a4,16(s2)
  return (((val & 0x000000ffUL) << 24) |
    80005f2e:	0187179b          	slliw	a5,a4,0x18
          ((val & 0xff000000UL) >> 24));
    80005f32:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005f36:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    80005f38:	0087169b          	slliw	a3,a4,0x8
    80005f3c:	00ff0637          	lui	a2,0xff0
    80005f40:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    80005f42:	8fd5                	or	a5,a5,a3
    80005f44:	0087571b          	srliw	a4,a4,0x8
    80005f48:	66c1                	lui	a3,0x10
    80005f4a:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80005f4e:	8f75                	and	a4,a4,a3
    80005f50:	8fd9                	or	a5,a5,a4
    80005f52:	2781                	sext.w	a5,a5
    80005f54:	0a000737          	lui	a4,0xa000
    80005f58:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80005f5c:	f8e79fe3          	bne	a5,a4,80005efa <net_rx+0x8e>
  if (iphdr->ip_p != IPPROTO_UDP)
    80005f60:	00994703          	lbu	a4,9(s2)
    80005f64:	47c5                	li	a5,17
    80005f66:	f8f71ae3          	bne	a4,a5,80005efa <net_rx+0x8e>
  return (((val & 0x00ffU) << 8) |
    80005f6a:	00295783          	lhu	a5,2(s2)
    80005f6e:	0087d713          	srli	a4,a5,0x8
    80005f72:	0087999b          	slliw	s3,a5,0x8
    80005f76:	0ff77793          	andi	a5,a4,255
    80005f7a:	00f9e9b3          	or	s3,s3,a5
    80005f7e:	19c2                	slli	s3,s3,0x30
    80005f80:	0309d993          	srli	s3,s3,0x30
  len = ntohs(iphdr->ip_len) - sizeof(*iphdr);
    80005f84:	fec9879b          	addiw	a5,s3,-20
    80005f88:	03079a13          	slli	s4,a5,0x30
    80005f8c:	030a5a13          	srli	s4,s4,0x30
  udphdr = mbufpullhdr(m, *udphdr);
    80005f90:	45a1                	li	a1,8
    80005f92:	8526                	mv	a0,s1
    80005f94:	00000097          	auipc	ra,0x0
    80005f98:	bdc080e7          	jalr	-1060(ra) # 80005b70 <mbufpull>
    80005f9c:	8aaa                	mv	s5,a0
  if (!udphdr)
    80005f9e:	c915                	beqz	a0,80005fd2 <net_rx+0x166>
    80005fa0:	00455783          	lhu	a5,4(a0)
    80005fa4:	0087d713          	srli	a4,a5,0x8
    80005fa8:	0087979b          	slliw	a5,a5,0x8
    80005fac:	0ff77713          	andi	a4,a4,255
    80005fb0:	8fd9                	or	a5,a5,a4
  if (ntohs(udphdr->ulen) != len)
    80005fb2:	2a01                	sext.w	s4,s4
    80005fb4:	17c2                	slli	a5,a5,0x30
    80005fb6:	93c1                	srli	a5,a5,0x30
    80005fb8:	00fa1d63          	bne	s4,a5,80005fd2 <net_rx+0x166>
  len -= sizeof(*udphdr);
    80005fbc:	fe49879b          	addiw	a5,s3,-28
  if (len > m->len)
    80005fc0:	0107979b          	slliw	a5,a5,0x10
    80005fc4:	0107d79b          	srliw	a5,a5,0x10
    80005fc8:	0007871b          	sext.w	a4,a5
    80005fcc:	488c                	lw	a1,16(s1)
    80005fce:	00e5f863          	bgeu	a1,a4,80005fde <net_rx+0x172>
  kfree(m);
    80005fd2:	8526                	mv	a0,s1
    80005fd4:	ffffa097          	auipc	ra,0xffffa
    80005fd8:	048080e7          	jalr	72(ra) # 8000001c <kfree>
}
    80005fdc:	b5d5                	j	80005ec0 <net_rx+0x54>
  mbuftrim(m, m->len - len);
    80005fde:	9d9d                	subw	a1,a1,a5
    80005fe0:	8526                	mv	a0,s1
    80005fe2:	00000097          	auipc	ra,0x0
    80005fe6:	c9c080e7          	jalr	-868(ra) # 80005c7e <mbuftrim>
  sip = ntohl(iphdr->ip_src);
    80005fea:	00c92783          	lw	a5,12(s2)
    80005fee:	000ad703          	lhu	a4,0(s5)
    80005ff2:	00875693          	srli	a3,a4,0x8
    80005ff6:	0087171b          	slliw	a4,a4,0x8
    80005ffa:	0ff6f693          	andi	a3,a3,255
    80005ffe:	8ed9                	or	a3,a3,a4
    80006000:	002ad703          	lhu	a4,2(s5)
    80006004:	00875613          	srli	a2,a4,0x8
    80006008:	0087171b          	slliw	a4,a4,0x8
    8000600c:	0ff67613          	andi	a2,a2,255
    80006010:	8e59                	or	a2,a2,a4
  return (((val & 0x000000ffUL) << 24) |
    80006012:	0187971b          	slliw	a4,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006016:	0187d59b          	srliw	a1,a5,0x18
          ((val & 0x00ff0000UL) >> 8) |
    8000601a:	8f4d                	or	a4,a4,a1
          ((val & 0x0000ff00UL) << 8) |
    8000601c:	0087959b          	slliw	a1,a5,0x8
    80006020:	00ff0537          	lui	a0,0xff0
    80006024:	8de9                	and	a1,a1,a0
          ((val & 0x00ff0000UL) >> 8) |
    80006026:	8f4d                	or	a4,a4,a1
    80006028:	0087d79b          	srliw	a5,a5,0x8
    8000602c:	65c1                	lui	a1,0x10
    8000602e:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80006032:	8fed                	and	a5,a5,a1
    80006034:	8fd9                	or	a5,a5,a4
  sockrecvudp(m, sip, dport, sport);
    80006036:	16c2                	slli	a3,a3,0x30
    80006038:	92c1                	srli	a3,a3,0x30
    8000603a:	1642                	slli	a2,a2,0x30
    8000603c:	9241                	srli	a2,a2,0x30
    8000603e:	0007859b          	sext.w	a1,a5
    80006042:	8526                	mv	a0,s1
    80006044:	00000097          	auipc	ra,0x0
    80006048:	55c080e7          	jalr	1372(ra) # 800065a0 <sockrecvudp>
  return;
    8000604c:	bd95                	j	80005ec0 <net_rx+0x54>
  arphdr = mbufpullhdr(m, *arphdr);
    8000604e:	45f1                	li	a1,28
    80006050:	8526                	mv	a0,s1
    80006052:	00000097          	auipc	ra,0x0
    80006056:	b1e080e7          	jalr	-1250(ra) # 80005b70 <mbufpull>
    8000605a:	892a                	mv	s2,a0
  if (!arphdr)
    8000605c:	c179                	beqz	a0,80006122 <net_rx+0x2b6>
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    8000605e:	00054783          	lbu	a5,0(a0) # ff0000 <_entry-0x7f010000>
    80006062:	00154703          	lbu	a4,1(a0)
    80006066:	0722                	slli	a4,a4,0x8
    80006068:	8fd9                	or	a5,a5,a4
  return (((val & 0x00ffU) << 8) |
    8000606a:	0087979b          	slliw	a5,a5,0x8
    8000606e:	8321                	srli	a4,a4,0x8
    80006070:	8fd9                	or	a5,a5,a4
    80006072:	17c2                	slli	a5,a5,0x30
    80006074:	93c1                	srli	a5,a5,0x30
    80006076:	4705                	li	a4,1
    80006078:	0ae79563          	bne	a5,a4,80006122 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    8000607c:	00254783          	lbu	a5,2(a0)
    80006080:	00354703          	lbu	a4,3(a0)
    80006084:	0722                	slli	a4,a4,0x8
    80006086:	8fd9                	or	a5,a5,a4
    80006088:	0087979b          	slliw	a5,a5,0x8
    8000608c:	8321                	srli	a4,a4,0x8
    8000608e:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006090:	0107979b          	slliw	a5,a5,0x10
    80006094:	0107d79b          	srliw	a5,a5,0x10
    80006098:	8007879b          	addiw	a5,a5,-2048
    8000609c:	e3d9                	bnez	a5,80006122 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    8000609e:	00454703          	lbu	a4,4(a0)
    800060a2:	4799                	li	a5,6
    800060a4:	06f71f63          	bne	a4,a5,80006122 <net_rx+0x2b6>
      arphdr->hln != ETHADDR_LEN ||
    800060a8:	00554703          	lbu	a4,5(a0)
    800060ac:	4791                	li	a5,4
    800060ae:	06f71a63          	bne	a4,a5,80006122 <net_rx+0x2b6>
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    800060b2:	00654783          	lbu	a5,6(a0)
    800060b6:	00754703          	lbu	a4,7(a0)
    800060ba:	0722                	slli	a4,a4,0x8
    800060bc:	8fd9                	or	a5,a5,a4
    800060be:	0087979b          	slliw	a5,a5,0x8
    800060c2:	8321                	srli	a4,a4,0x8
    800060c4:	8fd9                	or	a5,a5,a4
    800060c6:	17c2                	slli	a5,a5,0x30
    800060c8:	93c1                	srli	a5,a5,0x30
    800060ca:	4705                	li	a4,1
    800060cc:	04e79b63          	bne	a5,a4,80006122 <net_rx+0x2b6>
  tip = ntohl(arphdr->tip); // target IP address
    800060d0:	01854783          	lbu	a5,24(a0)
    800060d4:	01954703          	lbu	a4,25(a0)
    800060d8:	0722                	slli	a4,a4,0x8
    800060da:	8f5d                	or	a4,a4,a5
    800060dc:	01a54783          	lbu	a5,26(a0)
    800060e0:	07c2                	slli	a5,a5,0x10
    800060e2:	8f5d                	or	a4,a4,a5
    800060e4:	01b54783          	lbu	a5,27(a0)
    800060e8:	07e2                	slli	a5,a5,0x18
    800060ea:	8fd9                	or	a5,a5,a4
    800060ec:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    800060f0:	0187979b          	slliw	a5,a5,0x18
          ((val & 0xff000000UL) >> 24));
    800060f4:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    800060f8:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    800060fa:	0087169b          	slliw	a3,a4,0x8
    800060fe:	00ff0637          	lui	a2,0xff0
    80006102:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    80006104:	8fd5                	or	a5,a5,a3
    80006106:	0087571b          	srliw	a4,a4,0x8
    8000610a:	66c1                	lui	a3,0x10
    8000610c:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80006110:	8f75                	and	a4,a4,a3
    80006112:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    80006114:	2781                	sext.w	a5,a5
    80006116:	0a000737          	lui	a4,0xa000
    8000611a:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    8000611e:	00e78863          	beq	a5,a4,8000612e <net_rx+0x2c2>
  kfree(m);
    80006122:	8526                	mv	a0,s1
    80006124:	ffffa097          	auipc	ra,0xffffa
    80006128:	ef8080e7          	jalr	-264(ra) # 8000001c <kfree>
}
    8000612c:	bb51                	j	80005ec0 <net_rx+0x54>
  memmove(smac, arphdr->sha, ETHADDR_LEN); // sender's ethernet address
    8000612e:	4619                	li	a2,6
    80006130:	00850593          	addi	a1,a0,8
    80006134:	fb840513          	addi	a0,s0,-72
    80006138:	ffffa097          	auipc	ra,0xffffa
    8000613c:	0a0080e7          	jalr	160(ra) # 800001d8 <memmove>
  sip = ntohl(arphdr->sip); // sender's IP address (qemu's slirp)
    80006140:	00e94783          	lbu	a5,14(s2)
    80006144:	00f94703          	lbu	a4,15(s2)
    80006148:	0722                	slli	a4,a4,0x8
    8000614a:	8f5d                	or	a4,a4,a5
    8000614c:	01094783          	lbu	a5,16(s2)
    80006150:	07c2                	slli	a5,a5,0x10
    80006152:	8f5d                	or	a4,a4,a5
    80006154:	01194783          	lbu	a5,17(s2)
    80006158:	07e2                	slli	a5,a5,0x18
    8000615a:	8fd9                	or	a5,a5,a4
    8000615c:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    80006160:	0187991b          	slliw	s2,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006164:	0187579b          	srliw	a5,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006168:	00f96933          	or	s2,s2,a5
          ((val & 0x0000ff00UL) << 8) |
    8000616c:	0087179b          	slliw	a5,a4,0x8
    80006170:	00ff06b7          	lui	a3,0xff0
    80006174:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    80006176:	00f96933          	or	s2,s2,a5
    8000617a:	0087579b          	srliw	a5,a4,0x8
    8000617e:	6741                	lui	a4,0x10
    80006180:	f0070713          	addi	a4,a4,-256 # ff00 <_entry-0x7fff0100>
    80006184:	8ff9                	and	a5,a5,a4
    80006186:	00f96933          	or	s2,s2,a5
    8000618a:	2901                	sext.w	s2,s2
  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    8000618c:	08000513          	li	a0,128
    80006190:	00000097          	auipc	ra,0x0
    80006194:	b10080e7          	jalr	-1264(ra) # 80005ca0 <mbufalloc>
    80006198:	8a2a                	mv	s4,a0
  if (!m)
    8000619a:	d541                	beqz	a0,80006122 <net_rx+0x2b6>
  arphdr = mbufputhdr(m, *arphdr);
    8000619c:	45f1                	li	a1,28
    8000619e:	00000097          	auipc	ra,0x0
    800061a2:	aa6080e7          	jalr	-1370(ra) # 80005c44 <mbufput>
    800061a6:	89aa                	mv	s3,a0
  arphdr->hrd = htons(ARP_HRD_ETHER);
    800061a8:	00050023          	sb	zero,0(a0)
    800061ac:	4785                	li	a5,1
    800061ae:	00f500a3          	sb	a5,1(a0)
  arphdr->pro = htons(ETHTYPE_IP);
    800061b2:	47a1                	li	a5,8
    800061b4:	00f50123          	sb	a5,2(a0)
    800061b8:	000501a3          	sb	zero,3(a0)
  arphdr->hln = ETHADDR_LEN;
    800061bc:	4799                	li	a5,6
    800061be:	00f50223          	sb	a5,4(a0)
  arphdr->pln = sizeof(uint32);
    800061c2:	4791                	li	a5,4
    800061c4:	00f502a3          	sb	a5,5(a0)
  arphdr->op = htons(op);
    800061c8:	00050323          	sb	zero,6(a0)
    800061cc:	4a89                	li	s5,2
    800061ce:	015503a3          	sb	s5,7(a0)
  memmove(arphdr->sha, local_mac, ETHADDR_LEN);
    800061d2:	4619                	li	a2,6
    800061d4:	00003597          	auipc	a1,0x3
    800061d8:	70c58593          	addi	a1,a1,1804 # 800098e0 <local_mac>
    800061dc:	0521                	addi	a0,a0,8
    800061de:	ffffa097          	auipc	ra,0xffffa
    800061e2:	ffa080e7          	jalr	-6(ra) # 800001d8 <memmove>
  arphdr->sip = htonl(local_ip);
    800061e6:	47a9                	li	a5,10
    800061e8:	00f98723          	sb	a5,14(s3)
    800061ec:	000987a3          	sb	zero,15(s3)
    800061f0:	01598823          	sb	s5,16(s3)
    800061f4:	47bd                	li	a5,15
    800061f6:	00f988a3          	sb	a5,17(s3)
  memmove(arphdr->tha, dmac, ETHADDR_LEN);
    800061fa:	4619                	li	a2,6
    800061fc:	fb840593          	addi	a1,s0,-72
    80006200:	01298513          	addi	a0,s3,18
    80006204:	ffffa097          	auipc	ra,0xffffa
    80006208:	fd4080e7          	jalr	-44(ra) # 800001d8 <memmove>
  return (((val & 0x000000ffUL) << 24) |
    8000620c:	0189171b          	slliw	a4,s2,0x18
          ((val & 0xff000000UL) >> 24));
    80006210:	0189579b          	srliw	a5,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006214:	8f5d                	or	a4,a4,a5
          ((val & 0x0000ff00UL) << 8) |
    80006216:	0089179b          	slliw	a5,s2,0x8
    8000621a:	00ff06b7          	lui	a3,0xff0
    8000621e:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    80006220:	8f5d                	or	a4,a4,a5
    80006222:	0089579b          	srliw	a5,s2,0x8
    80006226:	66c1                	lui	a3,0x10
    80006228:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    8000622c:	8ff5                	and	a5,a5,a3
    8000622e:	8fd9                	or	a5,a5,a4
  arphdr->tip = htonl(dip);
    80006230:	00e98c23          	sb	a4,24(s3)
    80006234:	0087d71b          	srliw	a4,a5,0x8
    80006238:	00e98ca3          	sb	a4,25(s3)
    8000623c:	0107d71b          	srliw	a4,a5,0x10
    80006240:	00e98d23          	sb	a4,26(s3)
    80006244:	0187d79b          	srliw	a5,a5,0x18
    80006248:	00f98da3          	sb	a5,27(s3)
  net_tx_eth(m, ETHTYPE_ARP);
    8000624c:	6585                	lui	a1,0x1
    8000624e:	80658593          	addi	a1,a1,-2042 # 806 <_entry-0x7ffff7fa>
    80006252:	8552                	mv	a0,s4
    80006254:	00000097          	auipc	ra,0x0
    80006258:	978080e7          	jalr	-1672(ra) # 80005bcc <net_tx_eth>
  return 0;
    8000625c:	b5d9                	j	80006122 <net_rx+0x2b6>

000000008000625e <sockinit>:
...
sockinit(void)
{
    ...
    80006260:	e406                	sd	ra,8(sp)
    80006262:	e022                	sd	s0,0(sp)
    80006264:	0800                	addi	s0,sp,16
  initlock(&lock, "socktbl");
    80006266:	00003597          	auipc	a1,0x3
    8000626a:	5d258593          	addi	a1,a1,1490 # 80009838 <syscalls+0x460>
    8000626e:	00019517          	auipc	a0,0x19
    80006272:	0b250513          	addi	a0,a0,178 # 8001f320 <lock>
    80006276:	00001097          	auipc	ra,0x1
    8000627a:	e5c080e7          	jalr	-420(ra) # 800070d2 <initlock>
}
...
0000000080006286 <sockalloc>:

int
sockalloc(struct file **f, uint32 raddr, uint16 lport, uint16 rport)
{
    80006286:	7139                	addi	sp,sp,-64
    80006288:	fc06                	sd	ra,56(sp)
    8000628a:	f822                	sd	s0,48(sp)
    8000628c:	f426                	sd	s1,40(sp)
    8000628e:	f04a                	sd	s2,32(sp)
    80006290:	ec4e                	sd	s3,24(sp)
    80006292:	e852                	sd	s4,16(sp)
    80006294:	e456                	sd	s5,8(sp)
    80006296:	0080                	addi	s0,sp,64
    80006298:	892a                	mv	s2,a0
    8000629a:	84ae                	mv	s1,a1
    8000629c:	8a32                	mv	s4,a2
    8000629e:	89b6                	mv	s3,a3
  struct sock *si, *pos;
  ...
  *f = 0;
  ...
  if ((*f = filealloc()) == 0)
    ...
    800062a8:	62c080e7          	jalr	1580(ra) # 800038d0 <filealloc>
    800062ac:	00a93023          	sd	a0,0(s2)
    800062b0:	c975                	beqz	a0,800063a4 <sockalloc+0x11e>
    goto bad;
  if ((si = (struct sock*)kalloc()) == 0)
    800062b2:	ffffa097          	auipc	ra,0xffffa
    800062b6:	e66080e7          	jalr	-410(ra) # 80000118 <kalloc>
    800062ba:	8aaa                	mv	s5,a0
    800062bc:	c15d                	beqz	a0,80006362 <sockalloc+0xdc>
    goto bad;

  // initialize objects
  si->raddr = raddr;
    800062be:	c504                	sw	s1,8(a0)
  si->lport = lport;
    800062c0:	01451623          	sh	s4,12(a0)
  si->rport = rport;
    800062c4:	01351723          	sh	s3,14(a0)
  initlock(&si->lock, "sock");
    800062c8:	00003597          	auipc	a1,0x3
    800062cc:	57858593          	addi	a1,a1,1400 # 80009840 <syscalls+0x468>
    800062d0:	0541                	addi	a0,a0,16
    800062d2:	00001097          	auipc	ra,0x1
    800062d6:	e00080e7          	jalr	-512(ra) # 800070d2 <initlock>
  mbufq_init(&si->rxq);
    800062da:	028a8513          	addi	a0,s5,40
    800062de:	00000097          	auipc	ra,0x0
    800062e2:	a7a080e7          	jalr	-1414(ra) # 80005d58 <mbufq_init>
  (*f)->type = FD_SOCK;
    800062e6:	00093783          	ld	a5,0(s2)
    800062ea:	4711                	li	a4,4
    800062ec:	c398                	sw	a4,0(a5)
  (*f)->readable = 1;
    800062ee:	00093703          	ld	a4,0(s2)
    800062f2:	4785                	li	a5,1
    800062f4:	00f70423          	sb	a5,8(a4)
  (*f)->writable = 1;
    800062f8:	00093703          	ld	a4,0(s2)
    800062fc:	00f704a3          	sb	a5,9(a4)
  (*f)->sock = si;
    80006300:	00093783          	ld	a5,0(s2)
    80006304:	0357b023          	sd	s5,32(a5) # f020020 <_entry-0x70fdffe0>

  // add to list of sockets
  acquire(&lock);
    80006308:	00019517          	auipc	a0,0x19
    8000630c:	01850513          	addi	a0,a0,24 # 8001f320 <lock>
    80006310:	00001097          	auipc	ra,0x1
    80006314:	e52080e7          	jalr	-430(ra) # 80007162 <acquire>
  pos = sockets;
    80006318:	00004597          	auipc	a1,0x4
    8000631c:	d105b583          	ld	a1,-752(a1) # 8000a028 <sockets>
  while (pos) {
    80006320:	c9b1                	beqz	a1,80006374 <sockalloc+0xee>
  pos = sockets;
    80006322:	87ae                	mv	a5,a1
    if (pos->raddr == raddr &&
    80006324:	000a061b          	sext.w	a2,s4
        pos->lport == lport &&
    80006328:	0009869b          	sext.w	a3,s3
    8000632c:	a019                	j	80006332 <sockalloc+0xac>
	pos->rport == rport) {
      release(&lock);
      goto bad;
    }
    pos = pos->next;
    8000632e:	639c                	ld	a5,0(a5)
  while (pos) {
    80006330:	c3b1                	beqz	a5,80006374 <sockalloc+0xee>
    if (pos->raddr == raddr &&
    80006332:	4798                	lw	a4,8(a5)
    80006334:	fe971de3          	bne	a4,s1,8000632e <sockalloc+0xa8>
    80006338:	00c7d703          	lhu	a4,12(a5)
    8000633c:	fec719e3          	bne	a4,a2,8000632e <sockalloc+0xa8>
        pos->lport == lport &&
    80006340:	00e7d703          	lhu	a4,14(a5)
    80006344:	fed715e3          	bne	a4,a3,8000632e <sockalloc+0xa8>
      release(&lock);
    80006348:	00019517          	auipc	a0,0x19
    8000634c:	fd850513          	addi	a0,a0,-40 # 8001f320 <lock>
    80006350:	00001097          	auipc	ra,0x1
    80006354:	ec6080e7          	jalr	-314(ra) # 80007216 <release>
  release(&lock);
  return 0;
...
bad:
  if (si)
    kfree((char*)si);
    80006358:	8556                	mv	a0,s5
    8000635a:	ffffa097          	auipc	ra,0xffffa
    8000635e:	cc2080e7          	jalr	-830(ra) # 8000001c <kfree>
  if (*f)
    80006362:	00093503          	ld	a0,0(s2)
    80006366:	c129                	beqz	a0,800063a8 <sockalloc+0x122>
    fileclose(*f);
    80006368:	ffffd097          	auipc	ra,0xffffd
    8000636c:	624080e7          	jalr	1572(ra) # 8000398c <fileclose>
  return -1;
    80006370:	557d                	li	a0,-1
    80006372:	a005                	j	80006392 <sockalloc+0x10c>
  si->next = sockets;
    80006374:	00bab023          	sd	a1,0(s5)
  sockets = si;
    80006378:	00004797          	auipc	a5,0x4
    8000637c:	cb57b823          	sd	s5,-848(a5) # 8000a028 <sockets>
  release(&lock);
    80006380:	00019517          	auipc	a0,0x19
    80006384:	fa050513          	addi	a0,a0,-96 # 8001f320 <lock>
    80006388:	00001097          	auipc	ra,0x1
    8000638c:	e8e080e7          	jalr	-370(ra) # 80007216 <release>
  return 0;
    ...
    80006398:	7902                	ld	s2,32(sp)
    8000639a:	69e2                	ld	s3,24(sp)
  ...
  return -1;
    ...
    800063a6:	b7f5                	j	80006392 <sockalloc+0x10c>
    800063a8:	557d                	li	a0,-1
    800063aa:	b7e5                	j	80006392 <sockalloc+0x10c>

00000000800063ac <sockclose>:
...
sockclose(struct sock *si)
{
  ...
  acquire(&lock);
    800063ba:	00019517          	auipc	a0,0x19
    800063be:	f6650513          	addi	a0,a0,-154 # 8001f320 <lock>
    800063c2:	00001097          	auipc	ra,0x1
    800063c6:	da0080e7          	jalr	-608(ra) # 80007162 <acquire>
  pos = &sockets;
    800063ca:	00004797          	auipc	a5,0x4
    800063ce:	c5e7b783          	ld	a5,-930(a5) # 8000a028 <sockets>
  while (*pos) {
    800063d2:	cb99                	beqz	a5,800063e8 <sockclose+0x3c>
    if (*pos == si){
    800063d4:	02f90563          	beq	s2,a5,800063fe <sockclose+0x52>
      *pos = si->next;
      break;
    }
    pos = &(*pos)->next;
    800063d8:	873e                	mv	a4,a5
    800063da:	639c                	ld	a5,0(a5)
  while (*pos) {
    800063dc:	c791                	beqz	a5,800063e8 <sockclose+0x3c>
    if (*pos == si){
    800063de:	fef91de3          	bne	s2,a5,800063d8 <sockclose+0x2c>
      *pos = si->next;
    800063e2:	00093783          	ld	a5,0(s2)
    800063e6:	e31c                	sd	a5,0(a4)
  }
  release(&lock);
    800063e8:	00019517          	auipc	a0,0x19
    800063ec:	f3850513          	addi	a0,a0,-200 # 8001f320 <lock>
    800063f0:	00001097          	auipc	ra,0x1
    800063f4:	e26080e7          	jalr	-474(ra) # 80007216 <release>

  // free any pending mbufs
  while (!mbufq_empty(&si->rxq)) {
    800063f8:	02890493          	addi	s1,s2,40
    800063fc:	a839                	j	8000641a <sockclose+0x6e>
  pos = &sockets;
    800063fe:	00004717          	auipc	a4,0x4
    80006402:	c2a70713          	addi	a4,a4,-982 # 8000a028 <sockets>
    80006406:	bff1                	j	800063e2 <sockclose+0x36>
    m = mbufq_pophead(&si->rxq);
    80006408:	8526                	mv	a0,s1
    8000640a:	00000097          	auipc	ra,0x0
    8000640e:	926080e7          	jalr	-1754(ra) # 80005d30 <mbufq_pophead>
    mbuffree(m);
    80006412:	00000097          	auipc	ra,0x0
    80006416:	8e6080e7          	jalr	-1818(ra) # 80005cf8 <mbuffree>
  while (!mbufq_empty(&si->rxq)) {
    8000641a:	8526                	mv	a0,s1
    8000641c:	00000097          	auipc	ra,0x0
    80006420:	92a080e7          	jalr	-1750(ra) # 80005d46 <mbufq_empty>
    80006424:	d175                	beqz	a0,80006408 <sockclose+0x5c>
  }

  kfree((char*)si);
    80006426:	854a                	mv	a0,s2
    80006428:	ffffa097          	auipc	ra,0xffffa
    8000642c:	bf4080e7          	jalr	-1036(ra) # 8000001c <kfree>
}
    80006430:	60e2                	ld	ra,24(sp)
    80006432:	6442                	ld	s0,16(sp)
    80006434:	64a2                	ld	s1,8(sp)
    80006436:	6902                	ld	s2,0(sp)
    80006438:	6105                	addi	sp,sp,32
    8000643a:	8082                	ret

000000008000643c <sockread>:

int
sockread(struct sock *si, uint64 addr, int n)
{
    8000643c:	7139                	addi	sp,sp,-64
    8000643e:	fc06                	sd	ra,56(sp)
    80006440:	f822                	sd	s0,48(sp)
    80006442:	f426                	sd	s1,40(sp)
    80006444:	f04a                	sd	s2,32(sp)
    80006446:	ec4e                	sd	s3,24(sp)
    80006448:	e852                	sd	s4,16(sp)
    8000644a:	e456                	sd	s5,8(sp)
    8000644c:	0080                	addi	s0,sp,64
    8000644e:	84aa                	mv	s1,a0
    80006450:	8a2e                	mv	s4,a1
    80006452:	8ab2                	mv	s5,a2
  struct proc *pr = myproc();
    80006454:	ffffb097          	auipc	ra,0xffffb
    80006458:	a4c080e7          	jalr	-1460(ra) # 80000ea0 <myproc>
    8000645c:	892a                	mv	s2,a0
  struct mbuf *m;
  int len;

  acquire(&si->lock);
    8000645e:	01048993          	addi	s3,s1,16
    80006462:	854e                	mv	a0,s3
    80006464:	00001097          	auipc	ra,0x1
    80006468:	cfe080e7          	jalr	-770(ra) # 80007162 <acquire>
  while (mbufq_empty(&si->rxq) && !pr->killed) {
    8000646c:	02848493          	addi	s1,s1,40
    80006470:	8526                	mv	a0,s1
    80006472:	00000097          	auipc	ra,0x0
    80006476:	8d4080e7          	jalr	-1836(ra) # 80005d46 <mbufq_empty>
    8000647a:	c919                	beqz	a0,80006490 <sockread+0x54>
    8000647c:	02892783          	lw	a5,40(s2)
    80006480:	eba5                	bnez	a5,800064f0 <sockread+0xb4>
    sleep(&si->rxq, &si->lock);
    80006482:	85ce                	mv	a1,s3
    80006484:	8526                	mv	a0,s1
    80006486:	ffffb097          	auipc	ra,0xffffb
    8000648a:	0d6080e7          	jalr	214(ra) # 8000155c <sleep>
    8000648e:	b7cd                	j	80006470 <sockread+0x34>
  }
  if (pr->killed) {
    80006490:	02892783          	lw	a5,40(s2)
    80006494:	efb1                	bnez	a5,800064f0 <sockread+0xb4>
    release(&si->lock);
    return -1;
  }
  m = mbufq_pophead(&si->rxq);
    ...
    8000649c:	898080e7          	jalr	-1896(ra) # 80005d30 <mbufq_pophead>
    800064a0:	84aa                	mv	s1,a0
  release(&si->lock);
    800064a2:	854e                	mv	a0,s3
    800064a4:	00001097          	auipc	ra,0x1
    800064a8:	d72080e7          	jalr	-654(ra) # 80007216 <release>

  len = m->len;
    800064ac:	489c                	lw	a5,16(s1)
  if (len > n)
    800064ae:	89be                	mv	s3,a5
    800064b0:	00fad363          	bge	s5,a5,800064b6 <sockread+0x7a>
    800064b4:	89d6                	mv	s3,s5
    800064b6:	2981                	sext.w	s3,s3
    len = n;
  if (copyout(pr->pagetable, addr, m->head, len) == -1) {
    800064b8:	86ce                	mv	a3,s3
    800064ba:	6490                	ld	a2,8(s1)
    800064bc:	85d2                	mv	a1,s4
    800064be:	05093503          	ld	a0,80(s2)
    800064c2:	ffffa097          	auipc	ra,0xffffa
    800064c6:	6a4080e7          	jalr	1700(ra) # 80000b66 <copyout>
    800064ca:	892a                	mv	s2,a0
    800064cc:	57fd                	li	a5,-1
    800064ce:	02f50863          	beq	a0,a5,800064fe <sockread+0xc2>
    mbuffree(m);
    return -1;
  }
  mbuffree(m);
    ...
    800064d8:	824080e7          	jalr	-2012(ra) # 80005cf8 <mbuffree>
  return len;
}
    800064dc:	854e                	mv	a0,s3
    800064de:	70e2                	ld	ra,56(sp)
    800064e0:	7442                	ld	s0,48(sp)
    800064e2:	74a2                	ld	s1,40(sp)
    800064e4:	7902                	ld	s2,32(sp)
    800064e6:	69e2                	ld	s3,24(sp)
    800064e8:	6a42                	ld	s4,16(sp)
    800064ea:	6aa2                	ld	s5,8(sp)
    800064ec:	6121                	addi	sp,sp,64
    800064ee:	8082                	ret
    release(&si->lock);
    800064f0:	854e                	mv	a0,s3
    800064f2:	00001097          	auipc	ra,0x1
    800064f6:	d24080e7          	jalr	-732(ra) # 80007216 <release>
    return -1;
    800064fa:	59fd                	li	s3,-1
    800064fc:	b7c5                	j	800064dc <sockread+0xa0>
    mbuffree(m);
    800064fe:	8526                	mv	a0,s1
    80006500:	fffff097          	auipc	ra,0xfffff
    80006504:	7f8080e7          	jalr	2040(ra) # 80005cf8 <mbuffree>
    return -1;
    80006508:	89ca                	mv	s3,s2
    8000650a:	bfc9                	j	800064dc <sockread+0xa0>

000000008000650c <sockwrite>:

int
sockwrite(struct sock *si, uint64 addr, int n)
{
    8000650c:	7139                	addi	sp,sp,-64
    8000650e:	fc06                	sd	ra,56(sp)
    80006510:	f822                	sd	s0,48(sp)
    80006512:	f426                	sd	s1,40(sp)
    80006514:	f04a                	sd	s2,32(sp)
    80006516:	ec4e                	sd	s3,24(sp)
    80006518:	e852                	sd	s4,16(sp)
    8000651a:	e456                	sd	s5,8(sp)
    8000651c:	0080                	addi	s0,sp,64
    8000651e:	8aaa                	mv	s5,a0
    80006520:	89ae                	mv	s3,a1
    80006522:	8932                	mv	s2,a2
  struct proc *pr = myproc();
    80006524:	ffffb097          	auipc	ra,0xffffb
    80006528:	97c080e7          	jalr	-1668(ra) # 80000ea0 <myproc>
    8000652c:	8a2a                	mv	s4,a0
  struct mbuf *m;

  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    8000652e:	08000513          	li	a0,128
    80006532:	fffff097          	auipc	ra,0xfffff
    80006536:	76e080e7          	jalr	1902(ra) # 80005ca0 <mbufalloc>
  if (!m)
    8000653a:	c12d                	beqz	a0,8000659c <sockwrite+0x90>
    8000653c:	84aa                	mv	s1,a0
    return -1;

  if (copyin(pr->pagetable, mbufput(m, n), addr, n) == -1) {
    8000653e:	050a3a03          	ld	s4,80(s4)
    80006542:	85ca                	mv	a1,s2
    80006544:	fffff097          	auipc	ra,0xfffff
    80006548:	700080e7          	jalr	1792(ra) # 80005c44 <mbufput>
    8000654c:	85aa                	mv	a1,a0
    8000654e:	86ca                	mv	a3,s2
    80006550:	864e                	mv	a2,s3
    80006552:	8552                	mv	a0,s4
    80006554:	ffffa097          	auipc	ra,0xffffa
    80006558:	69e080e7          	jalr	1694(ra) # 80000bf2 <copyin>
    8000655c:	89aa                	mv	s3,a0
    8000655e:	57fd                	li	a5,-1
    80006560:	02f50863          	beq	a0,a5,80006590 <sockwrite+0x84>
    mbuffree(m);
    return -1;
  }
  net_tx_udp(m, si->raddr, si->lport, si->rport);
    80006564:	00ead683          	lhu	a3,14(s5)
    80006568:	00cad603          	lhu	a2,12(s5)
    8000656c:	008aa583          	lw	a1,8(s5)
    80006570:	8526                	mv	a0,s1
    80006572:	fffff097          	auipc	ra,0xfffff
    80006576:	7f6080e7          	jalr	2038(ra) # 80005d68 <net_tx_udp>
  return n;
    8000657a:	89ca                	mv	s3,s2
}
    ...
    8000658a:	6aa2                	ld	s5,8(sp)
    8000658c:	6121                	addi	sp,sp,64
    8000658e:	8082                	ret
    mbuffree(m);
    80006590:	8526                	mv	a0,s1
    80006592:	fffff097          	auipc	ra,0xfffff
    80006596:	766080e7          	jalr	1894(ra) # 80005cf8 <mbuffree>
    return -1;
    8000659a:	b7cd                	j	8000657c <sockwrite+0x70>
    return -1;
    8000659c:	59fd                	li	s3,-1
    8000659e:	bff9                	j	8000657c <sockwrite+0x70>

00000000800065a0 <sockrecvudp>:

// called by protocol handler layer to deliver UDP packets
void
sockrecvudp(struct mbuf *m, uint32 raddr, uint16 lport, uint16 rport)
{
    800065a0:	7139                	addi	sp,sp,-64
    800065a2:	fc06                	sd	ra,56(sp)
    800065a4:	f822                	sd	s0,48(sp)
    800065a6:	f426                	sd	s1,40(sp)
    800065a8:	f04a                	sd	s2,32(sp)
    800065aa:	ec4e                	sd	s3,24(sp)
    800065ac:	e852                	sd	s4,16(sp)
    800065ae:	e456                	sd	s5,8(sp)
    800065b0:	0080                	addi	s0,sp,64
    800065b2:	8a2a                	mv	s4,a0
    800065b4:	892e                	mv	s2,a1
    800065b6:	89b2                	mv	s3,a2
    800065b8:	8ab6                	mv	s5,a3
  ...
  acquire(&lock);
    800065ba:	00019517          	auipc	a0,0x19
    800065be:	d6650513          	addi	a0,a0,-666 # 8001f320 <lock>
    800065c2:	00001097          	auipc	ra,0x1
    800065c6:	ba0080e7          	jalr	-1120(ra) # 80007162 <acquire>
  si = sockets;
    800065ca:	00004497          	auipc	s1,0x4
    800065ce:	a5e4b483          	ld	s1,-1442(s1) # 8000a028 <sockets>
  while (si) {
    800065d2:	c4ad                	beqz	s1,8000663c <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065d4:	0009871b          	sext.w	a4,s3
    800065d8:	000a869b          	sext.w	a3,s5
    800065dc:	a019                	j	800065e2 <sockrecvudp+0x42>
      goto found;
    si = si->next;
    800065de:	6084                	ld	s1,0(s1)
  while (si) {
    800065e0:	ccb1                	beqz	s1,8000663c <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065e2:	449c                	lw	a5,8(s1)
    800065e4:	ff279de3          	bne	a5,s2,800065de <sockrecvudp+0x3e>
    800065e8:	00c4d783          	lhu	a5,12(s1)
    800065ec:	fee799e3          	bne	a5,a4,800065de <sockrecvudp+0x3e>
    800065f0:	00e4d783          	lhu	a5,14(s1)
    800065f4:	fed795e3          	bne	a5,a3,800065de <sockrecvudp+0x3e>
  release(&lock);
  mbuffree(m);
  return;
...
found:
  acquire(&si->lock);
    800065f8:	01048913          	addi	s2,s1,16
    800065fc:	854a                	mv	a0,s2
    800065fe:	00001097          	auipc	ra,0x1
    80006602:	b64080e7          	jalr	-1180(ra) # 80007162 <acquire>
  mbufq_pushtail(&si->rxq, m);
    80006606:	02848493          	addi	s1,s1,40
    8000660a:	85d2                	mv	a1,s4
    8000660c:	8526                	mv	a0,s1
    8000660e:	fffff097          	auipc	ra,0xfffff
    80006612:	702080e7          	jalr	1794(ra) # 80005d10 <mbufq_pushtail>
  wakeup(&si->rxq);
    80006616:	8526                	mv	a0,s1
    80006618:	ffffb097          	auipc	ra,0xffffb
    8000661c:	0d0080e7          	jalr	208(ra) # 800016e8 <wakeup>
  release(&si->lock);
    80006620:	854a                	mv	a0,s2
    80006622:	00001097          	auipc	ra,0x1
    80006626:	bf4080e7          	jalr	-1036(ra) # 80007216 <release>
  release(&lock);
    8000662a:	00019517          	auipc	a0,0x19
    8000662e:	cf650513          	addi	a0,a0,-778 # 8001f320 <lock>
    80006632:	00001097          	auipc	ra,0x1
    80006636:	be4080e7          	jalr	-1052(ra) # 80007216 <release>
    8000663a:	a831                	j	80006656 <sockrecvudp+0xb6>
  release(&lock);
    8000663c:	00019517          	auipc	a0,0x19
    80006640:	ce450513          	addi	a0,a0,-796 # 8001f320 <lock>
    80006644:	00001097          	auipc	ra,0x1
    80006648:	bd2080e7          	jalr	-1070(ra) # 80007216 <release>
  mbuffree(m);
    8000664c:	8552                	mv	a0,s4
    8000664e:	fffff097          	auipc	ra,0xfffff
    80006652:	6aa080e7          	jalr	1706(ra) # 80005cf8 <mbuffree>
}
    80006656:	70e2                	ld	ra,56(sp)
    80006658:	7442                	ld	s0,48(sp)
    8000665a:	74a2                	ld	s1,40(sp)
    8000665c:	7902                	ld	s2,32(sp)
    8000665e:	69e2                	ld	s3,24(sp)
    80006660:	6a42                	ld	s4,16(sp)
    80006662:	6aa2                	ld	s5,8(sp)
    80006664:	6121                	addi	sp,sp,64
    80006666:	8082                	ret

0000000080006668 <pci_init>:
#include "proc.h"
#include "defs.h"
...
pci_init()
{
    ...
    80006678:	e85a                	sd	s6,16(sp)
    8000667a:	e45e                	sd	s7,8(sp)
    8000667c:	0880                	addi	s0,sp,80
    8000667e:	300004b7          	lui	s1,0x30000
    ...
    if(id == 0x100e8086){
    80006682:	100e8937          	lui	s2,0x100e8
    80006686:	08690913          	addi	s2,s2,134 # 100e8086 <_entry-0x6ff17f7a>
      // command and status register.
      // bit 0 : I/O access enable
      // bit 1 : memory access enable
      // bit 2 : enable mastering
      base[1] = 7;
    8000668a:	4b9d                	li	s7,7
      for(int i = 0; i < 6; i++){
        uint32 old = base[4+i];
    ...
    8000668c:	5afd                	li	s5,-1
      ...
      base[4+0] = e1000_regs;
    8000668e:	40000b37          	lui	s6,0x40000
    80006692:	6a09                	lui	s4,0x2
  for(int dev = 0; dev < 32; dev++){
    80006694:	300409b7          	lui	s3,0x30040
    80006698:	a821                	j	800066b0 <pci_init+0x48>
      base[4+0] = e1000_regs;
    8000669a:	0166a823          	sw	s6,16(a3)

      e1000_init((uint32*)e1000_regs);
    8000669e:	40000537          	lui	a0,0x40000
    800066a2:	fffff097          	auipc	ra,0xfffff
    800066a6:	0be080e7          	jalr	190(ra) # 80005760 <e1000_init>
  for(int dev = 0; dev < 32; dev++){
    800066aa:	94d2                	add	s1,s1,s4
    800066ac:	03348a63          	beq	s1,s3,800066e0 <pci_init+0x78>
    volatile uint32 *base = ecam + off;
    800066b0:	86a6                	mv	a3,s1
    uint32 id = base[0];
    800066b2:	409c                	lw	a5,0(s1)
    800066b4:	2781                	sext.w	a5,a5
    if(id == 0x100e8086){
    800066b6:	ff279ae3          	bne	a5,s2,800066aa <pci_init+0x42>
      base[1] = 7;
    800066ba:	0174a223          	sw	s7,4(s1) # 30000004 <_entry-0x4ffffffc>
      __sync_synchronize();
    800066be:	0ff0000f          	fence
      for(int i = 0; i < 6; i++){
    800066c2:	01048793          	addi	a5,s1,16
    800066c6:	02848613          	addi	a2,s1,40
        uint32 old = base[4+i];
    800066ca:	4398                	lw	a4,0(a5)
    800066cc:	2701                	sext.w	a4,a4
        base[4+i] = 0xffffffff;
    800066ce:	0157a023          	sw	s5,0(a5)
        __sync_synchronize();
    800066d2:	0ff0000f          	fence
        base[4+i] = old;
    800066d6:	c398                	sw	a4,0(a5)
      for(int i = 0; i < 6; i++){
    800066d8:	0791                	addi	a5,a5,4
    800066da:	fec798e3          	bne	a5,a2,800066ca <pci_init+0x62>
    800066de:	bf75                	j	8000669a <pci_init+0x32>
    }
  }
}
    800066e0:	60a6                	ld	ra,72(sp)
    800066e2:	6406                	ld	s0,64(sp)
    800066e4:	74e2                	ld	s1,56(sp)
    800066e6:	7942                	ld	s2,48(sp)
    800066e8:	79a2                	ld	s3,40(sp)
    800066ea:	7a02                	ld	s4,32(sp)
    800066ec:	6ae2                	ld	s5,24(sp)
    800066ee:	6b42                	ld	s6,16(sp)
    800066f0:	6ba2                	ld	s7,8(sp)
    800066f2:	6161                	addi	sp,sp,80
    800066f4:	8082                	ret

00000000800066f6 <timerinit>:
...
timerinit()
{
  ...
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    800066fc:	f14027f3          	csrr	a5,mhartid
  // each CPU has a separate source of timer interrupts.
  int id = r_mhartid();
    80006700:	0007869b          	sext.w	a3,a5

  // ask the CLINT for a timer interrupt.
  int interval = 1000000; // cycles; about 1/10th second in qemu.
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
    80006704:	0037979b          	slliw	a5,a5,0x3
    80006708:	02004737          	lui	a4,0x2004
    8000670c:	97ba                	add	a5,a5,a4
    8000670e:	0200c737          	lui	a4,0x200c
    80006712:	ff873583          	ld	a1,-8(a4) # 200bff8 <_entry-0x7dff4008>
    80006716:	000f4637          	lui	a2,0xf4
    8000671a:	24060613          	addi	a2,a2,576 # f4240 <_entry-0x7ff0bdc0>
    8000671e:	95b2                	add	a1,a1,a2
    80006720:	e38c                	sd	a1,0(a5)
  ...
  uint64 *scratch = &timer_scratch[id][0];
    80006722:	00269713          	slli	a4,a3,0x2
    80006726:	9736                	add	a4,a4,a3
    80006728:	00371693          	slli	a3,a4,0x3
    8000672c:	00019717          	auipc	a4,0x19
    80006730:	c1470713          	addi	a4,a4,-1004 # 8001f340 <timer_scratch>
    80006734:	9736                	add	a4,a4,a3
  scratch[3] = CLINT_MTIMECMP(id);
    80006736:	ef1c                	sd	a5,24(a4)
  scratch[4] = interval;
    80006738:	f310                	sd	a2,32(a4)
  asm volatile("csrw mscratch, %0" : : "r" (x));
    8000673a:	34071073          	csrw	mscratch,a4
  asm volatile("csrw mtvec, %0" : : "r" (x));
    8000673e:	fffff797          	auipc	a5,0xfffff
    80006742:	9c278793          	addi	a5,a5,-1598 # 80005100 <timervec>
    80006746:	30579073          	csrw	mtvec,a5
  ...
  w_mstatus(r_mstatus() | MSTATUS_MIE);
    8000674e:	0087e793          	ori	a5,a5,8
  asm volatile("csrw mstatus, %0" : : "r" (x));
    80006752:	30079073          	csrw	mstatus,a5
  asm volatile("csrr %0, mie" : "=r" (x) );
    80006756:	304027f3          	csrr	a5,mie

  // enable machine-mode timer interrupts.
  w_mie(r_mie() | MIE_MTIE);
    8000675a:	0807e793          	ori	a5,a5,128
  asm volatile("csrw mie, %0" : : "r" (x));
    8000675e:	30479073          	csrw	mie,a5
}
    80006762:	6422                	ld	s0,8(sp)
    80006764:	0141                	addi	sp,sp,16
    80006766:	8082                	ret

0000000080006768 <start>:
{
  ...
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    80006770:	300027f3          	csrr	a5,mstatus
  x &= ~MSTATUS_MPP_MASK;
    80006774:	7779                	lui	a4,0xffffe
    80006776:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffd727f>
    8000677a:	8ff9                	and	a5,a5,a4
  x |= MSTATUS_MPP_S;
    8000677c:	6705                	lui	a4,0x1
    8000677e:	80070713          	addi	a4,a4,-2048 # 800 <_entry-0x7ffff800>
    80006782:	8fd9                	or	a5,a5,a4
  asm volatile("csrw mstatus, %0" : : "r" (x));
    80006784:	30079073          	csrw	mstatus,a5
  asm volatile("csrw mepc, %0" : : "r" (x));
    80006788:	ffffa797          	auipc	a5,0xffffa
    8000678c:	b9e78793          	addi	a5,a5,-1122 # 80000326 <main>
    80006790:	34179073          	csrw	mepc,a5
  asm volatile("csrw satp, %0" : : "r" (x));
    80006794:	4781                	li	a5,0
    80006796:	18079073          	csrw	satp,a5
  asm volatile("csrw medeleg, %0" : : "r" (x));
    8000679a:	67c1                	lui	a5,0x10
    8000679c:	17fd                	addi	a5,a5,-1
    8000679e:	30279073          	csrw	medeleg,a5
  asm volatile("csrw mideleg, %0" : : "r" (x));
    800067a2:	30379073          	csrw	mideleg,a5
  asm volatile("csrr %0, sie" : "=r" (x) );
    800067a6:	104027f3          	csrr	a5,sie
  w_sie(r_sie() | SIE_SEIE | SIE_STIE | SIE_SSIE);
    800067aa:	2227e793          	ori	a5,a5,546
  asm volatile("csrw sie, %0" : : "r" (x));
    800067ae:	10479073          	csrw	sie,a5
  asm volatile("csrw pmpaddr0, %0" : : "r" (x));
    800067b2:	57fd                	li	a5,-1
    800067b4:	83a9                	srli	a5,a5,0xa
    800067b6:	3b079073          	csrw	pmpaddr0,a5
  asm volatile("csrw pmpcfg0, %0" : : "r" (x));
    800067ba:	47bd                	li	a5,15
    800067bc:	3a079073          	csrw	pmpcfg0,a5
  timerinit();
    800067c0:	00000097          	auipc	ra,0x0
    800067c4:	f36080e7          	jalr	-202(ra) # 800066f6 <timerinit>
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    800067c8:	f14027f3          	csrr	a5,mhartid
  w_tp(id);
    800067cc:	2781                	sext.w	a5,a5
  asm volatile("mv tp, %0" : : "r" (x));
    800067ce:	823e                	mv	tp,a5
  asm volatile("mret");
    800067d0:	30200073          	mret
}
...
{
    800067dc:	715d                	addi	sp,sp,-80
    800067de:	e486                	sd	ra,72(sp)
    800067e0:	e0a2                	sd	s0,64(sp)
    800067e2:	fc26                	sd	s1,56(sp)
    800067e4:	f84a                	sd	s2,48(sp)
    800067e6:	f44e                	sd	s3,40(sp)
    800067e8:	f052                	sd	s4,32(sp)
    800067ea:	ec56                	sd	s5,24(sp)
    800067ec:	0880                	addi	s0,sp,80
  int i;

  for(i = 0; i < n; i++){
    800067ee:	04c05663          	blez	a2,8000683a <consolewrite+0x5e>
    800067f2:	8a2a                	mv	s4,a0
    800067f4:	84ae                	mv	s1,a1
    800067f6:	89b2                	mv	s3,a2
    800067f8:	4901                	li	s2,0
    char c;
    if(either_copyin(&c, user_src, src+i, 1) == -1)
    800067fa:	5afd                	li	s5,-1
    800067fc:	4685                	li	a3,1
    800067fe:	8626                	mv	a2,s1
    80006800:	85d2                	mv	a1,s4
    80006802:	fbf40513          	addi	a0,s0,-65
    80006806:	ffffb097          	auipc	ra,0xffffb
    8000680a:	150080e7          	jalr	336(ra) # 80001956 <either_copyin>
    8000680e:	01550c63          	beq	a0,s5,80006826 <consolewrite+0x4a>
      break;
    uartputc(c);
    80006812:	fbf44503          	lbu	a0,-65(s0)
    80006816:	00000097          	auipc	ra,0x0
    8000681a:	78e080e7          	jalr	1934(ra) # 80006fa4 <uartputc>
  for(i = 0; i < n; i++){
    8000681e:	2905                	addiw	s2,s2,1
    80006820:	0485                	addi	s1,s1,1
    80006822:	fd299de3          	bne	s3,s2,800067fc <consolewrite+0x20>
  }

  return i;
}
    80006826:	854a                	mv	a0,s2
    80006828:	60a6                	ld	ra,72(sp)
    8000682a:	6406                	ld	s0,64(sp)
    8000682c:	74e2                	ld	s1,56(sp)
    8000682e:	7942                	ld	s2,48(sp)
    80006830:	79a2                	ld	s3,40(sp)
    80006832:	7a02                	ld	s4,32(sp)
    80006834:	6ae2                	ld	s5,24(sp)
    80006836:	6161                	addi	sp,sp,80
    80006838:	8082                	ret
  for(i = 0; i < n; i++){
    8000683a:	4901                	li	s2,0
    8000683c:	b7ed                	j	80006826 <consolewrite+0x4a>

000000008000683e <consoleread>:
...
{
    8000683e:	7119                	addi	sp,sp,-128
    80006840:	fc86                	sd	ra,120(sp)
    80006842:	f8a2                	sd	s0,112(sp)
    80006844:	f4a6                	sd	s1,104(sp)
    80006846:	f0ca                	sd	s2,96(sp)
    80006848:	ecce                	sd	s3,88(sp)
    8000684a:	e8d2                	sd	s4,80(sp)
    8000684c:	e4d6                	sd	s5,72(sp)
    8000684e:	e0da                	sd	s6,64(sp)
    80006850:	fc5e                	sd	s7,56(sp)
    80006852:	f862                	sd	s8,48(sp)
    80006854:	f466                	sd	s9,40(sp)
    80006856:	f06a                	sd	s10,32(sp)
    80006858:	ec6e                	sd	s11,24(sp)
    8000685a:	0100                	addi	s0,sp,128
    8000685c:	8b2a                	mv	s6,a0
    8000685e:	8aae                	mv	s5,a1
    80006860:	8a32                	mv	s4,a2
  uint target;
  int c;
  char cbuf;

  target = n;
    80006862:	00060b9b          	sext.w	s7,a2
  acquire(&cons.lock);
    80006866:	00021517          	auipc	a0,0x21
    8000686a:	c1a50513          	addi	a0,a0,-998 # 80027480 <cons>
    8000686e:	00001097          	auipc	ra,0x1
    80006872:	8f4080e7          	jalr	-1804(ra) # 80007162 <acquire>
  while(n > 0){
    // wait until interrupt handler has put some
    // input into cons.buffer.
    while(cons.r == cons.w){
    80006876:	00021497          	auipc	s1,0x21
    8000687a:	c0a48493          	addi	s1,s1,-1014 # 80027480 <cons>
      if(myproc()->killed){
        release(&cons.lock);
        return -1;
      }
      sleep(&cons.r, &cons.lock);
    8000687e:	89a6                	mv	s3,s1
    80006880:	00021917          	auipc	s2,0x21
    80006884:	c9890913          	addi	s2,s2,-872 # 80027518 <cons+0x98>
    }

    c = cons.buf[cons.r++ % INPUT_BUF];

    if(c == C('D')){  // end-of-file
    80006888:	4c91                	li	s9,4
      break;
    }
    ...
    if(c == '\n'){
    8000688c:	4da9                	li	s11,10
  while(n > 0){
    8000688e:	07405863          	blez	s4,800068fe <consoleread+0xc0>
    while(cons.r == cons.w){
    80006892:	0984a783          	lw	a5,152(s1)
    80006896:	09c4a703          	lw	a4,156(s1)
    8000689a:	02f71463          	bne	a4,a5,800068c2 <consoleread+0x84>
      if(myproc()->killed){
    8000689e:	ffffa097          	auipc	ra,0xffffa
    800068a2:	602080e7          	jalr	1538(ra) # 80000ea0 <myproc>
    800068a6:	551c                	lw	a5,40(a0)
    800068a8:	e7b5                	bnez	a5,80006914 <consoleread+0xd6>
      sleep(&cons.r, &cons.lock);
    800068aa:	85ce                	mv	a1,s3
    800068ac:	854a                	mv	a0,s2
    800068ae:	ffffb097          	auipc	ra,0xffffb
    800068b2:	cae080e7          	jalr	-850(ra) # 8000155c <sleep>
    while(cons.r == cons.w){
    800068b6:	0984a783          	lw	a5,152(s1)
    800068ba:	09c4a703          	lw	a4,156(s1)
    800068be:	fef700e3          	beq	a4,a5,8000689e <consoleread+0x60>
    c = cons.buf[cons.r++ % INPUT_BUF];
    800068c2:	0017871b          	addiw	a4,a5,1
    800068c6:	08e4ac23          	sw	a4,152(s1)
    800068ca:	07f7f713          	andi	a4,a5,127
    800068ce:	9726                	add	a4,a4,s1
    800068d0:	01874703          	lbu	a4,24(a4)
    800068d4:	00070c1b          	sext.w	s8,a4
    if(c == C('D')){  // end-of-file
    800068d8:	079c0663          	beq	s8,s9,80006944 <consoleread+0x106>
    cbuf = c;
    800068dc:	f8e407a3          	sb	a4,-113(s0)
    if(either_copyout(user_dst, dst, &cbuf, 1) == -1)
    800068e0:	4685                	li	a3,1
    800068e2:	f8f40613          	addi	a2,s0,-113
    800068e6:	85d6                	mv	a1,s5
    800068e8:	855a                	mv	a0,s6
    800068ea:	ffffb097          	auipc	ra,0xffffb
    800068ee:	016080e7          	jalr	22(ra) # 80001900 <either_copyout>
    800068f2:	01a50663          	beq	a0,s10,800068fe <consoleread+0xc0>
    dst++;
    800068f6:	0a85                	addi	s5,s5,1
    --n;
    800068f8:	3a7d                	addiw	s4,s4,-1
    if(c == '\n'){
    800068fa:	f9bc1ae3          	bne	s8,s11,8000688e <consoleread+0x50>
  ...
  release(&cons.lock);
    800068fe:	00021517          	auipc	a0,0x21
    80006902:	b8250513          	addi	a0,a0,-1150 # 80027480 <cons>
    80006906:	00001097          	auipc	ra,0x1
    8000690a:	910080e7          	jalr	-1776(ra) # 80007216 <release>

  return target - n;
    8000690e:	414b853b          	subw	a0,s7,s4
    80006912:	a811                	j	80006926 <consoleread+0xe8>
        release(&cons.lock);
    80006914:	00021517          	auipc	a0,0x21
    80006918:	b6c50513          	addi	a0,a0,-1172 # 80027480 <cons>
    8000691c:	00001097          	auipc	ra,0x1
    80006920:	8fa080e7          	jalr	-1798(ra) # 80007216 <release>
        return -1;
    80006924:	557d                	li	a0,-1
}
    80006926:	70e6                	ld	ra,120(sp)
    80006928:	7446                	ld	s0,112(sp)
    8000692a:	74a6                	ld	s1,104(sp)
    8000692c:	7906                	ld	s2,96(sp)
    8000692e:	69e6                	ld	s3,88(sp)
    80006930:	6a46                	ld	s4,80(sp)
    80006932:	6aa6                	ld	s5,72(sp)
    80006934:	6b06                	ld	s6,64(sp)
    80006936:	7be2                	ld	s7,56(sp)
    80006938:	7c42                	ld	s8,48(sp)
    8000693a:	7ca2                	ld	s9,40(sp)
    8000693c:	7d02                	ld	s10,32(sp)
    8000693e:	6de2                	ld	s11,24(sp)
    80006940:	6109                	addi	sp,sp,128
    80006942:	8082                	ret
      if(n < target){
    80006944:	000a071b          	sext.w	a4,s4
    80006948:	fb777be3          	bgeu	a4,s7,800068fe <consoleread+0xc0>
        cons.r--;
    8000694c:	00021717          	auipc	a4,0x21
    80006950:	bcf72623          	sw	a5,-1076(a4) # 80027518 <cons+0x98>
    80006954:	b76d                	j	800068fe <consoleread+0xc0>

0000000080006956 <consputc>:
{
  ...
  if(c == BACKSPACE){
    8000695e:	10000793          	li	a5,256
    80006962:	00f50a63          	beq	a0,a5,80006976 <consputc+0x20>
    uartputc_sync(c);
    80006966:	00000097          	auipc	ra,0x0
    8000696a:	564080e7          	jalr	1380(ra) # 80006eca <uartputc_sync>
}
    8000696e:	60a2                	ld	ra,8(sp)
    80006970:	6402                	ld	s0,0(sp)
    80006972:	0141                	addi	sp,sp,16
    80006974:	8082                	ret
    uartputc_sync('\b'); uartputc_sync(' '); uartputc_sync('\b');
    80006976:	4521                	li	a0,8
    80006978:	00000097          	auipc	ra,0x0
    8000697c:	552080e7          	jalr	1362(ra) # 80006eca <uartputc_sync>
    80006980:	02000513          	li	a0,32
    80006984:	00000097          	auipc	ra,0x0
    80006988:	546080e7          	jalr	1350(ra) # 80006eca <uartputc_sync>
    8000698c:	4521                	li	a0,8
    8000698e:	00000097          	auipc	ra,0x0
    80006992:	53c080e7          	jalr	1340(ra) # 80006eca <uartputc_sync>
    80006996:	bfe1                	j	8000696e <consputc+0x18>

0000000080006998 <consoleintr>:
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    800069b2:	7b4080e7          	jalr	1972(ra) # 80007162 <acquire>

  switch(c){
    800069b6:	47d5                	li	a5,21
    800069b8:	0af48663          	beq	s1,a5,80006a64 <consoleintr+0xcc>
    800069bc:	0297ca63          	blt	a5,s1,800069f0 <consoleintr+0x58>
    800069c0:	47a1                	li	a5,8
    800069c2:	0ef48763          	beq	s1,a5,80006ab0 <consoleintr+0x118>
    800069c6:	47c1                	li	a5,16
    800069c8:	10f49a63          	bne	s1,a5,80006adc <consoleintr+0x144>
  case C('P'):  // Print process list.
    procdump();
    800069cc:	ffffb097          	auipc	ra,0xffffb
    800069d0:	fe0080e7          	jalr	-32(ra) # 800019ac <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    ...
    800069d8:	aac50513          	addi	a0,a0,-1364 # 80027480 <cons>
    800069dc:	00001097          	auipc	ra,0x1
    800069e0:	83a080e7          	jalr	-1990(ra) # 80007216 <release>
}
    800069e4:	60e2                	ld	ra,24(sp)
    800069e6:	6442                	ld	s0,16(sp)
    800069e8:	64a2                	ld	s1,8(sp)
    800069ea:	6902                	ld	s2,0(sp)
    800069ec:	6105                	addi	sp,sp,32
    800069ee:	8082                	ret
  switch(c){
    800069f0:	07f00793          	li	a5,127
    800069f4:	0af48e63          	beq	s1,a5,80006ab0 <consoleintr+0x118>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    800069f8:	00021717          	auipc	a4,0x21
    800069fc:	a8870713          	addi	a4,a4,-1400 # 80027480 <cons>
    80006a00:	0a072783          	lw	a5,160(a4)
    80006a04:	09872703          	lw	a4,152(a4)
    80006a08:	9f99                	subw	a5,a5,a4
    80006a0a:	07f00713          	li	a4,127
    80006a0e:	fcf763e3          	bltu	a4,a5,800069d4 <consoleintr+0x3c>
      c = (c == '\r') ? '\n' : c;
    80006a12:	47b5                	li	a5,13
    80006a14:	0cf48763          	beq	s1,a5,80006ae2 <consoleintr+0x14a>
      consputc(c);
    80006a18:	8526                	mv	a0,s1
    80006a1a:	00000097          	auipc	ra,0x0
    80006a1e:	f3c080e7          	jalr	-196(ra) # 80006956 <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a22:	00021797          	auipc	a5,0x21
    80006a26:	a5e78793          	addi	a5,a5,-1442 # 80027480 <cons>
    80006a2a:	0a07a703          	lw	a4,160(a5)
    80006a2e:	0017069b          	addiw	a3,a4,1
    80006a32:	0006861b          	sext.w	a2,a3
    80006a36:	0ad7a023          	sw	a3,160(a5)
    80006a3a:	07f77713          	andi	a4,a4,127
    80006a3e:	97ba                	add	a5,a5,a4
    80006a40:	00978c23          	sb	s1,24(a5)
      if(c == '\n' || c == C('D') || cons.e == cons.r+INPUT_BUF){
    80006a44:	47a9                	li	a5,10
    80006a46:	0cf48563          	beq	s1,a5,80006b10 <consoleintr+0x178>
    80006a4a:	4791                	li	a5,4
    80006a4c:	0cf48263          	beq	s1,a5,80006b10 <consoleintr+0x178>
    80006a50:	00021797          	auipc	a5,0x21
    80006a54:	ac87a783          	lw	a5,-1336(a5) # 80027518 <cons+0x98>
    80006a58:	0807879b          	addiw	a5,a5,128
    80006a5c:	f6f61ce3          	bne	a2,a5,800069d4 <consoleintr+0x3c>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a60:	863e                	mv	a2,a5
    80006a62:	a07d                	j	80006b10 <consoleintr+0x178>
    while(cons.e != cons.w &&
    ...
    80006a74:	00021497          	auipc	s1,0x21
    80006a78:	a0c48493          	addi	s1,s1,-1524 # 80027480 <cons>
    while(cons.e != cons.w &&
    80006a7c:	4929                	li	s2,10
    80006a7e:	f4f70be3          	beq	a4,a5,800069d4 <consoleintr+0x3c>
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a82:	37fd                	addiw	a5,a5,-1
    80006a84:	07f7f713          	andi	a4,a5,127
    80006a88:	9726                	add	a4,a4,s1
    while(cons.e != cons.w &&
    80006a8a:	01874703          	lbu	a4,24(a4)
    80006a8e:	f52703e3          	beq	a4,s2,800069d4 <consoleintr+0x3c>
      cons.e--;
    80006a92:	0af4a023          	sw	a5,160(s1)
      consputc(BACKSPACE);
    80006a96:	10000513          	li	a0,256
    80006a9a:	00000097          	auipc	ra,0x0
    80006a9e:	ebc080e7          	jalr	-324(ra) # 80006956 <consputc>
    while(cons.e != cons.w &&
    80006aa2:	0a04a783          	lw	a5,160(s1)
    80006aa6:	09c4a703          	lw	a4,156(s1)
    80006aaa:	fcf71ce3          	bne	a4,a5,80006a82 <consoleintr+0xea>
    80006aae:	b71d                	j	800069d4 <consoleintr+0x3c>
    if(cons.e != cons.w){
    80006ab0:	00021717          	auipc	a4,0x21
    80006ab4:	9d070713          	addi	a4,a4,-1584 # 80027480 <cons>
    80006ab8:	0a072783          	lw	a5,160(a4)
    80006abc:	09c72703          	lw	a4,156(a4)
    80006ac0:	f0f70ae3          	beq	a4,a5,800069d4 <consoleintr+0x3c>
      cons.e--;
    80006ac4:	37fd                	addiw	a5,a5,-1
    80006ac6:	00021717          	auipc	a4,0x21
    80006aca:	a4f72d23          	sw	a5,-1446(a4) # 80027520 <cons+0xa0>
      consputc(BACKSPACE);
    80006ace:	10000513          	li	a0,256
    80006ad2:	00000097          	auipc	ra,0x0
    80006ad6:	e84080e7          	jalr	-380(ra) # 80006956 <consputc>
    80006ada:	bded                	j	800069d4 <consoleintr+0x3c>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    80006adc:	ee048ce3          	beqz	s1,800069d4 <consoleintr+0x3c>
    80006ae0:	bf21                	j	800069f8 <consoleintr+0x60>
      consputc(c);
    80006ae2:	4529                	li	a0,10
    80006ae4:	00000097          	auipc	ra,0x0
    80006ae8:	e72080e7          	jalr	-398(ra) # 80006956 <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006aec:	00021797          	auipc	a5,0x21
    80006af0:	99478793          	addi	a5,a5,-1644 # 80027480 <cons>
    80006af4:	0a07a703          	lw	a4,160(a5)
    80006af8:	0017069b          	addiw	a3,a4,1
    80006afc:	0006861b          	sext.w	a2,a3
    80006b00:	0ad7a023          	sw	a3,160(a5)
    80006b04:	07f77713          	andi	a4,a4,127
    80006b08:	97ba                	add	a5,a5,a4
    80006b0a:	4729                	li	a4,10
    80006b0c:	00e78c23          	sb	a4,24(a5)
        cons.w = cons.e;
    80006b10:	00021797          	auipc	a5,0x21
    80006b14:	a0c7a623          	sw	a2,-1524(a5) # 8002751c <cons+0x9c>
        wakeup(&cons.r);
    80006b18:	00021517          	auipc	a0,0x21
    80006b1c:	a0050513          	addi	a0,a0,-1536 # 80027518 <cons+0x98>
    80006b20:	ffffb097          	auipc	ra,0xffffb
    80006b24:	bc8080e7          	jalr	-1080(ra) # 800016e8 <wakeup>
    80006b28:	b575                	j	800069d4 <consoleintr+0x3c>

0000000080006b2a <consoleinit>:

void
consoleinit(void)
{
    80006b2a:	1141                	addi	sp,sp,-16
    80006b2c:	e406                	sd	ra,8(sp)
    80006b2e:	e022                	sd	s0,0(sp)
    80006b30:	0800                	addi	s0,sp,16
  initlock(&cons.lock, "cons");
    80006b32:	00003597          	auipc	a1,0x3
    80006b36:	d1658593          	addi	a1,a1,-746 # 80009848 <syscalls+0x470>
    80006b3a:	00021517          	auipc	a0,0x21
    80006b3e:	94650513          	addi	a0,a0,-1722 # 80027480 <cons>
    80006b42:	00000097          	auipc	ra,0x0
    80006b46:	590080e7          	jalr	1424(ra) # 800070d2 <initlock>

  uartinit();
    80006b4a:	00000097          	auipc	ra,0x0
    80006b4e:	330080e7          	jalr	816(ra) # 80006e7a <uartinit>

  // connect read and write system calls
  // to consoleread and consolewrite.
  devsw[CONSOLE].read = consoleread;
    80006b52:	00013797          	auipc	a5,0x13
    80006b56:	59678793          	addi	a5,a5,1430 # 8001a0e8 <devsw>
    80006b5a:	00000717          	auipc	a4,0x0
    80006b5e:	ce470713          	addi	a4,a4,-796 # 8000683e <consoleread>
    80006b62:	eb98                	sd	a4,16(a5)
  devsw[CONSOLE].write = consolewrite;
    80006b64:	00000717          	auipc	a4,0x0
    80006b68:	c7870713          	addi	a4,a4,-904 # 800067dc <consolewrite>
    80006b6c:	ef98                	sd	a4,24(a5)
}
...
printint(int xx, int base, int sign)
{
    ...
    80006b7c:	ec26                	sd	s1,24(sp)
    80006b7e:	e84a                	sd	s2,16(sp)
    80006b80:	1800                	addi	s0,sp,48
  char buf[16];
  int i;
  uint x;

  if(sign && (sign = xx < 0))
    80006b82:	c219                	beqz	a2,80006b88 <printint+0x12>
    80006b84:	08054663          	bltz	a0,80006c10 <printint+0x9a>
    x = -xx;
  else
    x = xx;
    80006b88:	2501                	sext.w	a0,a0
    80006b8a:	4881                	li	a7,0
    80006b8c:	fd040693          	addi	a3,s0,-48

  i = 0;
    80006b90:	4701                	li	a4,0
  do {
    buf[i++] = digits[x % base];
    80006b92:	2581                	sext.w	a1,a1
    80006b94:	00003617          	auipc	a2,0x3
    80006b98:	ce460613          	addi	a2,a2,-796 # 80009878 <digits>
    80006b9c:	883a                	mv	a6,a4
    80006b9e:	2705                	addiw	a4,a4,1
    80006ba0:	02b577bb          	remuw	a5,a0,a1
    80006ba4:	1782                	slli	a5,a5,0x20
    80006ba6:	9381                	srli	a5,a5,0x20
    80006ba8:	97b2                	add	a5,a5,a2
    80006baa:	0007c783          	lbu	a5,0(a5)
    80006bae:	00f68023          	sb	a5,0(a3)
  } while((x /= base) != 0);
    80006bb2:	0005079b          	sext.w	a5,a0
    80006bb6:	02b5553b          	divuw	a0,a0,a1
    80006bba:	0685                	addi	a3,a3,1
    80006bbc:	feb7f0e3          	bgeu	a5,a1,80006b9c <printint+0x26>

  if(sign)
    80006bc0:	00088b63          	beqz	a7,80006bd6 <printint+0x60>
    buf[i++] = '-';
    80006bc4:	fe040793          	addi	a5,s0,-32
    80006bc8:	973e                	add	a4,a4,a5
    80006bca:	02d00793          	li	a5,45
    80006bce:	fef70823          	sb	a5,-16(a4)
    80006bd2:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    80006bd6:	02e05763          	blez	a4,80006c04 <printint+0x8e>
    80006bda:	fd040793          	addi	a5,s0,-48
    80006bde:	00e784b3          	add	s1,a5,a4
    80006be2:	fff78913          	addi	s2,a5,-1
    80006be6:	993a                	add	s2,s2,a4
    80006be8:	377d                	addiw	a4,a4,-1
    80006bea:	1702                	slli	a4,a4,0x20
    80006bec:	9301                	srli	a4,a4,0x20
    80006bee:	40e90933          	sub	s2,s2,a4
    consputc(buf[i]);
    80006bf2:	fff4c503          	lbu	a0,-1(s1)
    80006bf6:	00000097          	auipc	ra,0x0
    80006bfa:	d60080e7          	jalr	-672(ra) # 80006956 <consputc>
  while(--i >= 0)
    80006bfe:	14fd                	addi	s1,s1,-1
    80006c00:	ff2499e3          	bne	s1,s2,80006bf2 <printint+0x7c>
}
    80006c04:	70a2                	ld	ra,40(sp)
    80006c06:	7402                	ld	s0,32(sp)
    80006c08:	64e2                	ld	s1,24(sp)
    80006c0a:	6942                	ld	s2,16(sp)
    80006c0c:	6145                	addi	sp,sp,48
    80006c0e:	8082                	ret
    x = -xx;
    80006c10:	40a0053b          	negw	a0,a0
  if(sign && (sign = xx < 0))
    80006c14:	4885                	li	a7,1
    x = -xx;
    80006c16:	bf9d                	j	80006b8c <printint+0x16>

0000000080006c18 <panic>:
    release(&pr.lock);
}
...
panic(char *s)
{
    ...
    80006c20:	1000                	addi	s0,sp,32
    80006c22:	84aa                	mv	s1,a0
  pr.locking = 0;
    80006c24:	00021797          	auipc	a5,0x21
    80006c28:	9007ae23          	sw	zero,-1764(a5) # 80027540 <pr+0x18>
  printf("panic: ");
    80006c2c:	00003517          	auipc	a0,0x3
    80006c30:	c2450513          	addi	a0,a0,-988 # 80009850 <syscalls+0x478>
    80006c34:	00000097          	auipc	ra,0x0
    80006c38:	02e080e7          	jalr	46(ra) # 80006c62 <printf>
  printf(s);
    80006c3c:	8526                	mv	a0,s1
    80006c3e:	00000097          	auipc	ra,0x0
    80006c42:	024080e7          	jalr	36(ra) # 80006c62 <printf>
  printf("\n");
    80006c46:	00002517          	auipc	a0,0x2
    80006c4a:	40250513          	addi	a0,a0,1026 # 80009048 <etext+0x48>
    80006c4e:	00000097          	auipc	ra,0x0
    80006c52:	014080e7          	jalr	20(ra) # 80006c62 <printf>
  panicked = 1; // freeze uart output from other CPUs
    80006c56:	4785                	li	a5,1
    80006c58:	00003717          	auipc	a4,0x3
    80006c5c:	3cf72c23          	sw	a5,984(a4) # 8000a030 <panicked>
  for(;;)
    80006c60:	a001                	j	80006c60 <panic+0x48>

0000000080006c62 <printf>:
{
    80006c62:	7131                	addi	sp,sp,-192
    80006c64:	fc86                	sd	ra,120(sp)
    80006c66:	f8a2                	sd	s0,112(sp)
    80006c68:	f4a6                	sd	s1,104(sp)
    80006c6a:	f0ca                	sd	s2,96(sp)
    80006c6c:	ecce                	sd	s3,88(sp)
    80006c6e:	e8d2                	sd	s4,80(sp)
    80006c70:	e4d6                	sd	s5,72(sp)
    80006c72:	e0da                	sd	s6,64(sp)
    80006c74:	fc5e                	sd	s7,56(sp)
    80006c76:	f862                	sd	s8,48(sp)
    80006c78:	f466                	sd	s9,40(sp)
    80006c7a:	f06a                	sd	s10,32(sp)
    80006c7c:	ec6e                	sd	s11,24(sp)
    80006c7e:	0100                	addi	s0,sp,128
    80006c80:	8a2a                	mv	s4,a0
    80006c82:	e40c                	sd	a1,8(s0)
    80006c84:	e810                	sd	a2,16(s0)
    80006c86:	ec14                	sd	a3,24(s0)
    80006c88:	f018                	sd	a4,32(s0)
    80006c8a:	f41c                	sd	a5,40(s0)
    80006c8c:	03043823          	sd	a6,48(s0)
    80006c90:	03143c23          	sd	a7,56(s0)
  locking = pr.locking;
    80006c94:	00021d97          	auipc	s11,0x21
    80006c98:	8acdad83          	lw	s11,-1876(s11) # 80027540 <pr+0x18>
  if(locking)
    80006c9c:	020d9b63          	bnez	s11,80006cd2 <printf+0x70>
  if (fmt == 0)
    80006ca0:	040a0263          	beqz	s4,80006ce4 <printf+0x82>
  va_start(ap, fmt);
    80006ca4:	00840793          	addi	a5,s0,8
    80006ca8:	f8f43423          	sd	a5,-120(s0)
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006cac:	000a4503          	lbu	a0,0(s4) # 2000 <_entry-0x7fffe000>
    80006cb0:	16050263          	beqz	a0,80006e14 <printf+0x1b2>
    80006cb4:	4481                	li	s1,0
    if(c != '%'){
    80006cb6:	02500a93          	li	s5,37
    switch(c){
    80006cba:	07000b13          	li	s6,112
  consputc('x');
    80006cbe:	4d41                	li	s10,16
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006cc0:	00003b97          	auipc	s7,0x3
    80006cc4:	bb8b8b93          	addi	s7,s7,-1096 # 80009878 <digits>
    switch(c){
    80006cc8:	07300c93          	li	s9,115
    80006ccc:	06400c13          	li	s8,100
    80006cd0:	a82d                	j	80006d0a <printf+0xa8>
    acquire(&pr.lock);
    80006cd2:	00021517          	auipc	a0,0x21
    80006cd6:	85650513          	addi	a0,a0,-1962 # 80027528 <pr>
    80006cda:	00000097          	auipc	ra,0x0
    80006cde:	488080e7          	jalr	1160(ra) # 80007162 <acquire>
    80006ce2:	bf7d                	j	80006ca0 <printf+0x3e>
    panic("null fmt");
    80006ce4:	00003517          	auipc	a0,0x3
    80006ce8:	b7c50513          	addi	a0,a0,-1156 # 80009860 <syscalls+0x488>
    80006cec:	00000097          	auipc	ra,0x0
    80006cf0:	f2c080e7          	jalr	-212(ra) # 80006c18 <panic>
      consputc(c);
    80006cf4:	00000097          	auipc	ra,0x0
    80006cf8:	c62080e7          	jalr	-926(ra) # 80006956 <consputc>
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006cfc:	2485                	addiw	s1,s1,1
    80006cfe:	009a07b3          	add	a5,s4,s1
    80006d02:	0007c503          	lbu	a0,0(a5)
    80006d06:	10050763          	beqz	a0,80006e14 <printf+0x1b2>
    if(c != '%'){
    80006d0a:	ff5515e3          	bne	a0,s5,80006cf4 <printf+0x92>
    c = fmt[++i] & 0xff;
    80006d0e:	2485                	addiw	s1,s1,1
    80006d10:	009a07b3          	add	a5,s4,s1
    80006d14:	0007c783          	lbu	a5,0(a5)
    80006d18:	0007891b          	sext.w	s2,a5
    if(c == 0)
    80006d1c:	cfe5                	beqz	a5,80006e14 <printf+0x1b2>
    switch(c){
    80006d1e:	05678a63          	beq	a5,s6,80006d72 <printf+0x110>
    80006d22:	02fb7663          	bgeu	s6,a5,80006d4e <printf+0xec>
    80006d26:	09978963          	beq	a5,s9,80006db8 <printf+0x156>
    80006d2a:	07800713          	li	a4,120
    80006d2e:	0ce79863          	bne	a5,a4,80006dfe <printf+0x19c>
      printint(va_arg(ap, int), 16, 1);
    80006d32:	f8843783          	ld	a5,-120(s0)
    80006d36:	00878713          	addi	a4,a5,8
    80006d3a:	f8e43423          	sd	a4,-120(s0)
    80006d3e:	4605                	li	a2,1
    80006d40:	85ea                	mv	a1,s10
    80006d42:	4388                	lw	a0,0(a5)
    80006d44:	00000097          	auipc	ra,0x0
    80006d48:	e32080e7          	jalr	-462(ra) # 80006b76 <printint>
      break;
    80006d4c:	bf45                	j	80006cfc <printf+0x9a>
    switch(c){
    80006d4e:	0b578263          	beq	a5,s5,80006df2 <printf+0x190>
    80006d52:	0b879663          	bne	a5,s8,80006dfe <printf+0x19c>
      printint(va_arg(ap, int), 10, 1);
    80006d56:	f8843783          	ld	a5,-120(s0)
    80006d5a:	00878713          	addi	a4,a5,8
    80006d5e:	f8e43423          	sd	a4,-120(s0)
    80006d62:	4605                	li	a2,1
    80006d64:	45a9                	li	a1,10
    80006d66:	4388                	lw	a0,0(a5)
    80006d68:	00000097          	auipc	ra,0x0
    80006d6c:	e0e080e7          	jalr	-498(ra) # 80006b76 <printint>
      break;
    80006d70:	b771                	j	80006cfc <printf+0x9a>
      printptr(va_arg(ap, uint64));
    80006d72:	f8843783          	ld	a5,-120(s0)
    80006d76:	00878713          	addi	a4,a5,8
    80006d7a:	f8e43423          	sd	a4,-120(s0)
    80006d7e:	0007b983          	ld	s3,0(a5)
  consputc('0');
    80006d82:	03000513          	li	a0,48
    80006d86:	00000097          	auipc	ra,0x0
    80006d8a:	bd0080e7          	jalr	-1072(ra) # 80006956 <consputc>
  consputc('x');
    80006d8e:	07800513          	li	a0,120
    80006d92:	00000097          	auipc	ra,0x0
    80006d96:	bc4080e7          	jalr	-1084(ra) # 80006956 <consputc>
    80006d9a:	896a                	mv	s2,s10
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006d9c:	03c9d793          	srli	a5,s3,0x3c
    80006da0:	97de                	add	a5,a5,s7
    80006da2:	0007c503          	lbu	a0,0(a5)
    80006da6:	00000097          	auipc	ra,0x0
    80006daa:	bb0080e7          	jalr	-1104(ra) # 80006956 <consputc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    80006dae:	0992                	slli	s3,s3,0x4
    80006db0:	397d                	addiw	s2,s2,-1
    80006db2:	fe0915e3          	bnez	s2,80006d9c <printf+0x13a>
    80006db6:	b799                	j	80006cfc <printf+0x9a>
      if((s = va_arg(ap, char*)) == 0)
    80006db8:	f8843783          	ld	a5,-120(s0)
    80006dbc:	00878713          	addi	a4,a5,8
    80006dc0:	f8e43423          	sd	a4,-120(s0)
    80006dc4:	0007b903          	ld	s2,0(a5)
    80006dc8:	00090e63          	beqz	s2,80006de4 <printf+0x182>
      for(; *s; s++)
    80006dcc:	00094503          	lbu	a0,0(s2)
    80006dd0:	d515                	beqz	a0,80006cfc <printf+0x9a>
        consputc(*s);
    80006dd2:	00000097          	auipc	ra,0x0
    80006dd6:	b84080e7          	jalr	-1148(ra) # 80006956 <consputc>
      for(; *s; s++)
    80006dda:	0905                	addi	s2,s2,1
    80006ddc:	00094503          	lbu	a0,0(s2)
    80006de0:	f96d                	bnez	a0,80006dd2 <printf+0x170>
    80006de2:	bf29                	j	80006cfc <printf+0x9a>
        s = "(null)";
    80006de4:	00003917          	auipc	s2,0x3
    80006de8:	a7490913          	addi	s2,s2,-1420 # 80009858 <syscalls+0x480>
      for(; *s; s++)
    80006dec:	02800513          	li	a0,40
    80006df0:	b7cd                	j	80006dd2 <printf+0x170>
      consputc('%');
    80006df2:	8556                	mv	a0,s5
    80006df4:	00000097          	auipc	ra,0x0
    80006df8:	b62080e7          	jalr	-1182(ra) # 80006956 <consputc>
      break;
    80006dfc:	b701                	j	80006cfc <printf+0x9a>
      consputc('%');
    80006dfe:	8556                	mv	a0,s5
    80006e00:	00000097          	auipc	ra,0x0
    80006e04:	b56080e7          	jalr	-1194(ra) # 80006956 <consputc>
      consputc(c);
    80006e08:	854a                	mv	a0,s2
    80006e0a:	00000097          	auipc	ra,0x0
    80006e0e:	b4c080e7          	jalr	-1204(ra) # 80006956 <consputc>
      break;
    80006e12:	b5ed                	j	80006cfc <printf+0x9a>
  if(locking)
    80006e14:	020d9163          	bnez	s11,80006e36 <printf+0x1d4>
}
    80006e18:	70e6                	ld	ra,120(sp)
    80006e1a:	7446                	ld	s0,112(sp)
    80006e1c:	74a6                	ld	s1,104(sp)
    80006e1e:	7906                	ld	s2,96(sp)
    80006e20:	69e6                	ld	s3,88(sp)
    80006e22:	6a46                	ld	s4,80(sp)
    80006e24:	6aa6                	ld	s5,72(sp)
    80006e26:	6b06                	ld	s6,64(sp)
    80006e28:	7be2                	ld	s7,56(sp)
    80006e2a:	7c42                	ld	s8,48(sp)
    80006e2c:	7ca2                	ld	s9,40(sp)
    80006e2e:	7d02                	ld	s10,32(sp)
    80006e30:	6de2                	ld	s11,24(sp)
    80006e32:	6129                	addi	sp,sp,192
    80006e34:	8082                	ret
    release(&pr.lock);
    80006e36:	00020517          	auipc	a0,0x20
    80006e3a:	6f250513          	addi	a0,a0,1778 # 80027528 <pr>
    80006e3e:	00000097          	auipc	ra,0x0
    80006e42:	3d8080e7          	jalr	984(ra) # 80007216 <release>
}
    80006e46:	bfc9                	j	80006e18 <printf+0x1b6>

0000000080006e48 <printfinit>:
    ;
}
...
printfinit(void)
{
    80006e48:	1101                	addi	sp,sp,-32
    80006e4a:	ec06                	sd	ra,24(sp)
    80006e4c:	e822                	sd	s0,16(sp)
    80006e4e:	e426                	sd	s1,8(sp)
    80006e50:	1000                	addi	s0,sp,32
  initlock(&pr.lock, "pr");
    80006e52:	00020497          	auipc	s1,0x20
    80006e56:	6d648493          	addi	s1,s1,1750 # 80027528 <pr>
    80006e5a:	00003597          	auipc	a1,0x3
    80006e5e:	a1658593          	addi	a1,a1,-1514 # 80009870 <syscalls+0x498>
    80006e62:	8526                	mv	a0,s1
    80006e64:	00000097          	auipc	ra,0x0
    80006e68:	26e080e7          	jalr	622(ra) # 800070d2 <initlock>
  pr.locking = 1;
    80006e6c:	4785                	li	a5,1
    80006e6e:	cc9c                	sw	a5,24(s1)
}
    80006e70:	60e2                	ld	ra,24(sp)
    80006e72:	6442                	ld	s0,16(sp)
    80006e74:	64a2                	ld	s1,8(sp)
    80006e76:	6105                	addi	sp,sp,32
    80006e78:	8082                	ret

0000000080006e7a <uartinit>:
...
uartinit(void)
{
    ...
    80006e7c:	e406                	sd	ra,8(sp)
    80006e7e:	e022                	sd	s0,0(sp)
    80006e80:	0800                	addi	s0,sp,16
  // disable interrupts.
  WriteReg(IER, 0x00);
    80006e82:	100007b7          	lui	a5,0x10000
    80006e86:	000780a3          	sb	zero,1(a5) # 10000001 <_entry-0x6fffffff>

  // special mode to set baud rate.
  WriteReg(LCR, LCR_BAUD_LATCH);
    80006e8a:	f8000713          	li	a4,-128
    80006e8e:	00e781a3          	sb	a4,3(a5)

  // LSB for baud rate of 38.4K.
  WriteReg(0, 0x03);
    80006e92:	470d                	li	a4,3
    80006e94:	00e78023          	sb	a4,0(a5)

  // MSB for baud rate of 38.4K.
  WriteReg(1, 0x00);
    80006e98:	000780a3          	sb	zero,1(a5)

  // leave set-baud mode,
  // and set word length to 8 bits, no parity.
  WriteReg(LCR, LCR_EIGHT_BITS);
    80006e9c:	00e781a3          	sb	a4,3(a5)

  // reset and enable FIFOs.
  WriteReg(FCR, FCR_FIFO_ENABLE | FCR_FIFO_CLEAR);
    80006ea0:	469d                	li	a3,7
    80006ea2:	00d78123          	sb	a3,2(a5)

  // enable transmit and receive interrupts.
  WriteReg(IER, IER_TX_ENABLE | IER_RX_ENABLE);
    80006ea6:	00e780a3          	sb	a4,1(a5)

  initlock(&uart_tx_lock, "uart");
    80006eaa:	00003597          	auipc	a1,0x3
    80006eae:	9e658593          	addi	a1,a1,-1562 # 80009890 <digits+0x18>
    80006eb2:	00020517          	auipc	a0,0x20
    80006eb6:	69650513          	addi	a0,a0,1686 # 80027548 <uart_tx_lock>
    80006eba:	00000097          	auipc	ra,0x0
    80006ebe:	218080e7          	jalr	536(ra) # 800070d2 <initlock>
}
    80006ec2:	60a2                	ld	ra,8(sp)
    80006ec4:	6402                	ld	s0,0(sp)
    80006ec6:	0141                	addi	sp,sp,16
    80006ec8:	8082                	ret

0000000080006eca <uartputc_sync>:
...
uartputc_sync(int c)
{
    ...
    80006ed4:	84aa                	mv	s1,a0
  push_off();
    80006ed6:	00000097          	auipc	ra,0x0
    80006eda:	240080e7          	jalr	576(ra) # 80007116 <push_off>

  if(panicked){
    80006ede:	00003797          	auipc	a5,0x3
    80006ee2:	1527a783          	lw	a5,338(a5) # 8000a030 <panicked>
    for(;;)
      ;
  }
  ...
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006ee6:	10000737          	lui	a4,0x10000
  if(panicked){
    80006eea:	c391                	beqz	a5,80006eee <uartputc_sync+0x24>
    for(;;)
    80006eec:	a001                	j	80006eec <uartputc_sync+0x22>
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006eee:	00574783          	lbu	a5,5(a4) # 10000005 <_entry-0x6ffffffb>
    80006ef2:	0ff7f793          	andi	a5,a5,255
    80006ef6:	0207f793          	andi	a5,a5,32
    80006efa:	dbf5                	beqz	a5,80006eee <uartputc_sync+0x24>
    ;
  WriteReg(THR, c);
    80006efc:	0ff4f793          	andi	a5,s1,255
    80006f00:	10000737          	lui	a4,0x10000
    80006f04:	00f70023          	sb	a5,0(a4) # 10000000 <_entry-0x70000000>

  pop_off();
    80006f08:	00000097          	auipc	ra,0x0
    80006f0c:	2ae080e7          	jalr	686(ra) # 800071b6 <pop_off>
}
...
uartstart()
{
  while(1){
    ...
    80006f1a:	00003717          	auipc	a4,0x3
    80006f1e:	11e73703          	ld	a4,286(a4) # 8000a038 <uart_tx_r>
    80006f22:	00003797          	auipc	a5,0x3
    80006f26:	11e7b783          	ld	a5,286(a5) # 8000a040 <uart_tx_w>
    80006f2a:	06e78c63          	beq	a5,a4,80006fa2 <uartstart+0x88>
{
    80006f2e:	7139                	addi	sp,sp,-64
    80006f30:	fc06                	sd	ra,56(sp)
    80006f32:	f822                	sd	s0,48(sp)
    80006f34:	f426                	sd	s1,40(sp)
    80006f36:	f04a                	sd	s2,32(sp)
    80006f38:	ec4e                	sd	s3,24(sp)
    80006f3a:	e852                	sd	s4,16(sp)
    80006f3c:	e456                	sd	s5,8(sp)
    80006f3e:	0080                	addi	s0,sp,64
      // transmit buffer is empty.
      return;
    }
    
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006f40:	10000937          	lui	s2,0x10000
    ...
    80006f44:	00020a17          	auipc	s4,0x20
    80006f48:	604a0a13          	addi	s4,s4,1540 # 80027548 <uart_tx_lock>
    uart_tx_r += 1;
    80006f4c:	00003497          	auipc	s1,0x3
    80006f50:	0ec48493          	addi	s1,s1,236 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80006f54:	00003997          	auipc	s3,0x3
    80006f58:	0ec98993          	addi	s3,s3,236 # 8000a040 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006f5c:	00594783          	lbu	a5,5(s2) # 10000005 <_entry-0x6ffffffb>
    80006f60:	0ff7f793          	andi	a5,a5,255
    80006f64:	0207f793          	andi	a5,a5,32
    80006f68:	c785                	beqz	a5,80006f90 <uartstart+0x76>
    int c = uart_tx_buf[uart_tx_r % UART_TX_BUF_SIZE];
    80006f6a:	01f77793          	andi	a5,a4,31
    80006f6e:	97d2                	add	a5,a5,s4
    80006f70:	0187ca83          	lbu	s5,24(a5)
    uart_tx_r += 1;
    80006f74:	0705                	addi	a4,a4,1
    80006f76:	e098                	sd	a4,0(s1)
    
    // maybe uartputc() is waiting for space in the buffer.
    wakeup(&uart_tx_r);
    80006f78:	8526                	mv	a0,s1
    80006f7a:	ffffa097          	auipc	ra,0xffffa
    80006f7e:	76e080e7          	jalr	1902(ra) # 800016e8 <wakeup>
    
    WriteReg(THR, c);
    80006f82:	01590023          	sb	s5,0(s2)
    if(uart_tx_w == uart_tx_r){
    80006f86:	6098                	ld	a4,0(s1)
    80006f88:	0009b783          	ld	a5,0(s3)
    80006f8c:	fce798e3          	bne	a5,a4,80006f5c <uartstart+0x42>
  }
}
    80006f90:	70e2                	ld	ra,56(sp)
    80006f92:	7442                	ld	s0,48(sp)
    80006f94:	74a2                	ld	s1,40(sp)
    80006f96:	7902                	ld	s2,32(sp)
    80006f98:	69e2                	ld	s3,24(sp)
    80006f9a:	6a42                	ld	s4,16(sp)
    80006f9c:	6aa2                	ld	s5,8(sp)
    80006f9e:	6121                	addi	sp,sp,64
    80006fa0:	8082                	ret
    80006fa2:	8082                	ret

0000000080006fa4 <uartputc>:
{
    80006fa4:	7179                	addi	sp,sp,-48
    80006fa6:	f406                	sd	ra,40(sp)
    80006fa8:	f022                	sd	s0,32(sp)
    80006faa:	ec26                	sd	s1,24(sp)
    80006fac:	e84a                	sd	s2,16(sp)
    80006fae:	e44e                	sd	s3,8(sp)
    80006fb0:	e052                	sd	s4,0(sp)
    80006fb2:	1800                	addi	s0,sp,48
    80006fb4:	89aa                	mv	s3,a0
  acquire(&uart_tx_lock);
    80006fb6:	00020517          	auipc	a0,0x20
    80006fba:	59250513          	addi	a0,a0,1426 # 80027548 <uart_tx_lock>
    80006fbe:	00000097          	auipc	ra,0x0
    80006fc2:	1a4080e7          	jalr	420(ra) # 80007162 <acquire>
  if(panicked){
    80006fc6:	00003797          	auipc	a5,0x3
    80006fca:	06a7a783          	lw	a5,106(a5) # 8000a030 <panicked>
    80006fce:	c391                	beqz	a5,80006fd2 <uartputc+0x2e>
    for(;;)
    80006fd0:	a001                	j	80006fd0 <uartputc+0x2c>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006fd2:	00003797          	auipc	a5,0x3
    80006fd6:	06e7b783          	ld	a5,110(a5) # 8000a040 <uart_tx_w>
    80006fda:	00003717          	auipc	a4,0x3
    80006fde:	05e73703          	ld	a4,94(a4) # 8000a038 <uart_tx_r>
    80006fe2:	02070713          	addi	a4,a4,32
    80006fe6:	02f71b63          	bne	a4,a5,8000701c <uartputc+0x78>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006fea:	00020a17          	auipc	s4,0x20
    80006fee:	55ea0a13          	addi	s4,s4,1374 # 80027548 <uart_tx_lock>
    80006ff2:	00003497          	auipc	s1,0x3
    80006ff6:	04648493          	addi	s1,s1,70 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006ffa:	00003917          	auipc	s2,0x3
    80006ffe:	04690913          	addi	s2,s2,70 # 8000a040 <uart_tx_w>
      sleep(&uart_tx_r, &uart_tx_lock);
    80007002:	85d2                	mv	a1,s4
    80007004:	8526                	mv	a0,s1
    80007006:	ffffa097          	auipc	ra,0xffffa
    8000700a:	556080e7          	jalr	1366(ra) # 8000155c <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    8000700e:	00093783          	ld	a5,0(s2)
    80007012:	6098                	ld	a4,0(s1)
    80007014:	02070713          	addi	a4,a4,32
    80007018:	fef705e3          	beq	a4,a5,80007002 <uartputc+0x5e>
      uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    8000701c:	00020497          	auipc	s1,0x20
    80007020:	52c48493          	addi	s1,s1,1324 # 80027548 <uart_tx_lock>
    80007024:	01f7f713          	andi	a4,a5,31
    80007028:	9726                	add	a4,a4,s1
    8000702a:	01370c23          	sb	s3,24(a4)
      uart_tx_w += 1;
    8000702e:	0785                	addi	a5,a5,1
    80007030:	00003717          	auipc	a4,0x3
    80007034:	00f73823          	sd	a5,16(a4) # 8000a040 <uart_tx_w>
      uartstart();
    80007038:	00000097          	auipc	ra,0x0
    8000703c:	ee2080e7          	jalr	-286(ra) # 80006f1a <uartstart>
      release(&uart_tx_lock);
    80007040:	8526                	mv	a0,s1
    80007042:	00000097          	auipc	ra,0x0
    80007046:	1d4080e7          	jalr	468(ra) # 80007216 <release>
}
    8000704a:	70a2                	ld	ra,40(sp)
    8000704c:	7402                	ld	s0,32(sp)
    8000704e:	64e2                	ld	s1,24(sp)
    80007050:	6942                	ld	s2,16(sp)
    80007052:	69a2                	ld	s3,8(sp)
    80007054:	6a02                	ld	s4,0(sp)
    80007056:	6145                	addi	sp,sp,48
    80007058:	8082                	ret

000000008000705a <uartgetc>:
...
uartgetc(void)
{
  ...
  if(ReadReg(LSR) & 0x01){
    80007060:	100007b7          	lui	a5,0x10000
    80007064:	0057c783          	lbu	a5,5(a5) # 10000005 <_entry-0x6ffffffb>
    80007068:	8b85                	andi	a5,a5,1
    8000706a:	cb91                	beqz	a5,8000707e <uartgetc+0x24>
    // input data is ready.
    return ReadReg(RHR);
    8000706c:	100007b7          	lui	a5,0x10000
    80007070:	0007c503          	lbu	a0,0(a5) # 10000000 <_entry-0x70000000>
    80007074:	0ff57513          	andi	a0,a0,255
  } else {
    return -1;
  }
}
    ...
    8000707c:	8082                	ret
    return -1;
    8000707e:	557d                	li	a0,-1
    80007080:	bfe5                	j	80007078 <uartgetc+0x1e>

0000000080007082 <uartintr>:
...
uartintr(void)
{
  ...
  while(1){
    int c = uartgetc();
    if(c == -1)
    8000708c:	54fd                	li	s1,-1
    int c = uartgetc();
    8000708e:	00000097          	auipc	ra,0x0
    80007092:	fcc080e7          	jalr	-52(ra) # 8000705a <uartgetc>
    if(c == -1)
    80007096:	00950763          	beq	a0,s1,800070a4 <uartintr+0x22>
      break;
    consoleintr(c);
    8000709a:	00000097          	auipc	ra,0x0
    8000709e:	8fe080e7          	jalr	-1794(ra) # 80006998 <consoleintr>
  while(1){
    800070a2:	b7f5                	j	8000708e <uartintr+0xc>
  }

  // send buffered characters.
  acquire(&uart_tx_lock);
    800070a4:	00020497          	auipc	s1,0x20
    800070a8:	4a448493          	addi	s1,s1,1188 # 80027548 <uart_tx_lock>
    800070ac:	8526                	mv	a0,s1
    800070ae:	00000097          	auipc	ra,0x0
    800070b2:	0b4080e7          	jalr	180(ra) # 80007162 <acquire>
  uartstart();
    800070b6:	00000097          	auipc	ra,0x0
    800070ba:	e64080e7          	jalr	-412(ra) # 80006f1a <uartstart>
  release(&uart_tx_lock);
    800070be:	8526                	mv	a0,s1
    800070c0:	00000097          	auipc	ra,0x0
    800070c4:	156080e7          	jalr	342(ra) # 80007216 <release>
}
    800070c8:	60e2                	ld	ra,24(sp)
    800070ca:	6442                	ld	s0,16(sp)
    800070cc:	64a2                	ld	s1,8(sp)
    800070ce:	6105                	addi	sp,sp,32
    800070d0:	8082                	ret

00000000800070d2 <initlock>:
}
#endif
...
initlock(struct spinlock *lk, char *name)
{
  ...
  lk->name = name;
    800070d8:	e50c                	sd	a1,8(a0)
  lk->locked = 0;
    800070da:	00052023          	sw	zero,0(a0)
  lk->cpu = 0;
    800070de:	00053823          	sd	zero,16(a0)
#ifdef LAB_LOCK
  lk->nts = 0;
  lk->n = 0;
  findslot(lk);
    ...
    800070e2:	6422                	ld	s0,8(sp)
    800070e4:	0141                	addi	sp,sp,16
    800070e6:	8082                	ret

00000000800070e8 <holding>:
...
holding(struct spinlock *lk)
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    800070e8:	411c                	lw	a5,0(a0)
    800070ea:	e399                	bnez	a5,800070f0 <holding+0x8>
    800070ec:	4501                	li	a0,0
  return r;
}
    800070ee:	8082                	ret
{
    800070f0:	1101                	addi	sp,sp,-32
    800070f2:	ec06                	sd	ra,24(sp)
    800070f4:	e822                	sd	s0,16(sp)
    800070f6:	e426                	sd	s1,8(sp)
    800070f8:	1000                	addi	s0,sp,32
  r = (lk->locked && lk->cpu == mycpu());
    800070fa:	6904                	ld	s1,16(a0)
    800070fc:	ffffa097          	auipc	ra,0xffffa
    80007100:	d88080e7          	jalr	-632(ra) # 80000e84 <mycpu>
    80007104:	40a48533          	sub	a0,s1,a0
    80007108:	00153513          	seqz	a0,a0
}
    8000710c:	60e2                	ld	ra,24(sp)
    8000710e:	6442                	ld	s0,16(sp)
    80007110:	64a2                	ld	s1,8(sp)
    80007112:	6105                	addi	sp,sp,32
    80007114:	8082                	ret

0000000080007116 <push_off>:
...
push_off(void)
{
  ...
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80007120:	100024f3          	csrr	s1,sstatus
    80007124:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() & ~SSTATUS_SIE);
    80007128:	9bf5                	andi	a5,a5,-3
  asm volatile("csrw sstatus, %0" : : "r" (x));
    8000712a:	10079073          	csrw	sstatus,a5
  int old = intr_get();
  ...
  if(mycpu()->noff == 0)
    ...
    80007136:	5d3c                	lw	a5,120(a0)
    80007138:	cf89                	beqz	a5,80007152 <push_off+0x3c>
    mycpu()->intena = old;
  mycpu()->noff += 1;
    8000713a:	ffffa097          	auipc	ra,0xffffa
    8000713e:	d4a080e7          	jalr	-694(ra) # 80000e84 <mycpu>
    80007142:	5d3c                	lw	a5,120(a0)
    80007144:	2785                	addiw	a5,a5,1
    80007146:	dd3c                	sw	a5,120(a0)
}
    ...
    80007150:	8082                	ret
    mycpu()->intena = old;
    80007152:	ffffa097          	auipc	ra,0xffffa
    80007156:	d32080e7          	jalr	-718(ra) # 80000e84 <mycpu>
  return (x & SSTATUS_SIE) != 0;
    8000715a:	8085                	srli	s1,s1,0x1
    8000715c:	8885                	andi	s1,s1,1
    8000715e:	dd64                	sw	s1,124(a0)
    80007160:	bfe9                	j	8000713a <push_off+0x24>

0000000080007162 <acquire>:
{
    80007162:	1101                	addi	sp,sp,-32
    80007164:	ec06                	sd	ra,24(sp)
    80007166:	e822                	sd	s0,16(sp)
    80007168:	e426                	sd	s1,8(sp)
    8000716a:	1000                	addi	s0,sp,32
    8000716c:	84aa                	mv	s1,a0
  push_off(); // disable interrupts to avoid deadlock.
    8000716e:	00000097          	auipc	ra,0x0
    80007172:	fa8080e7          	jalr	-88(ra) # 80007116 <push_off>
  if(holding(lk))
    80007176:	8526                	mv	a0,s1
    80007178:	00000097          	auipc	ra,0x0
    8000717c:	f70080e7          	jalr	-144(ra) # 800070e8 <holding>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    80007180:	4705                	li	a4,1
  if(holding(lk))
    80007182:	e115                	bnez	a0,800071a6 <acquire+0x44>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    80007184:	87ba                	mv	a5,a4
    80007186:	0cf4a7af          	amoswap.w.aq	a5,a5,(s1)
    8000718a:	2781                	sext.w	a5,a5
    8000718c:	ffe5                	bnez	a5,80007184 <acquire+0x22>
  __sync_synchronize();
    8000718e:	0ff0000f          	fence
  lk->cpu = mycpu();
    80007192:	ffffa097          	auipc	ra,0xffffa
    80007196:	cf2080e7          	jalr	-782(ra) # 80000e84 <mycpu>
    8000719a:	e888                	sd	a0,16(s1)
}
    8000719c:	60e2                	ld	ra,24(sp)
    8000719e:	6442                	ld	s0,16(sp)
    800071a0:	64a2                	ld	s1,8(sp)
    800071a2:	6105                	addi	sp,sp,32
    800071a4:	8082                	ret
    panic("acquire");
    800071a6:	00002517          	auipc	a0,0x2
    800071aa:	6f250513          	addi	a0,a0,1778 # 80009898 <digits+0x20>
    800071ae:	00000097          	auipc	ra,0x0
    800071b2:	a6a080e7          	jalr	-1430(ra) # 80006c18 <panic>

00000000800071b6 <pop_off>:

void
pop_off(void)
{
    800071b6:	1141                	addi	sp,sp,-16
    800071b8:	e406                	sd	ra,8(sp)
    800071ba:	e022                	sd	s0,0(sp)
    800071bc:	0800                	addi	s0,sp,16
  struct cpu *c = mycpu();
    800071be:	ffffa097          	auipc	ra,0xffffa
    800071c2:	cc6080e7          	jalr	-826(ra) # 80000e84 <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800071c6:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    800071ca:	8b89                	andi	a5,a5,2
  if(intr_get())
    800071cc:	e78d                	bnez	a5,800071f6 <pop_off+0x40>
    panic("pop_off - interruptible");
  if(c->noff < 1)
    800071ce:	5d3c                	lw	a5,120(a0)
    800071d0:	02f05b63          	blez	a5,80007206 <pop_off+0x50>
    panic("pop_off");
  c->noff -= 1;
    800071d4:	37fd                	addiw	a5,a5,-1
    800071d6:	0007871b          	sext.w	a4,a5
    800071da:	dd3c                	sw	a5,120(a0)
  if(c->noff == 0 && c->intena)
    800071dc:	eb09                	bnez	a4,800071ee <pop_off+0x38>
    800071de:	5d7c                	lw	a5,124(a0)
    800071e0:	c799                	beqz	a5,800071ee <pop_off+0x38>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800071e2:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    800071e6:	0027e793          	ori	a5,a5,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    800071ea:	10079073          	csrw	sstatus,a5
    intr_on();
}
    800071ee:	60a2                	ld	ra,8(sp)
    800071f0:	6402                	ld	s0,0(sp)
    800071f2:	0141                	addi	sp,sp,16
    800071f4:	8082                	ret
    panic("pop_off - interruptible");
    800071f6:	00002517          	auipc	a0,0x2
    800071fa:	6aa50513          	addi	a0,a0,1706 # 800098a0 <digits+0x28>
    800071fe:	00000097          	auipc	ra,0x0
    80007202:	a1a080e7          	jalr	-1510(ra) # 80006c18 <panic>
    panic("pop_off");
    80007206:	00002517          	auipc	a0,0x2
    8000720a:	6b250513          	addi	a0,a0,1714 # 800098b8 <digits+0x40>
    8000720e:	00000097          	auipc	ra,0x0
    80007212:	a0a080e7          	jalr	-1526(ra) # 80006c18 <panic>

0000000080007216 <release>:
{
    80007216:	1101                	addi	sp,sp,-32
    80007218:	ec06                	sd	ra,24(sp)
    8000721a:	e822                	sd	s0,16(sp)
    8000721c:	e426                	sd	s1,8(sp)
    8000721e:	1000                	addi	s0,sp,32
    80007220:	84aa                	mv	s1,a0
  if(!holding(lk))
    80007222:	00000097          	auipc	ra,0x0
    80007226:	ec6080e7          	jalr	-314(ra) # 800070e8 <holding>
    8000722a:	c115                	beqz	a0,8000724e <release+0x38>
  lk->cpu = 0;
    8000722c:	0004b823          	sd	zero,16(s1)
  __sync_synchronize();
    80007230:	0ff0000f          	fence
  __sync_lock_release(&lk->locked);
    80007234:	0f50000f          	fence	iorw,ow
    80007238:	0804a02f          	amoswap.w	zero,zero,(s1)
  pop_off();
    8000723c:	00000097          	auipc	ra,0x0
    80007240:	f7a080e7          	jalr	-134(ra) # 800071b6 <pop_off>
}
    ...
    8000724c:	8082                	ret
    panic("release");
    8000724e:	00002517          	auipc	a0,0x2
    80007252:	67250513          	addi	a0,a0,1650 # 800098c0 <digits+0x48>
    80007256:	00000097          	auipc	ra,0x0
    8000725a:	9c2080e7          	jalr	-1598(ra) # 80006c18 <panic>

000000008000725e <lockfree_read8>:
...
lockfree_read8(uint64 *addr) {
  ...
  __atomic_load(addr, &val, __ATOMIC_SEQ_CST);
    ...
    80007268:	6108                	ld	a0,0(a0)
    8000726a:	0ff0000f          	fence
  return val;
}
    8000726e:	6422                	ld	s0,8(sp)
    80007270:	0141                	addi	sp,sp,16
    80007272:	8082                	ret

0000000080007274 <lockfree_read4>:

// Read a shared 32-bit value without holding a lock
int
lockfree_read4(int *addr) {
    80007274:	1141                	addi	sp,sp,-16
    80007276:	e422                	sd	s0,8(sp)
    80007278:	0800                	addi	s0,sp,16
  uint32 val;
  __atomic_load(addr, &val, __ATOMIC_SEQ_CST);
    8000727a:	0ff0000f          	fence
    8000727e:	4108                	lw	a0,0(a0)
    80007280:	0ff0000f          	fence
  return val;
}
    80007284:	2501                	sext.w	a0,a0
    80007286:	6422                	ld	s0,8(sp)
    80007288:	0141                	addi	sp,sp,16
    8000728a:	8082                	ret
	...
